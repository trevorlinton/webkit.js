...
public:
    ...
    {
        JSHTMLParagraphElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLParagraphElement>(globalObject->vm().heap)) JSHTMLParagraphElement(structure, globalObject, impl);
...
private:
    JSHTMLParagraphElementPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
...
JSC::EncodedJSValue jsHTMLParagraphElementAlign(JSC::ExecState*, JSC::EncodedJSValue, JSC::EncodedJSValue, JSC::PropertyName);
void setJSHTMLParagraphElementAlign(JSC::ExecState*, JSC::EncodedJSValue, JSC::EncodedJSValue);
JSC::EncodedJSValue jsHTMLParagraphElementConstructor(JSC::ExecState*, JSC::EncodedJSValue, JSC::EncodedJSValue, JSC::PropertyName);
