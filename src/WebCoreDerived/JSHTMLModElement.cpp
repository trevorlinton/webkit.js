...
EncodedJSValue jsHTMLModElementCite(ExecState* exec, EncodedJSValue slotBase, EncodedJSValue thisValue, PropertyName)
{
...
EncodedJSValue jsHTMLModElementDateTime(ExecState* exec, EncodedJSValue slotBase, EncodedJSValue thisValue, PropertyName)
{
    JSHTMLModElement* castedThis = jsDynamicCast<JSHTMLModElement*>(JSValue::decode(thisValue));
    UNUSED_PARAM(slotBase);
    if (!castedThis)
...
EncodedJSValue jsHTMLModElementConstructor(ExecState* exec, EncodedJSValue thisValue, EncodedJSValue, PropertyName)
{
    JSHTMLModElement* domObject = jsDynamicCast<JSHTMLModElement*>(JSValue::decode(thisValue));
    if (!domObject)
        return throwVMTypeError(exec);
    if (!domObject)
        return throwVMTypeError(exec);
...
void setJSHTMLModElementCite(ExecState* exec, EncodedJSValue thisValue, EncodedJSValue encodedValue)
{
...
void setJSHTMLModElementDateTime(ExecState* exec, EncodedJSValue thisValue, EncodedJSValue encodedValue)
{
    JSValue value = JSValue::decode(encodedValue);
    UNUSED_PARAM(exec);
    JSHTMLModElement* castedThis = jsDynamicCast<JSHTMLModElement*>(JSValue::decode(thisValue));
