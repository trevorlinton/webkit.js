...
EncodedJSValue jsHTMLBRElementClear(ExecState* exec, EncodedJSValue slotBase, EncodedJSValue thisValue, PropertyName)
{
...
EncodedJSValue jsHTMLBRElementConstructor(ExecState* exec, EncodedJSValue thisValue, EncodedJSValue, PropertyName)
{
    JSHTMLBRElement* domObject = jsDynamicCast<JSHTMLBRElement*>(JSValue::decode(thisValue));
    if (!domObject)
        return throwVMTypeError(exec);
    if (!domObject)
        return throwVMTypeError(exec);
...
void setJSHTMLBRElementClear(ExecState* exec, EncodedJSValue thisValue, EncodedJSValue encodedValue)
{
