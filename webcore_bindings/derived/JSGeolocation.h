...
public:
    ...
    {
        JSGeolocation* ptr = new (NotNull, JSC::allocateCell<JSGeolocation>(globalObject->vm().heap)) JSGeolocation(structure, globalObject, impl);
...
private:
    JSGeolocationPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
