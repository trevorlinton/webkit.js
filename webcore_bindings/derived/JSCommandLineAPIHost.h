...
public:
    ...
    static JSCommandLineAPIHost* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, PassRefPtr<CommandLineAPIHost> impl)
    {
        JSCommandLineAPIHost* ptr = new (NotNull, JSC::allocateCell<JSCommandLineAPIHost>(globalObject->vm().heap)) JSCommandLineAPIHost(structure, globalObject, impl);
...
protected:
    JSCommandLineAPIHost(JSC::Structure*, JSDOMGlobalObject*, PassRefPtr<CommandLineAPIHost>);
...
{
    DEFINE_STATIC_LOCAL(JSCommandLineAPIHostOwner, jsCommandLineAPIHostOwner, ());
    return &jsCommandLineAPIHostOwner;
}

inline void* wrapperContext(DOMWrapperWorld& world, CommandLineAPIHost*)
{
    return &world;
}

JSC::JSValue toJS(JSC::ExecState*, JSDOMGlobalObject*, CommandLineAPIHost*);
CommandLineAPIHost* toCommandLineAPIHost(JSC::JSValue);
...
private:
    JSCommandLineAPIHostPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
