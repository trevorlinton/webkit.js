...
JSSQLTransactionSyncCallback::JSSQLTransactionSyncCallback(JSObject* callback, JSDOMGlobalObject* globalObject)
...
bool JSSQLTransactionSyncCallback::handleEvent(SQLTransactionSync* transaction)
{
    if (!canInvokeCallback())
        return true;

    Ref<JSSQLTransactionSyncCallback> protect(*this);
