...
EncodedJSValue jsWebGLActiveInfoSize(ExecState* exec, EncodedJSValue slotBase, EncodedJSValue thisValue, PropertyName)
{
...
EncodedJSValue jsWebGLActiveInfoType(ExecState* exec, EncodedJSValue slotBase, EncodedJSValue thisValue, PropertyName)
{
    JSWebGLActiveInfo* castedThis = jsDynamicCast<JSWebGLActiveInfo*>(JSValue::decode(thisValue));
    UNUSED_PARAM(slotBase);
    if (!castedThis)
...
EncodedJSValue jsWebGLActiveInfoName(ExecState* exec, EncodedJSValue slotBase, EncodedJSValue thisValue, PropertyName)
{
    JSWebGLActiveInfo* castedThis = jsDynamicCast<JSWebGLActiveInfo*>(JSValue::decode(thisValue));
    UNUSED_PARAM(slotBase);
    if (!castedThis)
...
EncodedJSValue jsWebGLActiveInfoConstructor(ExecState* exec, EncodedJSValue thisValue, EncodedJSValue, PropertyName)
{
    JSWebGLActiveInfo* domObject = jsDynamicCast<JSWebGLActiveInfo*>(JSValue::decode(thisValue));
    if (!domObject)
        return throwVMTypeError(exec);
    if (!domObject)
        return throwVMTypeError(exec);
...
{
    return value.inherits(JSWebGLActiveInfo::info()) ? &jsCast<JSWebGLActiveInfo*>(value)->impl() : 0;
}
