		  ...
		  cairo_gl_operand_t	*operand)
{
	...
	return (cairo_int_status_t)image->status;
    }
    ...
    status = (cairo_status_t)_cairo_gl_operand_init (operand, &pattern.base, _dst,
		    ...
		    cairo_tristrip_t	*strip)
{
	...
	return (cairo_int_status_t)mask->base.status;
