...
static char const base64_table[65] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
...
_cairo_base64_stream_create (cairo_output_stream_t *output)
{
    ...
    stream = (cairo_base64_stream_t *)malloc (sizeof (cairo_base64_stream_t));
