...
----
  ...
  - Refactor webkit.c+pp to a normalized set of JS classes in EM6.
...
* Paste this into a file (establishing your source root):
```
solutions = [
  { "name"        : ".",
...
```
$ node webkit.debug.js "<html><body>Some HTML</body></html>"
```
