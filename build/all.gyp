  ...
  'targets': [
    {
      ...
      'ldflags':['<(emscripten_ldflags) -s EXPORTED_FUNCTIONS="[`cat <(DEPTH)/webcore_bindings/Symbols.exports`]"'],
      'ld':'<(emscripten_ld)',
    },
    {
      'target_name': 'libwebkit',
      'type': 'shared_library',
      'dependencies': [
        'generate_exports',
      ],
      ...
      'sources/':[
        ...
        ['exclude', '(blackberry|win/|linux/|glib/|cocoa/|gtk/|cf/|mac/|efl/)'],
        ['exclude', '(ExportFileGenerator\\.cpp$|loader/EmptyClients.cpp$|CF\\.cpp$)'],
        ['exclude', '(IOS\\.|Mac\\.|Win\\.|XMLHttpRequest|TextBreakIteratorWchar)'],
        ['exclude', '(TCSystemAlloc|FastMalloc|ThemeSafari|PlugInElement|JSAbstractView|InspectorWebBackend|AllInOne)'],
        ['exclude', '(OpenTypeUtilities|HarfBuzzFaceCoreText|graphics/FontPlatformData\\.cpp$)'],
        ['exclude', '(GraphicsContext3DOpenGL\\.cpp$)'], # We use OpenGLES v2
        ...
        ['exclude', '(TextEncodingDetectorICU\\.cpp$|TextEncodingDetectorICU)'],
        ['exclude', '(ExportFileGenerator\\.cpp$)'],
      ],
      'include_dirs': [
    ...
    },
    {
      ...
      'sources/':[
        ['exclude','(test|rngparser|trio|runxmlconf|runtest|runsuite|python/|macos/|win32config|nano|elfgccheck|tutorial|win32/|example|doc/)'],
        ['exclude','(xmlIO\\.c$|xmlcatalog\\.c$|testlimits\\.c$|gjobread\\.c$|macos_main\\.c$|xmllint\\.c$)'],
      ],
      'cc':'<(emscripten_cc)',
      'cxx':'<(emscripten_cc)',
    ...
    },
    {
      ...
      'sources/':[
        ...
        ['exclude','(jdcolext\\.c$|jdmrgext\\.c$|jpegtran\\.c$|jsimd_none\\.c$|md5cmp\\.c$)'],
        ['exclude','(rdjpgcom\\.c$|jsimd_arm\\.c$|jsimd_i386\\.c$|jsimd_mips_dspr2_asm\\.h$)'],
    ...
    },
    {
      ...
      'sources/': [
        ['exclude', '(prefs/|perf/|util/|test/|os2|win32|beos|qt|boilerplate|arm-|sse2|pdf|quartz|script-|wgl|xcb|vg-|-drm|skia-|tee-|xlib-|xml-|-vmx|utils|cogl|egl-|directfb-|glx-|check-has-hidden)'],
        ['exclude', 'pixman-region.c$|perceptualdiff\\.c$'],
      ],
      'include_dirs': [
        '<(DEPTH)/deps/cairo',
        '<(DEPTH)/deps/cairo/src',
    ...
    },
    {
      ...
      'cc':'<(emscripten_cc)',
      'cxx':'<(emscripten_cc)',
      'cflags':['-DTARGET_EMSCRIPTEN -include <(DEPTH)/deps/fontconfig/config/config.h -isysroot <(emscripten_sysroot)'],
      'ld':'<(emscripten_ld)',
      'ldflags':['<(emscripten_ldflags)'],
    },
    {
