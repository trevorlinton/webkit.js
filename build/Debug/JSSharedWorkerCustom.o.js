...
function __ZN7WebCore25JSSharedWorkerConstructor23constructJSSharedWorkerEPN3JSC9ExecStateE(i1) {
 i1 = i1 | 0;
 ...
 i12 = i1 + 24 | 0;
 i13 = HEAP32[i12 >> 2] | 0;
 if ((i13 & 0 | 0) == 0 & (HEAP32[i12 + 4 >> 2] & -1 | 0) == (-6 | 0)) {
  i14 = 0;
 } else {
  i14 = i13;
 }
 ...
 if ((i20 | 0) == 8) {
  i21 = __ZNK3JSC7JSValue16toStringSlowCaseEPNS_9ExecStateE(i6, i1) | 0;
 }
 i6 = i21 + 12 | 0;
 i4 = HEAP32[i6 >> 2] | 0;
 if ((i4 | 0) == 0) {
 ...
 i27 = (HEAP32[(i26 & -65536) + 1076 >> 2] | 0) + 24800 | 0;
 do {
  if ((HEAP32[i27 >> 2] & 0 | 0) == 0 & (HEAP32[i27 + 4 >> 2] & -1 | 0) == (-6 | 0)) {
   i20 = HEAP32[(HEAP32[(HEAP32[i26 >> 2] | 0) + 4 >> 2] | 0) + 660 >> 2] | 0;
   HEAP32[i9 >> 2] = 0;
   __ZN7WebCore12SharedWorker6createERNS_22ScriptExecutionContextERKN3WTF6StringES6_Ri(i10, (__ZNK7WebCore9DOMWindow8documentEv(i20) | 0) + 88 | 0, i5, i7, i9);
   i20 = i10 | 0;
   i25 = HEAP32[i20 >> 2] | 0;
   HEAP32[i20 >> 2] = 0;
   i20 = HEAP32[i9 >> 2] | 0;
   if ((i20 | 0) == 0) {
    __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_12SharedWorkerE(i11, i1, HEAP32[(HEAP32[i14 >> 2] | 0) + 4 >> 2] | 0, i25);
    i8 = HEAP32[i11 >> 2] | 0;
    i13 = (i8 | 0) == 0;
    i6 = (i13 ? 0 : 0) | i8;
    i8 = (i13 ? -6 : -5) | 0;
    ...
    FUNCTION_TABLE_vi[HEAP32[(HEAP32[i4 >> 2] | 0) + 8 >> 2] & 1](i4);
    i28 = i8;
    i29 = i6;
    break;
   } else {
    ...
    FUNCTION_TABLE_vi[HEAP32[(HEAP32[i6 >> 2] | 0) + 8 >> 2] & 1](i6);
    i28 = -6;
    i29 = 0;
    break;
   }
...
function __ZN7WebCore14JSSharedWorker13visitChildrenEPN3JSC6JSCellERNS1_11SlotVisitorE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0, i4 = 0, i5 = 0;
 i3 = STACKTOP;
 ...
 i5 = HEAP32[(HEAP32[i1 + 12 >> 2] | 0) + 36 >> 2] | 0;
 if ((i5 | 0) == 0) {
  STACKTOP = i3;
  return;
 }
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZN7WebCore25JSSharedWorkerConstructor23constructJSSharedWorkerEPN3JSC9ExecStateE","__ZN3WTF9HashTableIPvS1_NS_17IdentityExtractorENS_7PtrHashIS1_EENS_10HashTraitsIS1_EES6_E3addINS_22IdentityHashTranslatorIS4_EERKS1_SC_EENS_18HashTableAddResultINS_17HashTableIteratorIS1_S1_S2_S4_S6_S6_EEEEOT0_OT1_","__ZN7WebCore14JSSharedWorker13visitChildrenEPN3JSC6JSCellERNS1_11SlotVisitorE","_memset","_memcpy","__ZN3WTF9HashTableIPvS1_NS_17IdentityExtractorENS_7PtrHashIS1_EENS_10HashTraitsIS1_EES6_E6expandEPS1_"]
