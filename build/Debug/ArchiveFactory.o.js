...
function __ZN7WebCore14ArchiveFactory29registerKnownArchiveMIMETypesEv() {
 var i1 = 0, i2 = 0, i3 = 0, i4 = 0, i5 = 0, i6 = 0, i7 = 0, i8 = 0, i9 = 0, i10 = 0, i11 = 0;
 i1 = STACKTOP;
 STACKTOP = STACKTOP + 16 | 0;
 i2 = i1 | 0;
 i3 = __ZN7WebCore16MIMETypeRegistry29getSupportedNonImageMIMETypesEv() | 0;
 ...
 i9 = (HEAP32[i4 >> 2] | 0) + (HEAP32[i4 + 4 >> 2] << 3) | 0;
 if ((i8 | 0) == (i9 | 0)) {
  STACKTOP = i1;
  return;
 }
 ...
 while (1) {
  i8 = i3 | 0;
  __ZN3WTF9HashTableINS_6StringES1_NS_17IdentityExtractorENS_10StringHashENS_10HashTraitsIS1_EES5_E3addINS_22IdentityHashTranslatorIS3_EERKS1_SB_EENS_18HashTableAddResultINS_17HashTableIteratorIS1_S1_S2_S3_S5_S5_EEEEOT0_OT1_(i2, i4, i8, i8);
  i8 = i3 + 8 | 0;
  L18 : do {
   if ((i8 | 0) == (i7 | 0)) {
    i11 = i7;
...
function __ZN7WebCore14ArchiveFactory6createERKNS_3URLEPNS_12SharedBufferERKN3WTF6StringE(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 L1 : do {
  if ((i4 | 0) != 0) {
   ...
   i7 = HEAP32[i6 + 8 >> 2] | 0;
   i8 = HEAP32[i6 >> 2] | 0;
   i6 = __ZN3WTF15CaseFoldingHash4hashERNS_10StringImplE(HEAP32[i5 >> 2] | 0) | 0;
   if ((i8 | 0) == 0) {
    break;
   }
   i9 = (i6 >>> 23) + ~i6 | 0;
   ...
   while (1) {
    ...
    if ((i14 | 0) == 0) {
     ...
     if (__ZN3WTF24equalIgnoringCaseNonNullEPKNS_10StringImplES2_(i13, HEAP32[i5 >> 2] | 0) | 0) {
      break;
     }
    }
    i13 = (i6 | 0) == 0 ? i9 : i6;
   ...
   i6 = HEAP32[i8 + (i11 << 3) + 4 >> 2] | 0;
   if ((i6 | 0) == 0) {
    break;
   }
   FUNCTION_TABLE_viii[i6 & 1](i1, i2, i3);
   return;
  }
 } while (0);
 HEAP32[i1 >> 2] = 0;
...
function __ZN7WebCore14ArchiveFactory17isArchiveMimeTypeERKN3WTF6StringE(i1) {
 i1 = i1 | 0;
