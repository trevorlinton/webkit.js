...
/* memory initializer */ allocate([71,69,84,0,0,0,0,0,32,102,111,114,109,97,116,40,0,0,0,0,0,0,0,0,117,114,108,40,0,0,0,0,108,111,99,97,108,40,0,0,46,101,111,116,0,0,0,0,100,97,116,97,58,0,0,0,115,118,103,0,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE+H_BASE)
;
;
;
;
...
function __ZNK7WebCore19CSSFontFaceSrcValue13customCSSTextEv(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 if ((HEAP8[i2 + 16 | 0] & 1) == 0) {
  __ZN3WTF13StringBuilder6appendEPKhj(i6, H_BASE + 32 | 0, 4);
 } else {
  __ZN3WTF13StringBuilder6appendEPKhj(i6, H_BASE + 40 | 0, 6);
 }
 __ZN3WTF13StringBuilder6appendERKNS_6StringE(i6, i2 + 8 | 0);
 HEAP8[i5] = 41;
 i12 = HEAP32[i9 >> 2] | 0;
 do {
  if ((i12 | 0) == 0) {
   ...
   HEAP32[i7 >> 2] = i14 + 1;
   if (i15) {
    HEAP16[(HEAP32[i6 + 20 >> 2] | 0) + (i14 << 1) >> 1] = 41;
    break;
   } else {
    HEAP8[(HEAP32[i11 >> 2] | 0) + i14 | 0] = 41;
    break;
   }
  }
 } while (0);
 ...
 L15 : do {
  if ((i2 | 0) != 0) {
   ...
   __ZN3WTF13StringBuilder6appendEPKhj(i6, H_BASE + 16 | 0, 8);
...
function __ZN7WebCore19CSSFontFaceSrcValue10cachedFontEPNS_8DocumentE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 __ZNK7WebCore8Document11completeURLERKN3WTF6StringE(i7, i2, i1 + 8 | 0);
 i1 = i7 | 0;
 i10 = HEAP32[i1 >> 2] | 0;
 HEAP32[i6 >> 2] = i10;
 if ((i10 | 0) != 0) {
 ...
 i15 = HEAP8[i7 + 4 | 0] | 0;
 i10 = i6 + 4 | 0;
 HEAP8[i10] = HEAP8[i10] & -4 | i15 & 1 | i15 & 2;
 ...
 __ZN7WebCore20CachedResourceLoader11requestFontERNS_21CachedResourceRequestE(i9, HEAP32[i2 + 340 >> 2] | 0, i5);
...
function __ZNK7WebCore19CSSFontFaceSrcValue23addSubresourceStyleURLsERN3WTF11ListHashSetINS_3URLELj256ENS_7URLHashEEEPKNS_18StyleSheetContentsE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 __ZNK7WebCore18StyleSheetContents11completeURLERKN3WTF6StringE(i7, i3, i1 + 8 | 0);
 i1 = i7 | 0;
 if ((HEAP32[i1 >> 2] | 0) == 0) {
  STACKTOP = i4;
  return;
...
function __ZNK7WebCore19CSSFontFaceSrcValue17isSupportedFormatEv(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
 i2 = i1 + 12 | 0;
 i3 = HEAP32[i2 >> 2] | 0;
 do {
  if ((i3 | 0) != 0) {
   ...
   if (__ZN7WebCore22FontCustomPlatformData14supportsFormatERKN3WTF6StringE(i2) | 0) {
    i4 = 1;
    return i4 | 0;
   }
   i4 = __ZN3WTF17equalIgnoringCaseEPKNS_10StringImplEPKh(HEAP32[i1 + 12 >> 2] | 0, H_BASE + 64 | 0) | 0;
   return i4 | 0;
  }
 } while (0);
 i2 = i1 + 8 | 0;
 ...
 do {
  if ((i1 | 0) != 0) {
   if (__ZNK3WTF10StringImpl10startsWithEPKcjb(i1, H_BASE + 56 | 0, 5, 0) | 0) {
    break;
   }
   i3 = HEAP32[i2 >> 2] | 0;
   if ((i3 | 0) == 0) {
   ...
   if (__ZNK3WTF10StringImpl8endsWithEPKcjb(i3, H_BASE + 48 | 0, 4, 0) | 0) {
    i4 = 0;
   } else {
    break;
   }
...
function __ZNK7WebCore19CSSFontFaceSrcValue6equalsERKS0_(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 ...
 i3 = __ZN3WTF5equalEPKNS_10StringImplES2_(HEAP32[i1 + 8 >> 2] | 0, HEAP32[i2 + 8 >> 2] | 0) | 0;
 return i3 | 0;
}
...
function __ZNK7WebCore19CSSFontFaceSrcValue31hasFailedOrCanceledSubresourcesEv(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0;
 i2 = HEAP32[i1 + 20 >> 2] | 0;
 if ((i2 | 0) == 0) {
...
function __ZNK7WebCore19CSSFontFaceSrcValue16isSVGFontFaceSrcEv(i1) {
 i1 = i1 | 0;
 return __ZN3WTF17equalIgnoringCaseEPKNS_10StringImplEPKh(HEAP32[i1 + 12 >> 2] | 0, H_BASE + 64 | 0) | 0;
}
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZN3WTF13StringBuilder6appendERKNS_6StringE","__ZNK7WebCore19CSSFontFaceSrcValue17isSupportedFormatEv","__ZNK7WebCore19CSSFontFaceSrcValue6equalsERKS0_","__ZN7WebCore19CSSFontFaceSrcValue10cachedFontEPNS_8DocumentE","_memset","__ZN7WebCore19ResourceRequestBaseD2Ev","_memcpy","__ZN7WebCore15ResourceRequestD2Ev","__ZNK7WebCore19CSSFontFaceSrcValue16isSVGFontFaceSrcEv","__ZNK7WebCore19CSSFontFaceSrcValue23addSubresourceStyleURLsERN3WTF11ListHashSetINS_3URLELj256ENS_7URLHashEEEPKNS_18StyleSheetContentsE","__ZNK7WebCore19CSSFontFaceSrcValue31hasFailedOrCanceledSubresourcesEv","__ZNK7WebCore19CSSFontFaceSrcValue13customCSSTextEv","__ZN3WTF9HashTableIPNS_15ListHashSetNodeIN7WebCore3URLELj256EEES5_NS_17IdentityExtractorENS_28ListHashSetNodeHashFunctionsINS2_7URLHashEEENS_10HashTraitsIS5_EESB_E3addINS_21ListHashSetTranslatorIS8_EERKS3_PNS_24ListHashSetNodeAllocatorIS3_Lj256EEEEENS_18HashTableAddResultINS_17HashTableIteratorIS5_S5_S6_S9_SB_SB_EEEEOT0_OT1_","__ZN3WTF9HashTableIPNS_15ListHashSetNodeIN7WebCore3URLELj256EEES5_NS_17IdentityExtractorENS_28ListHashSetNodeHashFunctionsINS2_7URLHashEEENS_10HashTraitsIS5_EESB_E16lookupForWritingINS_22IdentityHashTranslatorIS9_EES5_EENSt3__14pairIPS5_bEERKT0_"]
