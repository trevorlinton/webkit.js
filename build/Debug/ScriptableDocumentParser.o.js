...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore24ScriptableDocumentParserE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore24ScriptableDocumentParserC2ERNS_8DocumentENS_19ParserContentPolicyE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0, i5 = 0, i6 = 0;
 __ZN7WebCore25DecodedDataDocumentParserC2ERNS_8DocumentE(i1 | 0, i2);
  ...
  if ((i3 | 0) == 0) {
   do {
    if ((__ZNK7WebCore8Document8settingsEv(i2) | 0) != 0) {
     if ((HEAP8[(__ZNK7WebCore8Document8settingsEv(i2) | 0) + 192 | 0] & 16) != 0) {
      break;
     }
     i5 = HEAP32[i4 >> 2] | 0;
     break L1;
 ...
 if ((HEAP8[(__ZNK7WebCore8Document8settingsEv(i2) | 0) + 189 | 0] & 8) != 0) {
  return;
 }
 i2 = HEAP32[i4 >> 2] | 0;
 HEAP32[i4 >> 2] = (i2 - 2 | 0) >>> 0 < 2 >>> 0 ? 1 : i2;
 return;
}
function runPostSets() {
 ...
 HEAP32[H_BASE + 44 >> 2] = F_BASE_vi + 20;
 ...
 HEAP32[H_BASE + 84 >> 2] = F_BASE_ii + 10;
...
function __ZN7WebCore24ScriptableDocumentParserD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore24ScriptableDocumentParserD1Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore14DocumentParserD2Ev(i1 | 0);
 return;
}
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,vi___ZN7WebCore14DocumentParser12startParsingEv__wrapper,b0,vi___ZN7WebCore14DocumentParser21suspendScheduledTasksEv__wrapper,b0,__ZN7WebCore24ScriptableDocumentParserD0Ev,b0,vi___ZN7WebCore14DocumentParser11stopParsingEv__wrapper,b0,__ZN7WebCore24ScriptableDocumentParserD1Ev,b0,vi___ZN7WebCore14DocumentParser6detachEv__wrapper,b0,vi___ZN7WebCore14DocumentParser20resumeScheduledTasksEv__wrapper,b0,vi___ZN7WebCore14DocumentParser20prepareToStopParsingEv__wrapper,b0,__ZN7WebCore24ScriptableDocumentParser35executeScriptsWaitingForStylesheetsEv,b0,__ZN7WebCore14DocumentParser15pinToMainThreadEv,b0,b0,b0,b0,b0,b0,b0,b0
  ,b0,b0,b0];
  var FUNCTION_TABLE_vii = [b1,b1,vii___ZN7WebCore25DecodedDataDocumentParser5flushERNS_14DocumentWriterE__wrapper,b1];
  var FUNCTION_TABLE_ii = [b2,b2,__ZNK7WebCore14DocumentParser14processingDataEv,b2,__ZN7WebCore14DocumentParser17hasInsertionPointEv,b2,__ZNK7WebCore24ScriptableDocumentParser17isExecutingScriptEv,b2,__ZN7WebCore24ScriptableDocumentParser26asScriptableDocumentParserEv,b2,__ZNK7WebCore25DecodedDataDocumentParser10wellFormedEv,b2,b2,b2,b2,b2];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZNK7WebCore14DocumentParser14processingDataEv","__ZNK7WebCore25DecodedDataDocumentParser10wellFormedEv","__ZN7WebCore24ScriptableDocumentParserD0Ev","__ZN7WebCore14DocumentParser17hasInsertionPointEv","_memset","__ZNK7WebCore24ScriptableDocumentParser17isExecutingScriptEv","__ZN7WebCore24ScriptableDocumentParserD1Ev","_memcpy","_strlen","__ZN7WebCore24ScriptableDocumentParser26asScriptableDocumentParserEv","__ZN7WebCore24ScriptableDocumentParser35executeScriptsWaitingForStylesheetsEv","__ZN7WebCore14DocumentParser15pinToMainThreadEv","__ZN7WebCore24ScriptableDocumentParserC2ERNS_8DocumentENS_19ParserContentPolicyE"]
