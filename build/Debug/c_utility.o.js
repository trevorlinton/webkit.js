...
var asm = (function(global, env, buffer) {
  ...
  var _NPScriptObjectClass=env._NPScriptObjectClass|0;
...
function __ZN3JSC8Bindings23convertValueToNPVariantEPNS_9ExecStateENS_7JSValueEP10_NPVariant(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i8 = i4 + 24 | 0;
 i9 = i4 + 32 | 0;
 __ZN3JSC12JSLockHolderC1EPNS_9ExecStateE(i5, i1);
 i10 = i3 | 0;
 HEAP32[i10 >> 2] = 0;
 i11 = i3 + 8 | 0;
 i12 = i11;
 ...
 do {
  if ((i14 | 0) == -5) {
   ...
   HEAP32[i23 >> 2] = i22;
   __Z35NPN_InitializeVariantWithStringCopyP10_NPVariantPK9_NPString(i3, i8);
   i15 = HEAP32[i17 >> 2] | 0;
   do {
    if ((i15 | 0) != 0) {
     i17 = i15 | 0;
  ...
  do {
   if ((i18 | 0) == -1) {
    ...
    if (i18 >>> 0 < 4294967289 >>> 0) {
     ...
     d24 = +__ZNK3JSC7JSValue16toNumberSlowCaseEPNS_9ExecStateE(i2, i1);
     break;
    }
   }
  } while (0);
 ...
 if ((i14 | 0) == (-2 | 0)) {
  ...
  do {
   if ((i18 | 0) == -1) {
    ...
    i13 = HEAP32[i2 >> 2] | 0;
    i8 = HEAP32[i13 >> 2] | 0;
    if ((HEAP8[i8 + 52 | 0] | 0) == 5) {
     i25 = __ZNK3JSC8JSString9toBooleanEv(i13) | 0;
     break;
    }
    if ((HEAP8[i8 + 53 | 0] & 1) == 0) {
     i25 = 1;
     break;
    }
    i25 = (HEAP32[i8 + 4 >> 2] | 0) != (HEAP32[(HEAP32[HEAP32[i1 + 16 >> 2] >> 2] | 0) + 4 >> 2] | 0);
   }
  } while (0);
  HEAP8[i11] = i25 & 1;
  __ZN3JSC12JSLockHolderD1Ev(i5);
  ...
  if ((HEAP32[(i14 & -65536) + 1048 >> 2] | 0) == 2) {
   ...
   i26 = (HEAP32[i2 >> 2] | 0) + 32 | 0;
  }
  if ((HEAP32[i26 >> 2] | 0) == (__ZN3JSC8Bindings14CRuntimeObject6s_infoE | 0)) {
   i26 = __ZNK3JSC8Bindings14CRuntimeObject20getInternalCInstanceEv(i14) | 0;
   if ((i26 | 0) == 0) {
    __ZN3JSC12JSLockHolderD1Ev(i5);
    STACKTOP = i4;
    return;
   }
   i14 = HEAP32[i26 + 20 >> 2] | 0;
   __NPN_RetainObject(i14) | 0;
   HEAP32[i10 >> 2] = 6;
   HEAP32[i12 >> 2] = i14;
   __ZN3JSC12JSLockHolderD1Ev(i5);
   STACKTOP = i4;
  ...
  i14 = __ZN3JSC8Bindings14findRootObjectEPNS_14JSGlobalObjectE(__ZN3JSC9ExecState19vmEntryGlobalObjectEv(i1) | 0) | 0;
  if ((i14 | 0) == 0) {
   __ZN3JSC12JSLockHolderD1Ev(i5);
   STACKTOP = i4;
   return;
  ...
  i26 = __Z23_NPN_CreateScriptObjectP4_NPPPN3JSC8JSObjectEN3WTF10PassRefPtrINS1_8Bindings10RootObjectEEE(0, i2, i9) | 0;
  i9 = HEAP32[i1 >> 2] | 0;
  do {
   if ((i9 | 0) != 0) {
    i1 = i9 + 4 | 0;
...
function __ZN3JSC8Bindings23convertNPVariantToValueEPNS_9ExecStateEPK10_NPVariantPNS0_10RootObjectE(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 case 5:
  {
   i9 = i3 + 8 | 0;
   __ZN3WTF6String26fromUTF8WithLatin1FallbackEPKhj(i8, HEAP32[i9 >> 2] | 0, HEAP32[i9 + 4 >> 2] | 0);
 ...
 case 6:
  {
   i10 = HEAP32[i3 + 8 >> 2] | 0;
   if ((HEAP32[i10 >> 2] | 0) == (HEAP32[_NPScriptObjectClass >> 2] | 0)) {
    i8 = HEAP32[i10 + 8 >> 2] | 0;
   ...
   i9 = i6 | 0;
   HEAP32[i9 >> 2] = i4;
   __ZN3JSC8Bindings9CInstanceC1EP8NPObjectN3WTF10PassRefPtrINS0_10RootObjectEEE(i8, i10, i6);
   i6 = HEAP32[i9 >> 2] | 0;
   do {
    if ((i6 | 0) != 0) {
     i9 = i6 + 4 | 0;
   ...
   i6 = i8;
   i4 = __ZN3JSC8Bindings8Instance19createRuntimeObjectEPNS_9ExecStateE(i6, i2) | 0;
   ...
   if ((i2 | 0) == 0) {
    FUNCTION_TABLE_vi[HEAP32[(HEAP32[i8 >> 2] | 0) + 48 >> 2] & 1](i6);
    __ZN3JSC12JSLockHolderD1Ev(i7);
    STACKTOP = i5;
    return;
   } else {
 ...
 case 4:
  {
   ...
   do {
    if (+(i3 | 0) == d11) {
     i4 = HEAP32[i2 + 4 >> 2] | 0;
     i6 = 0;
     if ((i3 | 0) == 0 & ((i4 | 0) < (i6 | 0) | (i4 | 0) == (i6 | 0) & (HEAP32[i2 >> 2] | 0) >>> 0 < 0 >>> 0)) {
      break;
     }
     i6 = i1 | 0;
     HEAP32[i6 >> 2] = i3;
...
function __ZN3JSC8Bindings26identifierFromNPIdentifierEPNS_9ExecStateEPKc(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i7 = i4 + 16 | 0;
 i8 = _strlen(i3 | 0) | 0;
 __ZN3WTF6String8fromUTF8EPKhj(i7, i3, i8);
 i9 = i7 | 0;
 do {
  if ((HEAP32[i9 >> 2] | 0) == 0) {
   __ZN3WTF6StringC1EPKcj(i6, i3, i8);
   i7 = i6 | 0;
   i10 = HEAP32[i7 >> 2] | 0;
   HEAP32[i7 >> 2] = 0;
   i11 = HEAP32[i9 >> 2] | 0;
 ...
 if ((HEAP32[i6 + 16 >> 2] & 4 | 0) == 0) {
  __ZN3JSC10Identifier11addSlowCaseEPNS_9ExecStateEPN3WTF10StringImplE(i5, i2, i6);
  i13 = i5 | 0;
 } else {
  i2 = i5 | 0;
  HEAP32[i2 >> 2] = i6;
...
function __ZN3JSC8Bindings22convertNPStringToUTF16EPK9_NPString(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 __ZN3WTF6String26fromUTF8WithLatin1FallbackEPKhj(i1, HEAP32[i2 >> 2] | 0, HEAP32[i2 + 4 >> 2] | 0);
 return;
}
