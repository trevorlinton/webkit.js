...
var __ZN7WebCore25SpellingCorrectionCommandC1EN3WTF10PassRefPtrINS_5RangeEEERKNS1_6StringE;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore25SpellingCorrectionCommandE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore25SpellingCorrectionCommand7doApplyEv(i1) {
 i1 = i1 | 0;
 ...
 i7 = i2 + 32 | 0;
 i8 = i1 + 152 | 0;
 __ZN7WebCore9plainTextEPKNS_5RangeENS_20TextIteratorBehaviorEb(i4, HEAP32[i8 >> 2] | 0, 0, 0);
 i9 = i4 | 0;
 i4 = HEAP32[i9 >> 2] | 0;
 HEAP32[i9 >> 2] = 0;
 i10 = i1 + 216 | 0;
 ...
 i11 = i1 + 156 | 0;
 if (!(__ZNK7WebCore14FrameSelection21shouldChangeSelectionERKNS_16VisibleSelectionE(HEAP32[(__ZN7WebCore11EditCommand5frameEv(i1 | 0) | 0) + 468 >> 2] | 0, i11) | 0)) {
  STACKTOP = i2;
  return;
 }
 i10 = HEAP32[i8 >> 2] | 0;
 ...
 __ZN7WebCore22createFragmentFromTextERNS_5RangeERKN3WTF6StringE(i5, i10, i1 + 220 | 0);
 i10 = i5 | 0;
 i5 = HEAP32[i10 >> 2] | 0;
 HEAP32[i10 >> 2] = 0;
 if ((i5 | 0) == 0) {
 ...
 i10 = i1 | 0;
 i8 = __ZN3WTF10fastMallocEj(200) | 0;
 __ZN7WebCore19SetSelectionCommandC1ERKNS_16VisibleSelectionEj(i8, i11, 14);
 i11 = i6 | 0;
 HEAP32[i11 >> 2] = i8;
 __ZN7WebCore20CompositeEditCommand23applyCommandToCompositeEN3WTF10PassRefPtrINS_11EditCommandEEE(i10, i6);
 i6 = HEAP32[i11 >> 2] | 0;
 do {
  if ((i6 | 0) != 0) {
   i11 = i6 + 4 | 0;
 ...
 i12 = i3 | 0;
 HEAP32[i12 >> 2] = i5;
 __ZN7WebCore23ReplaceSelectionCommandC1ERNS_8DocumentEN3WTF10PassRefPtrINS_16DocumentFragmentEEEjNS_10EditActionE(i1, i6, i3, 4, 29);
 i3 = HEAP32[i12 >> 2] | 0;
 do {
  if ((i3 | 0) != 0) {
   i12 = i3 + 8 | 0;
 ...
 i3 = i7 | 0;
 HEAP32[i3 >> 2] = i1;
 __ZN7WebCore20CompositeEditCommand23applyCommandToCompositeEN3WTF10PassRefPtrINS_11EditCommandEEE(i10, i7);
 i7 = HEAP32[i3 >> 2] | 0;
 if ((i7 | 0) == 0) {
  STACKTOP = i2;
  return;
...
function __ZN7WebCore25SpellingCorrectionCommandD2Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0, i5 = 0;
 ...
 __ZN7WebCore16VisibleSelectionD2Ev(i1 + 156 | 0);
 i2 = HEAP32[i1 + 152 >> 2] | 0;
 if ((i2 | 0) == 0) {
  i5 = i1 | 0;
  __ZN7WebCore20CompositeEditCommandD2Ev(i5);
  return;
 }
 i3 = i2 | 0;
...
function __ZN7WebCore25SpellingCorrectionCommandC2EN3WTF10PassRefPtrINS_5RangeEEERKNS1_6StringE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
 i4 = i2 | 0;
 __ZN7WebCore20CompositeEditCommandC2ERNS_8DocumentE(i1 | 0, HEAP32[(HEAP32[(HEAP32[(HEAP32[i4 >> 2] | 0) + 8 >> 2] | 0) + 20 >> 2] | 0) + 8 >> 2] | 0);
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i4 >> 2] | 0;
 HEAP32[i4 >> 2] = 0;
 HEAP32[i1 + 152 >> 2] = i2;
 __ZN7WebCore16VisibleSelectionC1EPKNS_5RangeENS_9EAffinityEb(i1 + 156 | 0, i2, 1, 0);
 HEAP32[i1 + 216 >> 2] = 0;
 i2 = HEAP32[i3 >> 2] | 0;
 HEAP32[i1 + 220 >> 2] = i2;
 if ((i2 | 0) == 0) {
...
function __ZN7WebCore25SpellingCorrectionCommandC1EN3WTF10PassRefPtrINS_5RangeEEERKNS1_6StringE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
function __ZN7WebCore25SpellingCorrectionCommandD0Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore25SpellingCorrectionCommandD2Ev(i1);
...
function __ZN7WebCore25SpellingCorrectionCommandD1Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore25SpellingCorrectionCommandD2Ev(i1);
 return;
}
...
function __ZNK7WebCore25SpellingCorrectionCommand35shouldRetainAutocorrectionIndicatorEv(i1) {
 i1 = i1 | 0;
 return 1;
}
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,__ZN7WebCore25SpellingCorrectionCommand7doApplyEv,b0,__ZN7WebCore25SpellingCorrectionCommandD1Ev,b0,__ZN7WebCore25SpellingCorrectionCommandD0Ev,b0];
  ...
  var FUNCTION_TABLE_ii = [b2,b2,ii___ZNK7WebCore11EditCommand13editingActionEv__wrapper,b2,ii___ZNK7WebCore20CompositeEditCommand15isTypingCommandEv__wrapper,b2,ii___ZNK7WebCore20CompositeEditCommand19isCreateLinkCommandEv__wrapper,b2,ii___ZNK7WebCore20CompositeEditCommand20preservesTypingStyleEv__wrapper,b2,__ZNK7WebCore20CompositeEditCommand22isCompositeEditCommandEv,b2,__ZNK7WebCore11EditCommand24isEditCommandCompositionEv,b2,__ZNK7WebCore11EditCommand19isSimpleEditCommandEv,b2,__ZNK7WebCore20CompositeEditCommand18isDictationCommandEv,b2,__ZNK7WebCore25SpellingCorrectionCommand35shouldRetainAutocorrectionIndicatorEv,b2,__ZNK7WebCore20CompositeEditCommand23shouldStopCaretBlinkingEv,b2,b2,b2,b2,b2,b2,b2,b2
  ,b2,b2,b2];
  var FUNCTION_TABLE_viii = [b3,b3,__ZN7WebCore25SpellingCorrectionCommandC2EN3WTF10PassRefPtrINS_5RangeEEERKNS1_6StringE,b3,viii___ZN7WebCore20CompositeEditCommand10removeNodeEN3WTF10PassRefPtrINS_4NodeEEENS_35ShouldAssumeContentIsAlwaysEditableE__wrapper,b3,b3,b3];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZN7WebCore25SpellingCorrectionCommand7doApplyEv","__ZN7WebCore25SpellingCorrectionCommandC2EN3WTF10PassRefPtrINS_5RangeEEERKNS1_6StringE","_strlen","__ZN7WebCore16VisibleSelectionD2Ev","__ZN7WebCore25SpellingCorrectionCommandD1Ev","__ZNK7WebCore20CompositeEditCommand22isCompositeEditCommandEv","__ZN7WebCore25SpellingCorrectionCommandD0Ev","_memset","_memcpy","__ZNK7WebCore11EditCommand24isEditCommandCompositionEv","__ZNK7WebCore11EditCommand19isSimpleEditCommandEv","__ZN7WebCore25SpellingCorrectionCommandD2Ev","__ZNK7WebCore20CompositeEditCommand18isDictationCommandEv","__ZNK7WebCore20CompositeEditCommand23shouldStopCaretBlinkingEv","__ZNK7WebCore25SpellingCorrectionCommand35shouldRetainAutocorrectionIndicatorEv"]
