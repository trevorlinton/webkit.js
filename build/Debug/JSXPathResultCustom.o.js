...
function __ZN7WebCore13JSXPathResult13visitChildrenEPN3JSC6JSCellERNS1_11SlotVisitorE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 i6 = (HEAP32[i1 + 12 >> 2] | 0) + 8 | 0;
 if ((HEAP32[i6 >> 2] | 0) != 0) {
  STACKTOP = i3;
  return;
 }
 i1 = __ZNK7WebCore5XPath5Value9toNodeSetEv(i6) | 0;
 i6 = i1 + 12 | 0;
 if ((HEAP32[i6 >> 2] | 0) == 0) {
  STACKTOP = i3;
  return;
 ...
 while (1) {
  ...
  if ((i9 & 256 | 0) == 0) {
   ...
   i15 = HEAP32[(HEAP32[i8 + 20 >> 2] | 0) + 8 >> 2] | 0;
  }
  HEAP32[i4 >> 2] = i15;
  __ZN3WTF9HashTableIPvS1_NS_17IdentityExtractorENS_7PtrHashIS1_EENS_10HashTraitsIS1_EES6_E3addINS_22IdentityHashTranslatorIS4_EERKS1_SC_EENS_18HashTableAddResultINS_17HashTableIteratorIS1_S1_S2_S4_S6_S6_EEEEOT0_OT1_(i5, i1, i4, i4);
  i2 = i2 + 1 | 0;
