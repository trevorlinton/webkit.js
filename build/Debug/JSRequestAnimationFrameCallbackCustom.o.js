...
function __ZN7WebCore31JSRequestAnimationFrameCallback11handleEventEd(i1, d2) {
 i1 = i1 | 0;
 d2 = +d2;
 ...
 i7 = i3 + 96 | 0;
 i8 = i3 + 104 | 0;
 if (!(__ZNK7WebCore17ActiveDOMCallback17canInvokeCallbackEv(i1 + 16 | 0) | 0)) {
  i9 = 1;
  STACKTOP = i3;
  return i9 | 0;
 }
 ...
 i10 = i1 + 24 | 0;
 __ZN3JSC12JSLockHolderC1ERNS_2VME(i5, HEAP32[(HEAP32[(HEAP32[HEAP32[(HEAP32[i10 >> 2] | 0) + 4 >> 2] >> 2] & -65536) + 1076 >> 2] | 0) + 20544 >> 2] | 0);
 i11 = i6 | 0;
 HEAP32[i11 >> 2] = 0;
 i12 = i6 + 4 | 0;
 HEAP32[i12 >> 2] = 8;
 ...
 do {
  if (+(i16 | 0) != d2) {
   ...
   i21 = 0;
   if ((i16 | 0) == 0 & ((i20 | 0) < (i21 | 0) | (i20 | 0) == (i21 | 0) & i19 >>> 0 < 0 >>> 0)) {
    i17 = i20;
    i18 = i19;
    break;
   }
 ...
 HEAP32[i11 >> 2] = 1;
 HEAP8[i7] = 0;
 __ZN7WebCore14JSCallbackData14invokeCallbackERN3JSC20MarkedArgumentBufferEPb(i8, HEAP32[i10 >> 2] | 0, i6, i7);
 i10 = (HEAP8[i7] & 1) == 0;
 i7 = HEAP32[i15 >> 2] | 0;
 if ((i7 | 0) != 0) {
  HEAP32[i4 >> 2] = i6;
  __ZN3WTF7HashSetIPN3JSC20MarkedArgumentBufferENS_7PtrHashIS3_EENS_10HashTraitsIS3_EEE6removeERKS3_(i7, i4) | 0;
 }
 do {
  if ((HEAP32[i12 >> 2] | 0) != 8) {
   i4 = HEAP32[i13 >> 2] | 0;
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZN3WTF7HashSetIPN3JSC20MarkedArgumentBufferENS_7PtrHashIS3_EENS_10HashTraitsIS3_EEE6removeERKS3_","_memset","__ZN7WebCore31JSRequestAnimationFrameCallback11handleEventEd","_memcpy","__ZN3WTF9HashTableIPN3JSC20MarkedArgumentBufferES3_NS_17IdentityExtractorENS_7PtrHashIS3_EENS_10HashTraitsIS3_EES8_E6removeEPS3_"]
