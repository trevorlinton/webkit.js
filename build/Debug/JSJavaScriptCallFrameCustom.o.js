...
/* memory initializer */ allocate([112,114,111,103,114,97,109,0,102,117,110,99,116,105,111,110,0,0,0,0,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE+H_BASE)
;
;
;
;
...
function __ZN7WebCore21JSJavaScriptCallFrame9scopeTypeEPN3JSC9ExecStateE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i8 = i4 + 24 | 0;
 i9 = i2 + 12 | 0;
 if ((__ZNK3JSC17DebuggerCallFrame5scopeEv(HEAP32[(HEAP32[i9 >> 2] | 0) + 4 >> 2] | 0) | 0) == 0) {
  HEAP32[i1 + 4 >> 2] = -4;
  HEAP32[i1 >> 2] = 0;
  STACKTOP = i4;
  return;
 ...
 do {
  if ((HEAP32[i3 + 32 >> 2] | 0) != 1) {
   i2 = i3 + 48 | 0;
   i10 = HEAP32[i2 >> 2] | 0;
   if (!((i10 & 0 | 0) == 0 & (HEAP32[i2 + 4 >> 2] & -1 | 0) == (-1 | 0))) {
    break;
   }
   i2 = __ZNK3JSC17DebuggerCallFrame5scopeEv(HEAP32[(HEAP32[i9 >> 2] | 0) + 4 >> 2] | 0) | 0;
   L8 : do {
    if ((i2 | 0) != 0) {
     i11 = i2;
     i12 = 0;
     ...
     L9 : while (1) {
      do {
       if ((HEAP8[(HEAP32[(__ZN3JSC7JSScope13objectAtScopeEPS0_(i11) | 0) >> 2] | 0) + 52 | 0] | 0) == 28) {
        i14 = (i13 | 0) != 0;
        if (i12) {
         if (i14) {
          i15 = 1;
     ...
     if ((i16 | 0) == 10) {
      HEAP32[i5 >> 2] = 0;
      i13 = __ZN7WebCore32jsJavaScriptCallFrameLOCAL_SCOPEEPN3JSC9ExecStateExxNS0_12PropertyNameE(i3, 0, 0, 0, 0, i5) | 0;
      i12 = i1 | 0;
      HEAP32[i12 >> 2] = i13;
      ...
      HEAP32[i6 >> 2] = 0;
      i12 = __ZN7WebCore34jsJavaScriptCallFrameCLOSURE_SCOPEEPN3JSC9ExecStateExxNS0_12PropertyNameE(i3, 0, 0, 0, 0, i6) | 0;
      i13 = i1 | 0;
      HEAP32[i13 >> 2] = i12;
      ...
      if ((HEAP32[i11 + 8 >> 2] | 0) == 0) {
       HEAP32[i7 >> 2] = 0;
       i13 = __ZN7WebCore33jsJavaScriptCallFrameGLOBAL_SCOPEEPN3JSC9ExecStateExxNS0_12PropertyNameE(i3, 0, 0, 0, 0, i7) | 0;
       i12 = i1 | 0;
       HEAP32[i12 >> 2] = i13;
       HEAP32[i12 + 4 >> 2] = tempRet0;
       STACKTOP = i4;
       ...
       HEAP32[i8 >> 2] = 0;
       i12 = __ZN7WebCore31jsJavaScriptCallFrameWITH_SCOPEEPN3JSC9ExecStateExxNS0_12PropertyNameE(i3, 0, 0, 0, 0, i8) | 0;
       i13 = i1 | 0;
       HEAP32[i13 >> 2] = i12;
       HEAP32[i13 + 4 >> 2] = tempRet0;
       STACKTOP = i4;
...
function __ZNK7WebCore21JSJavaScriptCallFrame4typeEPN3JSC9ExecStateE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i9 = i4 + 32 | 0;
 i10 = i4 + 40 | 0;
 i11 = __ZNK3JSC17DebuggerCallFrame4typeEv(HEAP32[(HEAP32[i2 + 12 >> 2] | 0) + 4 >> 2] | 0) | 0;
 if ((i11 | 0) == 1) {
  ...
  i13 = __ZN3JSC8JSString6createERNS_2VMEN3WTF10PassRefPtrINS3_10StringImplEEE(i8, i5) | 0;
  i5 = HEAP32[i12 >> 2] | 0;
  do {
   if ((i5 | 0) != 0) {
    i12 = i5 | 0;
  ...
  i5 = __ZN3JSC8JSString6createERNS_2VMEN3WTF10PassRefPtrINS3_10StringImplEEE(i10, i6) | 0;
  i6 = HEAP32[i11 >> 2] | 0;
  do {
   if ((i6 | 0) != 0) {
    i11 = i6 | 0;
...
function __ZNK7WebCore21JSJavaScriptCallFrame10scopeChainEPN3JSC9ExecStateE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i10 = __ZNK3JSC17DebuggerCallFrame5scopeEv(HEAP32[(HEAP32[i9 >> 2] | 0) + 4 >> 2] | 0) | 0;
 i9 = i8 | 0;
 HEAP32[i9 >> 2] = 0;
 i11 = i8 + 4 | 0;
 HEAP32[i11 >> 2] = 8;
 ...
 i15 = i10;
 while (1) {
  i10 = __ZN3JSC7JSScope13objectAtScopeEPS0_(i15) | 0;
  i16 = (i10 | 0) == 0;
  i17 = HEAP32[i9 >> 2] | 0;
  i18 = (i16 ? 0 : 0) | i10;
  i10 = (i16 ? -6 : -5) | 0;
  if ((i17 | 0) < (HEAP32[i11 >> 2] | 0)) {
   i16 = (HEAP32[i12 >> 2] | 0) + (i17 << 3) | 0;
   HEAP32[i16 >> 2] = i18;
   HEAP32[i16 + 4 >> 2] = i10;
 ...
 i3 = __ZN3JSC7JSArray22tryCreateUninitializedERNS_2VMEPNS_9StructureEj(i9, HEAP32[(HEAP32[(HEAP32[i2 >> 2] | 0) + 4 >> 2] | 0) + 244 >> 2] | 0, i5) | 0;
 if ((i3 | 0) == 0) {
  _WTFCrash();
 }
 if ((i5 | 0) != 0) {
  ...
  while (1) {
   ...
   __ZN3JSC8JSObject15initializeIndexERNS_2VMEjNS_7JSValueE(i2, i9, i16, i6);
   i16 = i16 + 1 | 0;
   if (i16 >>> 0 >= i5 >>> 0) {
    break;
   }
...
function __ZN7WebCore21JSJavaScriptCallFrame8evaluateEPN3JSC9ExecStateE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 if ((i11 | 0) == 6) {
  i14 = __ZNK3JSC7JSValue16toStringSlowCaseEPNS_9ExecStateE(i6, i3) | 0;
 }
 if ((HEAP32[i14 + 12 >> 2] | 0) == 0) {
  __ZNK3JSC12JSRopeString11resolveRopeEPNS_9ExecStateE(i14, i3);
 }
 __ZNK3JSC17DebuggerCallFrame8evaluateERKN3WTF6StringERNS_7JSValueE(i1, HEAP32[i10 + 4 >> 2] | 0, i14 + 12 | 0, i5);
 if ((HEAP32[i9 >> 2] | 0) == -6) {
  STACKTOP = i4;
  return;
 }
 ...
 HEAP32[i10 + 4 >> 2] = i5;
 __ZN3JSC2VM14throwExceptionEPNS_9ExecStateENS_7JSValueE(i8, i9, i3, i7);
 STACKTOP = i4;
 return;
}
...
function __ZNK7WebCore21JSJavaScriptCallFrame10thisObjectEPN3JSC9ExecStateE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 __ZNK3JSC17DebuggerCallFrame9thisValueEv(i1, HEAP32[(HEAP32[i2 + 12 >> 2] | 0) + 4 >> 2] | 0);
 return;
}
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZN3JSC8JSObject15initializeIndexERNS_2VMEjNS_7JSValueE","_strlen","__ZN3WTF7HashSetIPN3JSC20MarkedArgumentBufferENS_7PtrHashIS3_EENS_10HashTraitsIS3_EEE6removeERKS3_","__ZN7WebCore21JSJavaScriptCallFrame9scopeTypeEPN3JSC9ExecStateE","__ZN3JSC7JSArray22tryCreateUninitializedERNS_2VMEPNS_9StructureEj","_memset","_memcpy","__ZNK7WebCore21JSJavaScriptCallFrame10thisObjectEPN3JSC9ExecStateE","__ZNK7WebCore21JSJavaScriptCallFrame4typeEPN3JSC9ExecStateE","__ZN3JSC8JSString6createERNS_2VMEN3WTF10PassRefPtrINS3_10StringImplEEE","__ZNK7WebCore21JSJavaScriptCallFrame10scopeChainEPN3JSC9ExecStateE","__ZN7WebCore21JSJavaScriptCallFrame8evaluateEPN3JSC9ExecStateE","__ZN3WTF9HashTableIPN3JSC20MarkedArgumentBufferES3_NS_17IdentityExtractorENS_7PtrHashIS3_EENS_10HashTraitsIS3_EES8_E6removeEPS3_"]
