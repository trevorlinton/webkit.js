...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore22SVGAltGlyphItemElementE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZNK7WebCore22SVGAltGlyphItemElement21hasValidGlyphElementsERN3WTF6VectorINS1_6StringELj0ENS1_15CrashOnOverflowEEE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 L1 : do {
  if ((i5 | 0) == 0) {
   ...
   i1 = HEAP32[__ZN7WebCore8SVGNames11glyphRefTagE >> 2] | 0;
   i7 = i1 + 12 | 0;
   i8 = i1 + 16 | 0;
   i9 = i5;
   L3 : while (1) {
   ...
   while (1) {
    ...
    do {
     if (__ZNK7WebCore18SVGGlyphRefElement20hasValidGlyphElementERN3WTF6StringE(i12, i4) | 0) {
      i13 = HEAP32[i7 >> 2] | 0;
      if ((i13 | 0) != (HEAP32[i1 >> 2] | 0)) {
       i14 = HEAP32[i8 >> 2] | 0;
       HEAP32[(HEAP32[i10 >> 2] | 0) + (i13 << 2) >> 2] = i14;
       if ((i14 | 0) != 0) {
        i15 = i14 | 0;
      ...
      i14 = HEAP32[i18 >> 2] | 0;
      HEAP32[i19 + (HEAP32[i7 >> 2] << 2) >> 2] = i14;
      if ((i14 | 0) != 0) {
       i13 = i14 | 0;
    ...
    i15 = HEAP32[__ZN7WebCore8SVGNames11glyphRefTagE >> 2] | 0;
    i13 = i15 + 12 | 0;
    i14 = i15 + 16 | 0;
    i21 = i17;
    L55 : while (1) {
...
function __ZN7WebCore22SVGAltGlyphItemElement6createERKNS_13QualifiedNameERNS_8DocumentE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
function __ZN7WebCore22SVGAltGlyphItemElement16rendererIsNeededERKNS_11RenderStyleE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 return 0;
}
...
function __ZN7WebCore22SVGAltGlyphItemElementD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore22SVGAltGlyphItemElementD1Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore10SVGElementD2Ev(i1 | 0);
 return;
}
