...
function __ZNK7WebCore19CSSAspectRatioValue13customCSSTextEv(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 i5 = i3 + 16 | 0;
 i6 = i3 + 24 | 0;
 __ZN3WTF6String6numberEdjNS_29TrailingZerosTruncatingPolicyE(i5, +HEAPF32[i2 + 8 >> 2], 6, 1);
 i7 = i5 | 0;
 i5 = HEAP32[i7 >> 2] | 0;
 do {
  if ((i5 | 0) == 0) {
 ...
 __ZN3WTF6String6numberEdjNS_29TrailingZerosTruncatingPolicyE(i6, +HEAPF32[i2 + 12 >> 2], 6, 1);
 i2 = (i8 | 0) == 0;
 if (!i2) {
  i5 = i8 | 0;
...
function __ZNK7WebCore19CSSAspectRatioValue6equalsERKS0_(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 ...
 i3 = +HEAPF32[i1 + 12 >> 2] == +HEAPF32[i2 + 12 >> 2];
 return i3 | 0;
}
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZNK3WTF12StringAppendINS0_INS_6StringEcEES1_EcvS1_Ev","_strlen","__ZNK7WebCore19CSSAspectRatioValue6equalsERKS0_","__ZNK7WebCore19CSSAspectRatioValue13customCSSTextEv","__ZN3WTF13tryMakeStringINS_12StringAppendINS_6StringEcEES2_EENS_10PassRefPtrINS_10StringImplEEET_T0_","_memset","_memcpy"]
