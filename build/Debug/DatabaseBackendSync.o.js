...
var __ZN7WebCore19DatabaseBackendSyncD1Ev;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore19DatabaseBackendSyncE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore19DatabaseBackendSyncC2EN3WTF10PassRefPtrINS_22DatabaseBackendContextEEERKNS1_6StringES7_S7_m(i1, i2, i3, i4, i5, i6) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 HEAP32[i10 >> 2] = 0;
 HEAP32[i9 >> 2] = i2;
 __ZN7WebCore19DatabaseBackendBaseC2EN3WTF10PassRefPtrINS_22DatabaseBackendContextEEERKNS1_6StringES7_S7_mNS_12DatabaseTypeE(i1 | 0, i8, i3, i4, i5, i6, 1);
 i6 = HEAP32[i9 >> 2] | 0;
 do {
  if ((i6 | 0) != 0) {
   i9 = i6 + 12 | 0;
...
function __ZN7WebCore19DatabaseBackendSyncD2Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = i1 | 0;
 if ((HEAP8[i1 + 44 | 0] & 1) == 0) {
  __ZN7WebCore19DatabaseBackendBaseD2Ev(i2);
  return;
 }
 __ZN7WebCore19DatabaseBackendBase13closeDatabaseEv(i2);
 __ZN7WebCore19DatabaseBackendBaseD2Ev(i2);
 return;
}
function __ZN7WebCore19DatabaseBackendSyncD1Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = i1 | 0;
...
function __ZN7WebCore19DatabaseBackendSyncD0Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = i1 | 0;
...
function __ZN7WebCore19DatabaseBackendSync20openAndVerifyVersionEbRNS_13DatabaseErrorERN3WTF6StringE(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 return FUNCTION_TABLE_iiiii[HEAP32[(HEAP32[i1 >> 2] | 0) + 48 >> 2] & 7](i1 | 0, i2, i3, i4) | 0;
}
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_iiiii = [b0,b0,__ZN7WebCore19DatabaseBackendSync20openAndVerifyVersionEbRNS_13DatabaseErrorERN3WTF6StringE,b0,iiiii___ZN7WebCore19DatabaseBackendBase20performOpenAndVerifyEbRNS_13DatabaseErrorERN3WTF6StringE__wrapper,b0,b0,b0];
  var FUNCTION_TABLE_vi = [b1,b1,__ZN7WebCore19DatabaseBackendSyncD0Ev,b1,__ZN7WebCore19DatabaseBackendSyncD2Ev,b1,b1,b1];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZN7WebCore19DatabaseBackendSync20openAndVerifyVersionEbRNS_13DatabaseErrorERN3WTF6StringE","__ZN7WebCore19DatabaseBackendSyncD0Ev","__ZN7WebCore19DatabaseBackendSyncC2EN3WTF10PassRefPtrINS_22DatabaseBackendContextEEERKNS1_6StringES7_S7_m","_memset","_memcpy","_strlen","__ZN7WebCore19DatabaseBackendSyncD2Ev"]
