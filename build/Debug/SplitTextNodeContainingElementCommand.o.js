...
var __ZN7WebCore37SplitTextNodeContainingElementCommandC1EN3WTF10PassRefPtrINS_4TextEEEi;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore37SplitTextNodeContainingElementCommandE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore37SplitTextNodeContainingElementCommand7doApplyEv(i1) {
 i1 = i1 | 0;
 ...
 __ZN7WebCore20CompositeEditCommand13splitTextNodeEN3WTF10PassRefPtrINS_4TextEEEj(i7, i3, HEAP32[i1 + 156 >> 2] | 0);
 i1 = HEAP32[i10 >> 2] | 0;
 do {
  if ((i1 | 0) != 0) {
   i10 = i1 + 8 | 0;
 ...
 do {
  if ((i13 | 0) == 17) {
   ...
   __ZN7WebCore20CompositeEditCommand23wrapContentsInDummySpanEN3WTF10PassRefPtrINS_7ElementEEE(i7, i4);
   i12 = HEAP32[i3 >> 2] | 0;
   do {
    if ((i12 | 0) != 0) {
     i3 = i12 + 8 | 0;
 ...
 __ZN7WebCore20CompositeEditCommand12splitElementEN3WTF10PassRefPtrINS_7ElementEEENS2_INS_4NodeEEE(i7, i5, i6);
 i6 = HEAP32[i4 >> 2] | 0;
 do {
  if ((i6 | 0) != 0) {
   i4 = i6 + 8 | 0;
...
function __ZN7WebCore37SplitTextNodeContainingElementCommandD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore37SplitTextNodeContainingElementCommandD1Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0, i5 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i1 + 152 >> 2] | 0;
...
function __ZN7WebCore37SplitTextNodeContainingElementCommandC2EN3WTF10PassRefPtrINS_4TextEEEi(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
function __ZN7WebCore37SplitTextNodeContainingElementCommandC1EN3WTF10PassRefPtrINS_4TextEEEi(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,__ZN7WebCore37SplitTextNodeContainingElementCommand7doApplyEv,b0,__ZN7WebCore37SplitTextNodeContainingElementCommandD0Ev,b0,__ZN7WebCore37SplitTextNodeContainingElementCommandD1Ev,b0];
  ...
  ,b2,b2,b2];
  var FUNCTION_TABLE_viii = [b3,b3,__ZN7WebCore37SplitTextNodeContainingElementCommandC2EN3WTF10PassRefPtrINS_4TextEEEi,b3,viii___ZN7WebCore20CompositeEditCommand10removeNodeEN3WTF10PassRefPtrINS_4NodeEEENS_35ShouldAssumeContentIsAlwaysEditableE__wrapper,b3,b3,b3];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZNK7WebCore20CompositeEditCommand18isDictationCommandEv","_strlen","__ZN7WebCore37SplitTextNodeContainingElementCommandC2EN3WTF10PassRefPtrINS_4TextEEEi","__ZNK7WebCore20CompositeEditCommand22isCompositeEditCommandEv","_memset","_memcpy","__ZNK7WebCore11EditCommand24isEditCommandCompositionEv","__ZNK7WebCore11EditCommand19isSimpleEditCommandEv","__ZN7WebCore37SplitTextNodeContainingElementCommand7doApplyEv","__ZN7WebCore37SplitTextNodeContainingElementCommandD0Ev","__ZNK7WebCore20CompositeEditCommand23shouldStopCaretBlinkingEv","__ZN7WebCore37SplitTextNodeContainingElementCommandD1Ev"]
