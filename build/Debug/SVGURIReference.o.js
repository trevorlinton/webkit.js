...
function __ZN7WebCore15SVGURIReference26targetElementFromIRIStringERKN3WTF6StringERNS_8DocumentEPS2_PS5_(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 L1 : do {
  if ((i21 | 0) == 0) {
   ...
   __ZNK3WTF6String9substringEjj(i9, i1, i26 + 1 | 0, -1);
   i24 = i9 | 0;
   i25 = HEAP32[i24 >> 2] | 0;
   HEAP32[i24 >> 2] = 0;
   i24 = HEAP32[(HEAP32[i2 >> 2] | 0) + 80 >> 2] | 0;
   if ((i26 | 0) == 0) {
    FUNCTION_TABLE_vii[i24 & 1](i14, i2);
    __ZNK3WTF6String9substringEjj(i15, i1, 0, -1);
    __ZN7WebCore3URLC1ERKS0_RKN3WTF6StringE(i16, i14, i15);
    i23 = HEAP32[i15 >> 2] | 0;
    do {
     if ((i23 | 0) != 0) {
      i27 = i23 | 0;
   ...
   FUNCTION_TABLE_vii[i24 & 1](i11, i2);
   __ZNK3WTF6String9substringEjj(i12, i1, 0, i26);
   __ZN7WebCore3URLC1ERKS0_RKN3WTF6StringE(i10, i11, i12);
   i27 = HEAP32[i12 >> 2] | 0;
   do {
    if ((i27 | 0) != 0) {
     i28 = i27 | 0;
   ...
   __ZNK3WTF6String9substringEjj(i13, i1, i26, -1);
   __ZN7WebCore3URLC1ERKS0_RKN3WTF6StringE(i16, i10, i13);
   i27 = HEAP32[i13 >> 2] | 0;
   do {
    if ((i27 | 0) != 0) {
     i23 = i27 | 0;
 ...
 i17 = i16 | 0;
 i16 = __ZN3WTF5equalEPKNS_10StringImplES2_(HEAP32[i17 >> 2] | 0, HEAP32[i10 >> 2] | 0) | 0;
 i13 = HEAP32[i10 >> 2] | 0;
 do {
  if ((i13 | 0) != 0) {
   i10 = i13 | 0;
  ...
  if (i16) {
   ...
   if ((i4 | 0) != 0) {
    if ((HEAP32[i29 + 16 >> 2] & 16 | 0) == 0) {
     __ZN3WTF12AtomicString11addSlowCaseEPNS_10StringImplE(i8, i29);
     i31 = i8 | 0;
    } else {
     i25 = i8 | 0;
     HEAP32[i25 >> 2] = i29;
    ...
    i25 = i18 | 0;
    HEAP32[i25 >> 2] = HEAP32[i31 >> 2];
    i10 = __ZNK7WebCore9TreeScope14getElementByIdERKN3WTF12AtomicStringE(i4 + 44 | 0, i18) | 0;
    i13 = HEAP32[i25 >> 2] | 0;
    if ((i13 | 0) == 0) {
     i30 = i10;
     break;
   ...
   if ((i10 | 0) == 0) {
    ...
    if (!(__ZNK3WTF10StringImpl10startsWithEt(i10, 35) | 0)) {
     i22 = 60;
    }
   }
   do {
    if ((i22 | 0) == 60) {
     __ZNK7WebCore8Document11completeURLERKN3WTF6StringE(i7, i2, i1);
     i10 = __ZN7WebCore31equalIgnoringFragmentIdentifierERKNS_3URLES2_(i7, i2 + 356 | 0) | 0;
     i26 = HEAP32[i7 >> 2] | 0;
     if ((i26 | 0) == 0) {
      if (i10) {
       break;
   ...
   i13 = __ZNK7WebCore9TreeScope14getElementByIdERKN3WTF12AtomicStringE(i2 + 44 | 0, i19) | 0;
   i25 = HEAP32[i10 >> 2] | 0;
   if ((i25 | 0) == 0) {
    i30 = i13;
    break;
...
function __ZN7WebCore15SVGURIReference31fragmentIdentifierFromIRIStringERKN3WTF6StringERNS_8DocumentE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 L1 : do {
  if ((i10 | 0) != 0) {
   ...
   i12 = HEAP32[(HEAP32[i3 >> 2] | 0) + 80 >> 2] | 0;
   do {
    if ((i14 | 0) == 0) {
     FUNCTION_TABLE_vii[i12 & 1](i5, i3);
    } else {
     FUNCTION_TABLE_vii[i12 & 1](i6, i3);
     __ZNK3WTF6String9substringEjj(i7, i2, 0, i14);
     __ZN7WebCore3URLC1ERKS0_RKN3WTF6StringE(i5, i6, i7);
     i13 = HEAP32[i7 >> 2] | 0;
     do {
      if ((i13 | 0) != 0) {
       i11 = i13 | 0;
   ...
   __ZNK3WTF6String9substringEjj(i8, i2, i14, -1);
   __ZN7WebCore3URLC1ERKS0_RKN3WTF6StringE(i9, i5, i8);
   do {
    if (__ZN7WebCore31equalIgnoringFragmentIdentifierERKNS_3URLES2_(i9, i3 + 356 | 0) | 0) {
     __ZNK3WTF6String9substringEjj(i1, i8, 1, -1);
    } else {
...
function __ZN7WebCore15SVGURIReference14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0, i5 = 0;
 i4 = HEAP32[i2 >> 2] | 0;
 i2 = HEAP32[__ZN7WebCore10XLinkNames8hrefAttrE >> 2] | 0;
 do {
  if ((i4 | 0) != (i2 | 0)) {
 ...
 FUNCTION_TABLE_viii[HEAP32[(HEAP32[i1 >> 2] | 0) + 8 >> 2] & 1](i1, i3 | 0, 1);
 i5 = 1;
 return i5 | 0;
}
function __ZN7WebCore15SVGURIReference22addSupportedAttributesERN3WTF7HashSetINS_13QualifiedNameENS_17QualifiedNameHashENS1_10HashTraitsIS3_EEEE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i1 = STACKTOP;
 STACKTOP = STACKTOP + 16 | 0;
 __ZN3WTF9HashTableIN7WebCore13QualifiedNameES2_NS_17IdentityExtractorENS1_17QualifiedNameHashENS_10HashTraitsIS2_EES6_E3addINS_22IdentityHashTranslatorIS4_EERKS2_SC_EENS_18HashTableAddResultINS_17HashTableIteratorIS2_S2_S3_S4_S6_S6_EEEEOT0_OT1_(i1 | 0, i2 | 0, __ZN7WebCore10XLinkNames8hrefAttrE, __ZN7WebCore10XLinkNames8hrefAttrE);
 STACKTOP = i1;
 return;
}
...
function __ZN7WebCore15SVGURIReference16isKnownAttributeERKNS_13QualifiedNameE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 i1 = HEAP32[i2 >> 2] | 0;
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZN7WebCore15SVGURIReference26targetElementFromIRIStringERKN3WTF6StringERNS_8DocumentEPS2_PS5_","__ZN7WebCore15SVGURIReference16isKnownAttributeERKNS_13QualifiedNameE","__ZN7WebCore15SVGURIReference31fragmentIdentifierFromIRIStringERKN3WTF6StringERNS_8DocumentE","__ZN7WebCore15SVGURIReference22addSupportedAttributesERN3WTF7HashSetINS_13QualifiedNameENS_17QualifiedNameHashENS1_10HashTraitsIS3_EEEE","__ZN3WTF9HashTableIN7WebCore13QualifiedNameES2_NS_17IdentityExtractorENS1_17QualifiedNameHashENS_10HashTraitsIS2_EES6_E6rehashEiPS2_","_memset","__ZN3WTF9HashTableIN7WebCore13QualifiedNameES2_NS_17IdentityExtractorENS1_17QualifiedNameHashENS_10HashTraitsIS2_EES6_E16lookupForWritingINS_22IdentityHashTranslatorIS4_EES2_EENSt3__14pairIPS2_bEERKT0_","__ZN3WTF9HashTableIN7WebCore13QualifiedNameES2_NS_17IdentityExtractorENS1_17QualifiedNameHashENS_10HashTraitsIS2_EES6_E3addINS_22IdentityHashTranslatorIS4_EERKS2_SC_EENS_18HashTableAddResultINS_17HashTableIteratorIS2_S2_S3_S4_S6_S6_EEEEOT0_OT1_","_memcpy","__ZN7WebCore15SVGURIReference14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE"]
