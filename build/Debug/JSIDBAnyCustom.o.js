...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore16JSIDBCursorOwnerE=env.__ZTVN7WebCore16JSIDBCursorOwnerE|0;
  var __ZN7WebCore20JSIDBCursorWithValue6s_infoE=env.__ZN7WebCore20JSIDBCursorWithValue6s_infoE|0;
  var NaN=+env.NaN;
  var Infinity=+env.Infinity;
  var __ZZN7WebCore12wrapperOwnerERNS_15DOMWrapperWorldEPNS_9IDBCursorEE16jsIDBCursorOwner=(H_BASE+16)|0;
  ...
  var __ZGVZN7WebCore12wrapperOwnerERNS_15DOMWrapperWorldEPNS_9IDBCursorEE16jsIDBCursorOwner=(H_BASE+24)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_6IDBAnyE(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 case 2:
  {
   __ZN7WebCore6IDBAny13domStringListEv(i7, i4);
   i15 = i7 | 0;
   __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_13DOMStringListE(i1, i2, i3, HEAP32[i15 >> 2] | 0);
   i7 = HEAP32[i15 >> 2] | 0;
   if ((i7 | 0) == 0) {
    STACKTOP = i5;
    return;
 ...
 case 3:
  {
   __ZN7WebCore6IDBAny9idbCursorEv(i8, i4);
   i7 = i8 | 0;
   __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_9IDBCursorE(i1, i2, i3, HEAP32[i7 >> 2] | 0);
   i8 = HEAP32[i7 >> 2] | 0;
   if ((i8 | 0) == 0) {
    STACKTOP = i5;
    return;
 ...
 case 4:
  {
   __ZN7WebCore6IDBAny18idbCursorWithValueEv(i9, i4);
   i17 = i9 | 0;
   i9 = HEAP32[i17 >> 2] | 0;
   if ((i9 | 0) == 0) {
    HEAP32[i1 + 4 >> 2] = -3;
   ...
   i7 = i2 + 16 | 0;
   i8 = HEAP32[i7 >> 2] | 0;
   i15 = HEAP32[(HEAP32[(HEAP32[i8 >> 2] | 0) + 4 >> 2] | 0) + 656 >> 2] | 0;
   do {
   ...
   if ((i24 | 0) == 43) {
    i24 = __ZN7WebCore15getDOMStructureINS_20JSIDBCursorWithValueEEEPN3JSC9StructureERNS2_2VMEPNS_17JSDOMGlobalObjectE(HEAP32[(i8 & -65536) + 1076 >> 2] | 0, i3) | 0;
    i8 = i6 | 0;
    HEAP32[i8 >> 2] = i9;
    i25 = i9 + 8 | 0;
    HEAP32[i25 >> 2] = (HEAP32[i25 >> 2] | 0) + 1;
    i25 = __ZN7WebCore20JSIDBCursorWithValue6createEPN3JSC9StructureEPNS_17JSDOMGlobalObjectEN3WTF10PassRefPtrINS_18IDBCursorWithValueEEE(i24, i3, i6) | 0;
    i6 = HEAP32[i8 >> 2] | 0;
    do {
     if ((i6 | 0) != 0) {
      i8 = i6 + 8 | 0;
    ...
    __ZN7WebCore12cacheWrapperINS_18IDBCursorWithValueENS_20JSIDBCursorWithValueEEEvRNS_15DOMWrapperWorldEPT_PT0_(HEAP32[(HEAP32[(HEAP32[HEAP32[i7 >> 2] >> 2] | 0) + 4 >> 2] | 0) + 656 >> 2] | 0, i9, i25);
    HEAP32[i1 + 4 >> 2] = (i25 | 0) == 0 ? -6 : -5;
    HEAP32[i1 >> 2] = i25;
    i31 = HEAP32[i17 >> 2] | 0;
   }
   if ((i31 | 0) == 0) {
 ...
 case 5:
  {
   __ZN7WebCore6IDBAny11idbDatabaseEv(i10, i4);
   i25 = i10 | 0;
   __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_11IDBDatabaseE(i1, i2, i3, HEAP32[i25 >> 2] | 0);
   i10 = HEAP32[i25 >> 2] | 0;
   if ((i10 | 0) == 0) {
    STACKTOP = i5;
    return;
 ...
 case 6:
  {
   __ZN7WebCore6IDBAny10idbFactoryEv(i11, i4);
   i17 = i11 | 0;
   __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_10IDBFactoryE(i1, i2, i3, HEAP32[i17 >> 2] | 0);
   i11 = HEAP32[i17 >> 2] | 0;
   if ((i11 | 0) == 0) {
    STACKTOP = i5;
    return;
   ...
   __ZN7WebCore10IDBFactoryD1Ev(i25);
 ...
 case 7:
  {
   __ZN7WebCore6IDBAny8idbIndexEv(i12, i4);
   i25 = i12 | 0;
   __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_8IDBIndexE(i1, i2, i3, HEAP32[i25 >> 2] | 0);
   i12 = HEAP32[i25 >> 2] | 0;
   if ((i12 | 0) == 0) {
    STACKTOP = i5;
    return;
 ...
 case 8:
  {
   __ZN7WebCore6IDBAny14idbObjectStoreEv(i13, i4);
   i17 = i13 | 0;
   __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_14IDBObjectStoreE(i1, i2, i3, HEAP32[i17 >> 2] | 0);
   i13 = HEAP32[i17 >> 2] | 0;
   if ((i13 | 0) == 0) {
    STACKTOP = i5;
    return;
   ...
   i13 = HEAP32[i17 + 84 >> 2] | 0;
   if ((i13 | 0) != 0) {
    i12 = HEAP32[i17 + 88 >> 2] | 0;
    if ((i12 | 0) > 0) {
     i11 = 0;
     while (1) {
      i10 = i13 + (i11 << 3) | 0;
 ...
 case 9:
  {
   __ZN7WebCore6IDBAny14idbTransactionEv(i14, i4);
   i25 = i14 | 0;
   __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_14IDBTransactionE(i1, i2, i3, HEAP32[i25 >> 2] | 0);
   i14 = HEAP32[i25 >> 2] | 0;
   if ((i14 | 0) == 0) {
    STACKTOP = i5;
    return;
 ...
 case 10:
  {
   i17 = HEAP32[(__ZN7WebCore6IDBAny11scriptValueEv(i4) | 0) + 4 >> 2] | 0;
   if ((i17 | 0) == 0) {
    HEAP32[i1 + 4 >> 2] = -6;
    HEAP32[i1 >> 2] = 0;
    STACKTOP = i5;
 ...
 case 12:
  {
   __ZN7WebCore17jsStringWithCacheEPN3JSC9ExecStateERKN3WTF6StringE(i1, i2, __ZN7WebCore6IDBAny6stringEv(i4) | 0);
   STACKTOP = i5;
   return;
  }
 case 11:
  {
   i17 = __ZN7WebCore6IDBAny7integerEv(i4) | 0;
   i14 = tempRet0;
   i25 = i17;
   if ((i25 | 0) == (i17 | 0) & (((i25 | 0) < 0 | 0 ? -1 : 0) | 0) == (i14 | 0)) {
    i25 = i1 | 0;
    HEAP32[i25 >> 2] = i17;
    HEAP32[i25 + 4 >> 2] = i14 | -1;
    STACKTOP = i5;
    return;
   } else {
    HEAPF64[i1 >> 3] = +(i17 >>> 0) + +(i14 | 0) * +4294967296;
    STACKTOP = i5;
    return;
   }
   break;
 ...
 case 13:
  {
   ...
   if ((i14 | 0) == 0) {
    ...
    __ZN7WebCore17jsStringWithCacheEPN3JSC9ExecStateERKN3WTF6StringE(i1, i2, i4 + 48 | 0);
    STACKTOP = i5;
    return;
   } else if ((i14 | 0) == 2) {
    ...
    if ((HEAP32[i6 >> 2] | 0) != 0) {
     i4 = HEAP32[i9 >> 2] | 0;
     while (1) {
      __ZN7WebCore13DOMStringList6appendERKN3WTF6StringE(i17, i4);
      i4 = i4 + 4 | 0;
      if ((i4 | 0) == ((HEAP32[i9 >> 2] | 0) + (HEAP32[i6 >> 2] << 2) | 0)) {
       break;
      }
     }
    }
    __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_13DOMStringListE(i1, i2, i3, i17);
    if ((i14 | 0) == 0) {
     STACKTOP = i5;
     return;
    }
...
function __ZN7WebCore12cacheWrapperINS_18IDBCursorWithValueENS_20JSIDBCursorWithValueEEEvRNS_15DOMWrapperWorldEPT_PT0_(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 if ((HEAP8[H_BASE + 24 | 0] | 0) == 0) {
  i10 = __Znwj(4) | 0;
  i11 = i10;
  HEAP32[i10 >> 2] = __ZTVN7WebCore16JSIDBCursorOwnerE + 8;
...
function __ZN7WebCore15getDOMStructureINS_20JSIDBCursorWithValueEEEPN3JSC9StructureERNS2_2VMEPNS_17JSDOMGlobalObjectE(i1, i2) {
 ...
 i4 = i3 | 0;
 i5 = i3 + 8 | 0;
 i6 = __ZN7WebCore21getCachedDOMStructureEPNS_17JSDOMGlobalObjectEPKN3JSC9ClassInfoE(i2, __ZN7WebCore20JSIDBCursorWithValue6s_infoE) | 0;
 if ((i6 | 0) != 0) {
  i7 = i6;
  STACKTOP = i3;
  return i7 | 0;
 ...
 __ZN3JSC9StructureC1ERNS_2VMEPNS_14JSGlobalObjectENS_7JSValueERKNS_8TypeInfoEPKNS_9ClassInfoEhj(i12, i1, i6, i4, i5, __ZN7WebCore20JSIDBCursorWithValue6s_infoE, 0, 0);
 i7 = __ZN7WebCore17cacheDOMStructureEPNS_17JSDOMGlobalObjectEPN3JSC9StructureEPKNS2_9ClassInfoE(i2, i12, __ZN7WebCore20JSIDBCursorWithValue6s_infoE) | 0;
 STACKTOP = i3;
 return i7 | 0;
}
function __ZN7WebCore20JSIDBCursorWithValue6createEPN3JSC9StructureEPNS_17JSDOMGlobalObjectEN3WTF10PassRefPtrINS_18IDBCursorWithValueEEE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 HEAP32[i8 >> 2] = 0;
 HEAP32[i10 >> 2] = i3;
 __ZN7WebCore20JSIDBCursorWithValueC1EPN3JSC9StructureEPNS_17JSDOMGlobalObjectEN3WTF10PassRefPtrINS_18IDBCursorWithValueEEE(i9, i1, i2, i5);
 i5 = HEAP32[i10 >> 2] | 0;
 do {
  if ((i5 | 0) != 0) {
   i10 = i5 + 8 | 0;
 ...
 __ZN7WebCore20JSIDBCursorWithValue14finishCreationERN3JSC2VME(i9, HEAP32[(HEAP32[i6 >> 2] | 0) + 20544 >> 2] | 0);
 STACKTOP = i4;
 return i9 | 0;
}
