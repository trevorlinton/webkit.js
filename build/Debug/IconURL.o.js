...
function __ZN7WebCore7IconURL14defaultIconURLERKNS_3URLENS_8IconTypeE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0, i5 = 0;
...
function __ZN7WebCoreeqERKNS_7IconURLES2_(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 ...
 if (((HEAP8[i2 + 60 | 0] ^ HEAP8[i1 + 60 | 0]) & 1) != 0) {
  i3 = 0;
  return i3 | 0;
 }
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","_memcpy","__ZN7WebCoreeqERKNS_7IconURLES2_","_memset","__ZN7WebCore7IconURL14defaultIconURLERKNS_3URLENS_8IconTypeE"]
