...
var __ZN7WebCore11DOMMimeTypeC1EN3WTF10PassRefPtrINS_10PluginDataEEEPNS_5FrameEj;
var __ZN7WebCore11DOMMimeTypeD1Ev;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore11DOMMimeTypeE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZNK7WebCore11DOMMimeType8suffixesEv(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
     ...
     if ((i15 | 0) != 0) {
      ...
      do {
       if ((i16 | 0) != 0) {
        ...
        HEAP32[i6 >> 2] = i17 + 1;
        if (i18) {
         HEAP16[(HEAP32[i14 >> 2] | 0) + (i17 << 1) >> 1] = 44;
         break L8;
        } else {
         HEAP8[(HEAP32[i11 >> 2] | 0) + i17 | 0] = 44;
         break L8;
        }
       }
      } while (0);
...
function __ZNK7WebCore11DOMMimeType13enabledPluginEv(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 do {
  if ((i4 | 0) != 0) {
   ...
   if (!(__ZN7WebCore14SubframeLoader12allowPluginsENS_28ReasonForCallingAllowPluginsE(HEAP32[(HEAP32[i5 + 60 >> 2] | 0) + 100 >> 2] | 0, 1) | 0)) {
    break;
   }
   i5 = HEAP32[i2 + 12 >> 2] | 0;
   i6 = HEAP32[i2 + 16 >> 2] | 0;
   if ((HEAP32[i5 + 36 >> 2] | 0) >>> 0 <= i6 >>> 0) {
    __ZN3WTF15CrashOnOverflow10overflowedEv();
   }
   i7 = HEAP32[i3 >> 2] | 0;
   i8 = HEAP32[(HEAP32[i5 + 28 >> 2] | 0) + (i6 << 2) >> 2] | 0;
   i6 = __ZN3WTF10fastMallocEj(24) | 0;
   __ZN7WebCore9DOMPluginC1EPNS_10PluginDataEPNS_5FrameEj(i6, i5, i7, i8);
   HEAP32[i1 >> 2] = i6;
   return;
  }
 } while (0);
...
function __ZN7WebCore11DOMMimeTypeD0Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
...
function __ZN7WebCore11DOMMimeTypeD2Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i1 + 12 >> 2] | 0;
...
function __ZN7WebCore11DOMMimeTypeD1Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i1 + 12 >> 2] | 0;
...
function __ZN7WebCore11DOMMimeTypeC2EN3WTF10PassRefPtrINS_10PluginDataEEEPNS_5FrameEj(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
...
function __ZN7WebCore11DOMMimeTypeC1EN3WTF10PassRefPtrINS_10PluginDataEEEPNS_5FrameEj(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
...
function __ZNK7WebCore11DOMMimeType11descriptionEv(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0;
 i2 = HEAP32[i1 + 12 >> 2] | 0;
 i3 = HEAP32[i1 + 16 >> 2] | 0;
 if ((HEAP32[i2 + 24 >> 2] | 0) >>> 0 > i3 >>> 0) {
  return (HEAP32[i2 + 16 >> 2] | 0) + (i3 * 20 & -1) + 4 | 0;
 } else {
  __ZN3WTF15CrashOnOverflow10overflowedEv();
  return 0;
 }
...
function __ZNK7WebCore11DOMMimeType4typeEv(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0;
 i2 = HEAP32[i1 + 12 >> 2] | 0;
 i3 = HEAP32[i1 + 16 >> 2] | 0;
 if ((HEAP32[i2 + 24 >> 2] | 0) >>> 0 > i3 >>> 0) {
  return (HEAP32[i2 + 16 >> 2] | 0) + (i3 * 20 & -1) | 0;
 } else {
  __ZN3WTF15CrashOnOverflow10overflowedEv();
  return 0;
 }
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,__ZN7WebCore11DOMMimeTypeD0Ev,b0,vi___ZN7WebCore24FrameDestructionObserver14frameDestroyedEv__wrapper,b0,__ZN7WebCore11DOMMimeTypeD2Ev,b0,vi___ZN7WebCore24FrameDestructionObserver14willDetachPageEv__wrapper,b0,b0,b0,b0,b0,b0,b0];
  var FUNCTION_TABLE_ii = [b1,b1];
  var FUNCTION_TABLE_v = [b2,b2];
  var FUNCTION_TABLE_iii = [b3,b3];
  var FUNCTION_TABLE_viiii = [b4,b4,__ZN7WebCore11DOMMimeTypeC2EN3WTF10PassRefPtrINS_10PluginDataEEEPNS_5FrameEj,b4];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZN3WTF15CrashOnOverflow10overflowedEv","__ZN3WTF13StringBuilder6appendERKNS_6StringE","__ZN7WebCore10PluginDataD2Ev","__ZN7WebCore11DOMMimeTypeC2EN3WTF10PassRefPtrINS_10PluginDataEEEPNS_5FrameEj","__ZN7WebCore10PluginInfoD2Ev","__ZN7WebCore11DOMMimeTypeD0Ev","__ZN7WebCore11DOMMimeTypeD2Ev","_memset","__ZNK7WebCore11DOMMimeType4typeEv","_memcpy","__ZNK7WebCore11DOMMimeType13enabledPluginEv","__ZN7WebCore13MimeClassInfoD2Ev","__ZNK7WebCore11DOMMimeType11descriptionEv","__ZNK7WebCore11DOMMimeType8suffixesEv"]
