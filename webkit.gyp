  ...
  'targets': [
    {
      ...
      'sources':[
        ...
        '<(DEPTH)/src/ChromeClientJS.h',
        '<(DEPTH)/src/DocumentLoaderJS.cpp',
        '<(DEPTH)/src/DocumentLoaderJS.h',
        '<(DEPTH)/src/FileSystemJS.cpp',
        '<(DEPTH)/src/FrameJS.cpp',
        '<(DEPTH)/src/FrameJS.h',
        '<(DEPTH)/src/FrameLoaderClientJS.cpp',
        '<(DEPTH)/src/FrameLoaderClientJS.h',
        '<(DEPTH)/src/FrameNetworkingContextJS.cpp',
        '<(DEPTH)/src/FrameNetworkingContextJS.h',
        '<(DEPTH)/src/SharedBufferJS.cpp',
        '<(DEPTH)/src/StorageAreaJS.cpp',
        '<(DEPTH)/src/StorageJS.cpp',
        '<(DEPTH)/src/StorageNamespaceJS.cpp',
        '<(DEPTH)/src/RenderThemeJS.cpp',
        '<(DEPTH)/src/RenderThemeJS.h',
        '<(DEPTH)/src/WebKitJSStrategies.cpp',
        '<(DEPTH)/src/WebKitJSStrategies.h',
        '<(DEPTH)/src/RuntimeEnabledFeaturesJS.cpp',
