	...
	'target_defaults': {
		...
		'configurations': {
			...
			'Debug': {
				...
				'jsflags+':['<(emscripten_linktojs) -s ASSERTIONS=2 -O2 -g2 --js-opts 0 -s SAFE_HEAP=1 -s ALIASING_FUNCTION_POINTERS=0'],
			},
		},
	},
}
