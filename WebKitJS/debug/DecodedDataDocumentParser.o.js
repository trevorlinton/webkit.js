...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore25DecodedDataDocumentParserE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore25DecodedDataDocumentParser11appendBytesERNS_14DocumentWriterEPKcj(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 __ZN7WebCore19TextResourceDecoder6decodeEPKcj(i6, __ZN7WebCore14DocumentWriter21createDecoderIfNeededEv(i2) | 0, i3, i4);
 i4 = i6 | 0;
 i6 = HEAP32[i4 >> 2] | 0;
 if ((i6 | 0) == 0) {
  STACKTOP = i5;
 ...
 do {
  if ((HEAP32[i6 + 4 >> 2] | 0) != 0) {
   __ZN7WebCore14DocumentWriter18reportDataReceivedEv(i2);
   i3 = HEAP32[(HEAP32[i1 >> 2] | 0) + 32 >> 2] | 0;
   i8 = i7 | 0;
   HEAP32[i8 >> 2] = HEAP32[i4 >> 2];
   HEAP32[i4 >> 2] = 0;
   FUNCTION_TABLE_vii[i3 & 3](i1, i7);
   i3 = HEAP32[i8 >> 2] | 0;
   if ((i3 | 0) == 0) {
    break;
   }
...
function __ZN7WebCore25DecodedDataDocumentParser5flushERNS_14DocumentWriterE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 i4 = i3 | 0;
 i5 = i3 + 8 | 0;
 __ZN7WebCore19TextResourceDecoder5flushEv(i4, __ZN7WebCore14DocumentWriter21createDecoderIfNeededEv(i2) | 0);
 i6 = i4 | 0;
 i4 = HEAP32[i6 >> 2] | 0;
 if ((i4 | 0) == 0) {
  STACKTOP = i3;
...
function __ZN7WebCore25DecodedDataDocumentParserC2ERNS_8DocumentE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 __ZN7WebCore14DocumentParserC2ERNS_8DocumentE(i1 | 0, i2);
...
function __ZN7WebCore25DecodedDataDocumentParserD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore25DecodedDataDocumentParserD1Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore14DocumentParserD2Ev(i1 | 0);
 return;
}
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,vi___ZN7WebCore14DocumentParser12startParsingEv__wrapper,b0,vi___ZN7WebCore14DocumentParser20resumeScheduledTasksEv__wrapper,b0,vi___ZN7WebCore14DocumentParser11stopParsingEv__wrapper,b0,__ZN7WebCore25DecodedDataDocumentParserD0Ev,b0,vi___ZN7WebCore14DocumentParser6detachEv__wrapper,b0,__ZN7WebCore25DecodedDataDocumentParserD1Ev,b0,vi___ZN7WebCore14DocumentParser20prepareToStopParsingEv__wrapper,b0,vi___ZN7WebCore14DocumentParser21suspendScheduledTasksEv__wrapper,b0,__ZN7WebCore14DocumentParser15pinToMainThreadEv,b0,b0,b0,b0,b0,b0,b0,b0,b0,b0
  ,b0,b0,b0];
  var FUNCTION_TABLE_vii = [b1,b1,__ZN7WebCore25DecodedDataDocumentParser5flushERNS_14DocumentWriterE,b1];
  var FUNCTION_TABLE_ii = [b2,b2,__ZNK7WebCore14DocumentParser14processingDataEv,b2,__ZN7WebCore14DocumentParser17hasInsertionPointEv,b2,__ZN7WebCore14DocumentParser26asScriptableDocumentParserEv,b2,__ZNK7WebCore25DecodedDataDocumentParser10wellFormedEv,b2,b2,b2,b2,b2,b2,b2];
  var FUNCTION_TABLE_v = [b3,b3,v____cxa_pure_virtual__wrapper,b3];
  var FUNCTION_TABLE_iii = [b4,b4];
  var FUNCTION_TABLE_viiii = [b5,b5,__ZN7WebCore25DecodedDataDocumentParser11appendBytesERNS_14DocumentWriterEPKcj,b5];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZN7WebCore14DocumentParser17hasInsertionPointEv","__ZNK7WebCore14DocumentParser14processingDataEv","__ZNK7WebCore25DecodedDataDocumentParser10wellFormedEv","__ZN7WebCore25DecodedDataDocumentParserC2ERNS_8DocumentE","__ZN7WebCore14DocumentParser15pinToMainThreadEv","__ZN7WebCore25DecodedDataDocumentParser5flushERNS_14DocumentWriterE","__ZN7WebCore25DecodedDataDocumentParser11appendBytesERNS_14DocumentWriterEPKcj","_memset","_memcpy","__ZN7WebCore25DecodedDataDocumentParserD0Ev","_strlen","__ZN7WebCore25DecodedDataDocumentParserD1Ev","__ZN7WebCore14DocumentParser26asScriptableDocumentParserEv"]
