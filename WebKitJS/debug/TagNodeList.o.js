...
var __ZN7WebCore11TagNodeListC1ERNS_13ContainerNodeENS_12LiveNodeList4TypeERKN3WTF12AtomicStringES8_;
var __ZN7WebCore11TagNodeListD1Ev;
var __ZN7WebCore15HTMLTagNodeListC1ERNS_13ContainerNodeERKN3WTF12AtomicStringE;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore11TagNodeListE=(H_BASE+64)|0;
  var __ZTVN7WebCore15HTMLTagNodeListE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN3WTF9HashTableIN7WebCore13QualifiedNameENS_12KeyValuePairIS2_PNS1_11TagNodeListEEENS_24KeyValuePairKeyExtractorIS6_EENS1_17QualifiedNameHashENS_7HashMapIS2_S5_S9_NS_10HashTraitsIS2_EENSB_IS5_EEE18KeyValuePairTraitsESC_E6lookupINS_22IdentityHashTranslatorIS9_EES2_EEPS6_RKT0_(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
...
function __ZN7WebCore17NodeListsNodeData28removeCacheWithQualifiedNameEPNS_12LiveNodeListERKN3WTF12AtomicStringES6_(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 i3 = i1 + 60 | 0;
 if (((HEAP32[i1 + 20 >> 2] | 0) + ((HEAP32[i1 >> 2] | 0) != 0) + ((HEAP32[i1 + 4 >> 2] | 0) != 0) + (HEAP32[i1 + 40 >> 2] | 0) + (HEAP32[i3 >> 2] | 0) + (HEAP32[i1 + 80 >> 2] | 0) | 0) == 1) {
  __ZN7WebCore4Node14clearNodeListsEv(HEAP32[i2 + 12 >> 2] | 0);
  __ZN7WebCore13QualifiedNameD1Ev(i6);
  STACKTOP = i5;
  return;
 ...
 if ((HEAP32[i4 >> 2] | 0) == 0) {
  ...
  i7 = i2 | 0;
  i2 = __ZN3WTF9HashTableIN7WebCore13QualifiedNameENS_12KeyValuePairIS2_PNS1_11TagNodeListEEENS_24KeyValuePairKeyExtractorIS6_EENS1_17QualifiedNameHashENS_7HashMapIS2_S5_S9_NS_10HashTraitsIS2_EENSB_IS5_EEE18KeyValuePairTraitsESC_E6lookupINS_22IdentityHashTranslatorIS9_EES2_EEPS6_RKT0_(i7, i6) | 0;
  i12 = HEAP32[i4 >> 2] | 0;
  i4 = HEAP32[i1 + 52 >> 2] | 0;
  i8 = (i2 | 0) == 0 ? i12 + (i4 << 3) | 0 : i2;
  i9 = i12;
  i10 = i4;
  i11 = i7;
 }
 ...
 HEAP32[i3 >> 2] = i8;
 i3 = HEAP32[i1 + 52 >> 2] | 0;
 if (!((i8 * 6 & -1 | 0) < (i3 | 0) & (i3 | 0) > 8)) {
  __ZN7WebCore13QualifiedNameD1Ev(i6);
  STACKTOP = i5;
  return;
 }
 __ZN3WTF9HashTableIN7WebCore13QualifiedNameENS_12KeyValuePairIS2_PNS1_11TagNodeListEEENS_24KeyValuePairKeyExtractorIS6_EENS1_17QualifiedNameHashENS_7HashMapIS2_S5_S9_NS_10HashTraitsIS2_EENSB_IS5_EEE18KeyValuePairTraitsESC_E6rehashEiPS6_(i11, (i3 | 0) / 2 & -1, 0) | 0;
 __ZN7WebCore13QualifiedNameD1Ev(i6);
 STACKTOP = i5;
 return;
}
function __ZN7WebCore11TagNodeListD2Ev(i1) {
 i1 = i1 | 0;
 ...
 i3 = i1 + 36 | 0;
 i4 = i3 | 0;
 i5 = (HEAP32[i4 >> 2] | 0) == (HEAP32[__ZN3WTF8starAtomE >> 2] | 0);
 i6 = i1 | 0;
 i7 = i1 + 12 | 0;
 i8 = __ZN7WebCore4Node9nodeListsEv(HEAP32[i7 >> 2] | 0) | 0;
 i9 = i1 + 40 | 0;
 if (i5) {
  __ZN7WebCore17NodeListsNodeData25removeCacheWithAtomicNameEPNS_12LiveNodeListERKN3WTF12AtomicStringE(i8, i6, i9);
 } else {
  __ZN7WebCore17NodeListsNodeData28removeCacheWithQualifiedNameEPNS_12LiveNodeListERKN3WTF12AtomicStringES6_(i8, i6, i3, i9);
 }
 i3 = HEAP32[i9 >> 2] | 0;
 do {
  if ((i3 | 0) != 0) {
 ...
 __ZN7WebCore8Document18unregisterNodeListERNS_12LiveNodeListE(HEAP32[(HEAP32[(HEAP32[i7 >> 2] | 0) + 20 >> 2] | 0) + 8 >> 2] | 0, i6);
 i6 = (HEAP32[i7 >> 2] | 0) + 8 | 0;
 i7 = i6 - 8 | 0;
 i2 = i6 | 0;
...
function __ZN7WebCore11TagNodeListD1Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0, i5 = 0, i6 = 0, i7 = 0, i8 = 0, i9 = 0;
 i2 = i1 | 0;
 HEAP32[i2 >> 2] = H_BASE + 72;
...
function __ZN7WebCore15HTMLTagNodeListC2ERNS_13ContainerNodeERKN3WTF12AtomicStringE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 HEAP32[i1 + 8 >> 2] = 1;
 i4 = i1 | 0;
 HEAP32[i4 >> 2] = __ZTVN7WebCore12LiveNodeListE + 8;
 i5 = i1 + 12 | 0;
 HEAP32[i5 >> 2] = i2;
 i6 = i2 + 8 | 0;
 ...
 i6 = i1 + 32 | 0;
 HEAP32[i6 >> 2] = HEAP32[i6 >> 2] & -2048 | 192;
 __ZN7WebCore8Document16registerNodeListERNS_12LiveNodeListE(HEAP32[(HEAP32[(HEAP32[i5 >> 2] | 0) + 20 >> 2] | 0) + 8 >> 2] | 0, i1 | 0);
 ...
 if ((i6 | 0) == 0) {
  ...
  i7 = i1 + 44 | 0;
  __ZNK3WTF12AtomicString5lowerEv(i7, i3);
  return;
 }
 i5 = i6 | 0;
...
function __ZN7WebCore15HTMLTagNodeListC1ERNS_13ContainerNodeERKN3WTF12AtomicStringE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0, i5 = 0, i6 = 0, i7 = 0;
...
function __ZN7WebCore11TagNodeListC2ERNS_13ContainerNodeENS_12LiveNodeList4TypeERKN3WTF12AtomicStringES8_(i1, i2, i3, i4, i5) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 HEAP32[i1 + 8 >> 2] = 1;
 i6 = i1 | 0;
 HEAP32[i6 >> 2] = __ZTVN7WebCore12LiveNodeListE + 8;
 i7 = i1 + 12 | 0;
 HEAP32[i7 >> 2] = i2;
 i8 = i2 + 8 | 0;
 HEAP32[i8 >> 2] = (HEAP32[i8 >> 2] | 0) + 1;
 _memset(i1 + 16 | 0, 0, 13) | 0;
 i8 = i1 + 32 | 0;
 HEAP32[i8 >> 2] = HEAP32[i8 >> 2] & -2048 | i3 << 6 & 1984;
 __ZN7WebCore8Document16registerNodeListERNS_12LiveNodeListE(HEAP32[(HEAP32[(HEAP32[i7 >> 2] | 0) + 20 >> 2] | 0) + 8 >> 2] | 0, i1 | 0);
...
function __ZN7WebCore11TagNodeListC1ERNS_13ContainerNodeENS_12LiveNodeList4TypeERKN3WTF12AtomicStringES8_(i1, i2, i3, i4, i5) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
...
function __ZNK7WebCore11TagNodeList11nodeMatchesEPNS_7ElementE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0, i4 = 0, i5 = 0;
 i3 = HEAP32[i1 + 40 >> 2] | 0;
 i4 = HEAP32[__ZN3WTF8starAtomE >> 2] | 0;
 do {
  if ((i3 | 0) != (i4 | 0)) {
   if ((i3 | 0) == (HEAP32[(HEAP32[i2 + 44 >> 2] | 0) + 12 >> 2] | 0)) {
    break;
   } else {
    i5 = 0;
   }
 ...
 i5 = (i3 | 0) == (HEAP32[(HEAP32[i2 + 44 >> 2] | 0) + 16 >> 2] | 0);
 return i5 | 0;
}
...
function __ZN7WebCore15HTMLTagNodeListD0Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
 ...
 __ZN7WebCore11TagNodeListD2Ev(i1 | 0);
 __ZN3WTF8fastFreeEPv(i1);
 return;
}
function __ZNK7WebCore15HTMLTagNodeList11nodeMatchesEPNS_7ElementE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0, i4 = 0;
 i3 = i1 + 40 | 0;
 do {
  if ((HEAP32[i3 >> 2] | 0) != (HEAP32[__ZN3WTF8starAtomE >> 2] | 0)) {
   if ((HEAP32[((HEAP32[i2 + 12 >> 2] & 16 | 0) != 0 ? i1 + 44 | 0 : i3) >> 2] | 0) == (HEAP32[(HEAP32[i2 + 44 >> 2] | 0) + 12 >> 2] | 0)) {
    break;
   } else {
    i4 = 0;
   }
...
function __ZN7WebCore15HTMLTagNodeListD1Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i1 + 44 >> 2] | 0;
...
function __ZN7WebCore11TagNodeListD0Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore11TagNodeListD2Ev(i1);
 __ZN3WTF8fastFreeEPv(i1);
 return;
}
function _strlen(i1) {
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_viiiii = [b0,b0,__ZN7WebCore11TagNodeListC2ERNS_13ContainerNodeENS_12LiveNodeList4TypeERKN3WTF12AtomicStringES8_,b0];
  var FUNCTION_TABLE_vi = [b1,b1,__ZN7WebCore11TagNodeListD2Ev,b1,__ZN7WebCore15HTMLTagNodeListD0Ev,b1,__ZN7WebCore15HTMLTagNodeListD1Ev,b1,__ZN7WebCore11TagNodeListD0Ev,b1,b1,b1,b1,b1,b1,b1];
  ...
  var FUNCTION_TABLE_viii = [b3,b3,__ZN7WebCore15HTMLTagNodeListC2ERNS_13ContainerNodeERKN3WTF12AtomicStringE,b3];
  var FUNCTION_TABLE_v = [b4,b4];
  var FUNCTION_TABLE_iii = [b5,b5,iii___ZNK7WebCore12LiveNodeList9namedItemERKN3WTF12AtomicStringE__wrapper,b5,iii___ZNK7WebCore12LiveNodeList4itemEj__wrapper,b5,__ZNK7WebCore15HTMLTagNodeList11nodeMatchesEPNS_7ElementE,b5,__ZNK7WebCore11TagNodeList11nodeMatchesEPNS_7ElementE,b5,b5,b5,b5,b5,b5,b5];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZN7WebCore11TagNodeListD2Ev","_strlen","__ZNK7WebCore12LiveNodeList14isLiveNodeListEv","__ZN7WebCore15HTMLTagNodeListC2ERNS_13ContainerNodeERKN3WTF12AtomicStringE","__ZNK7WebCore8NodeList15isChildNodeListEv","__ZN3WTF9HashTableIN7WebCore13QualifiedNameENS_12KeyValuePairIS2_PNS1_11TagNodeListEEENS_24KeyValuePairKeyExtractorIS6_EENS1_17QualifiedNameHashENS_7HashMapIS2_S5_S9_NS_10HashTraitsIS2_EENSB_IS5_EEE18KeyValuePairTraitsESC_E16lookupForWritingINS_22IdentityHashTranslatorIS9_EES2_EENSt3__14pairIPS6_bEERKT0_","__ZN3WTF9HashTableINSt3__14pairIhNS_12AtomicStringEEENS_12KeyValuePairIS4_PN7WebCore12LiveNodeListEEENS_24KeyValuePairKeyExtractorIS9_EENS6_17NodeListsNodeData25NodeListCacheMapEntryHashIS3_EENS_7HashMapIS4_S8_SE_NS_10HashTraitsIS4_EENSG_IS8_EEE18KeyValuePairTraitsESH_E6rehashEiPS9_","__ZN7WebCore17NodeListsNodeData28removeCacheWithQualifiedNameEPNS_12LiveNodeListERKN3WTF12AtomicStringES6_","__ZN7WebCore11TagNodeListC2ERNS_13ContainerNodeENS_12LiveNodeList4TypeERKN3WTF12AtomicStringES8_","_memcpy","__ZNK7WebCore8NodeList15isEmptyNodeListEv","__ZNK7WebCore15HTMLTagNodeList11nodeMatchesEPNS_7ElementE","__ZN3WTF9HashTableIN7WebCore13QualifiedNameENS_12KeyValuePairIS2_PNS1_11TagNodeListEEENS_24KeyValuePairKeyExtractorIS6_EENS1_17QualifiedNameHashENS_7HashMapIS2_S5_S9_NS_10HashTraitsIS2_EENSB_IS5_EEE18KeyValuePairTraitsESC_E6lookupINS_22IdentityHashTranslatorIS9_EES2_EEPS6_RKT0_","__ZNK7WebCore11TagNodeList11nodeMatchesEPNS_7ElementE","__ZN3WTF9HashTableIN7WebCore13QualifiedNameENS_12KeyValuePairIS2_PNS1_11TagNodeListEEENS_24KeyValuePairKeyExtractorIS6_EENS1_17QualifiedNameHashENS_7HashMapIS2_S5_S9_NS_10HashTraitsIS2_EENSB_IS5_EEE18KeyValuePairTraitsESC_E6rehashEiPS6_","__ZN7WebCore17NodeListsNodeData25removeCacheWithAtomicNameEPNS_12LiveNodeListERKN3WTF12AtomicStringE","__ZN7WebCore15HTMLTagNodeListD0Ev","_memset","__ZN7WebCore15HTMLTagNodeListD1Ev","__ZN7WebCore11TagNodeListD0Ev"]
