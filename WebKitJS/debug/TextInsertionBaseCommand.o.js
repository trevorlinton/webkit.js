...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore24TextInsertionBaseCommandE=(H_BASE+16)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore31dispatchBeforeTextInsertedEventERKN3WTF6StringERKNS_16VisibleSelectionEb(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 HEAP32[i6 + 4 >> 2] = HEAP32[i3 + 28 >> 2];
 i12 = HEAP32[i3 + 32 >> 2] | 0;
 i3 = i6 + 8 | 0;
 i11 = i3;
 i13 = HEAP32[i11 >> 2] & -8 | i12 & 7;
 HEAP32[i11 >> 2] = i13;
 HEAP8[i3] = i13 & 255 & -9 | i12 & 8;
 i12 = __ZNK7WebCore8Position13containerNodeEv(i6) | 0;
 i6 = HEAP32[i10 >> 2] | 0;
 do {
  if ((i6 | 0) != 0) {
   i10 = i6 + 8 | 0;
 ...
 do {
  if ((i12 | 0) == 0) {
   ...
   if ((__ZNK7WebCore4Node19rootEditableElementEv(i12) | 0) == 0) {
    i14 = i9;
    break;
   }
   i6 = __ZN3WTF10fastMallocEj(56) | 0;
   __ZN7WebCore23BeforeTextInsertedEventC1ERKN3WTF6StringE(i6, i2);
   i10 = __ZNK7WebCore4Node19rootEditableElementEv(i12) | 0;
   i3 = i7 | 0;
   i13 = i6;
   HEAP32[i3 >> 2] = i13;
   i11 = (i6 | 0) == 0;
   ...
   i15 = i8 | 0;
   HEAP32[i15 >> 2] = 0;
   __ZN7WebCore11EventTarget13dispatchEventEN3WTF10PassRefPtrINS_5EventEEERi(i10, i7, i15) | 0;
   i15 = HEAP32[i3 >> 2] | 0;
   do {
    if ((i15 | 0) != 0) {
     i3 = i15 + 8 | 0;
   ...
   if ((i16 | 0) == 0) {
    FUNCTION_TABLE_vi[HEAP32[(HEAP32[i6 >> 2] | 0) + 4 >> 2] & 7](i13);
    i14 = i15;
    break;
   } else {
    HEAP32[i3 >> 2] = i16;
...
function __ZN7WebCore31canAppendNewLineFeedToSelectionERKNS_16VisibleSelectionE(i1) {
 i1 = i1 | 0;
 ...
 i4 = i2 + 8 | 0;
 i5 = i2 + 16 | 0;
 i6 = __ZNK7WebCore16VisibleSelection19rootEditableElementEv(i1) | 0;
 if ((i6 | 0) == 0) {
  i7 = 0;
  STACKTOP = i2;
  return i7 | 0;
 ...
 __ZN7WebCore23BeforeTextInsertedEventC1ERKN3WTF6StringE(i1, i3);
 i8 = HEAP32[i3 >> 2] | 0;
 do {
  if ((i8 | 0) != 0) {
   i3 = i8 | 0;
 ...
 i10 = i5 | 0;
 HEAP32[i10 >> 2] = 0;
 __ZN7WebCore11EventTarget13dispatchEventEN3WTF10PassRefPtrINS_5EventEEERi(i6 | 0, i4, i10) | 0;
 i10 = HEAP32[i8 >> 2] | 0;
 do {
  if ((i10 | 0) != 0) {
   i8 = i10 + 8 | 0;
 ...
 if ((i10 | 0) == 0) {
  FUNCTION_TABLE_vi[HEAP32[(HEAP32[i1 >> 2] | 0) + 4 >> 2] & 7](i9);
  i7 = i11;
  STACKTOP = i2;
  return i7 | 0;
 } else {
...
function __ZN7WebCore24TextInsertionBaseCommand25applyTextInsertionCommandEPNS_5FrameEN3WTF10PassRefPtrIS0_EERKNS_16VisibleSelectionES8_(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 i6 = i5 | 0;
 i7 = __ZN7WebCoreeqERKNS_16VisibleSelectionES2_(i3, i4) | 0;
 i8 = i2 | 0;
 if (!i7) {
  __ZN7WebCore11EditCommand20setStartingSelectionERKNS_16VisibleSelectionE(HEAP32[i8 >> 2] | 0, i3);
  __ZN7WebCore11EditCommand18setEndingSelectionERKNS_16VisibleSelectionE(HEAP32[i8 >> 2] | 0, i3);
 }
 i3 = i6 | 0;
 i2 = HEAP32[i8 >> 2] | 0;
 HEAP32[i8 >> 2] = 0;
 HEAP32[i3 >> 2] = i2;
 __ZN7WebCore12applyCommandEN3WTF10PassRefPtrINS_20CompositeEditCommandEEE(i6);
 i6 = HEAP32[i3 >> 2] | 0;
 do {
  if ((i6 | 0) != 0) {
   i3 = i6 + 4 | 0;
 ...
 __ZN7WebCore11EditCommand18setEndingSelectionERKNS_16VisibleSelectionE(HEAP32[i8 >> 2] | 0, i4);
 __ZN7WebCore14FrameSelection12setSelectionERKNS_16VisibleSelectionEjNS0_19CursorAlignOnScrollENS_15TextGranularityE(HEAP32[i1 + 468 >> 2] | 0, i4, 6, 0, 0);
 STACKTOP = i5;
 return;
}
...
function __ZN7WebCore24TextInsertionBaseCommandC2ERNS_8DocumentE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
...
function __ZN7WebCore24TextInsertionBaseCommandD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore24TextInsertionBaseCommandD1Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore20CompositeEditCommandD2Ev(i1 | 0);
 return;
}
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,__ZN7WebCore24TextInsertionBaseCommandD1Ev,b0,__ZN7WebCore24TextInsertionBaseCommandD0Ev,b0,b0,b0];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZNK7WebCore20CompositeEditCommand18isDictationCommandEv","__ZN7WebCore24TextInsertionBaseCommandD1Ev","__ZN7WebCore31canAppendNewLineFeedToSelectionERKNS_16VisibleSelectionE","__ZN7WebCore24TextInsertionBaseCommandD0Ev","__ZNK7WebCore20CompositeEditCommand22isCompositeEditCommandEv","__ZN7WebCore24TextInsertionBaseCommand25applyTextInsertionCommandEPNS_5FrameEN3WTF10PassRefPtrIS0_EERKNS_16VisibleSelectionES8_","_memset","_memcpy","__ZNK7WebCore11EditCommand24isEditCommandCompositionEv","__ZNK7WebCore11EditCommand19isSimpleEditCommandEv","__ZN7WebCoreeqERKNS_16VisibleSelectionES2_","_strlen","__ZN7WebCore31dispatchBeforeTextInsertedEventERKN3WTF6StringERKNS_16VisibleSelectionEb","__ZN7WebCore24TextInsertionBaseCommandC2ERNS_8DocumentE","__ZNK7WebCore20CompositeEditCommand23shouldStopCaretBlinkingEv"]
