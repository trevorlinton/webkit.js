...
var __ZN7WebCore17AppendNodeCommandC1EN3WTF10PassRefPtrINS_13ContainerNodeEEENS2_INS_4NodeEEE;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore17AppendNodeCommandE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore17AppendNodeCommand7doApplyEv(i1) {
 i1 = i1 | 0;
 ...
 i4 = i2 + 8 | 0;
 i5 = i1 + 136 | 0;
 i6 = __ZNK7WebCore4Node16hasEditableStyleENS0_13EditableLevelENS0_22UserSelectAllTreatmentE(HEAP32[i5 >> 2] | 0, 0, 1) | 0;
 i7 = HEAP32[i5 >> 2] | 0;
 do {
  if (!i6) {
   i5 = i7 + 32 | 0;
 ...
 i6 = i4 | 0;
 HEAP32[i6 >> 2] = 0;
 __ZN7WebCore13ContainerNode11appendChildEN3WTF10PassRefPtrINS_4NodeEEERi(i7, i3, i6) | 0;
 i6 = HEAP32[i1 >> 2] | 0;
 if ((i6 | 0) == 0) {
  STACKTOP = i2;
  return;
...
function __ZN7WebCore17AppendNodeCommandD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore17AppendNodeCommandD1Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0, i5 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i1 + 140 >> 2] | 0;
...
function __ZN7WebCore17AppendNodeCommandC2EN3WTF10PassRefPtrINS_13ContainerNodeEEENS2_INS_4NodeEEE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
function __ZN7WebCore17AppendNodeCommandC1EN3WTF10PassRefPtrINS_13ContainerNodeEEENS2_INS_4NodeEEE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
function __ZN7WebCore17AppendNodeCommand9doUnapplyEv(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0;
 i2 = STACKTOP;
 ...
 i1 = i2 | 0;
 HEAP32[i1 >> 2] = 0;
 __ZN7WebCore4Node6removeERi(i3, i1);
 STACKTOP = i2;
 return;
}
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,__ZN7WebCore17AppendNodeCommandD1Ev,b0,__ZN7WebCore17AppendNodeCommand7doApplyEv,b0,__ZN7WebCore17AppendNodeCommand9doUnapplyEv,b0,__ZN7WebCore17AppendNodeCommandD0Ev,b0,vi___ZN7WebCore17SimpleEditCommand9doReapplyEv__wrapper,b0,b0,b0,b0,b0];
  ...
  var FUNCTION_TABLE_viii = [b2,b2,__ZN7WebCore17AppendNodeCommandC2EN3WTF10PassRefPtrINS_13ContainerNodeEEENS2_INS_4NodeEEE,b2];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZN7WebCore17AppendNodeCommandD1Ev","_strlen","__ZNK7WebCore17SimpleEditCommand19isSimpleEditCommandEv","__ZN7WebCore17AppendNodeCommandC2EN3WTF10PassRefPtrINS_13ContainerNodeEEENS2_INS_4NodeEEE","_memset","_memcpy","__ZNK7WebCore11EditCommand24isEditCommandCompositionEv","__ZN7WebCore17AppendNodeCommand7doApplyEv","__ZN7WebCore17AppendNodeCommand9doUnapplyEv","__ZN7WebCore17AppendNodeCommandD0Ev","__ZNK7WebCore11EditCommand22isCompositeEditCommandEv"]
