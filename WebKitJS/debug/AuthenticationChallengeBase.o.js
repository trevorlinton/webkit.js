...
var __ZN7WebCore27AuthenticationChallengeBaseC1Ev;
var __ZN7WebCore27AuthenticationChallengeBaseC1ERKNS_15ProtectionSpaceERKNS_10CredentialEjRKNS_16ResourceResponseERKNS_13ResourceErrorE;
...
function __ZN7WebCore27AuthenticationChallengeBaseC2ERKNS_15ProtectionSpaceERKNS_10CredentialEjRKNS_16ResourceResponseERKNS_13ResourceErrorE(i1, i2, i3, i4, i5, i6) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 HEAP32[i1 + 40 >> 2] = i4;
 __ZN7WebCore20ResourceResponseBaseC2ERKS0_(i1 + 48 | 0, i5 | 0);
 HEAP8[i1 + 208 | 0] = HEAP8[i5 + 160 | 0] & 1;
 i5 = HEAP32[i6 >> 2] | 0;
 HEAP32[i1 + 216 >> 2] = i5;
 if ((i5 | 0) != 0) {
  i4 = i5 | 0;
...
function __ZN7WebCore27AuthenticationChallengeBaseC1ERKNS_15ProtectionSpaceERKNS_10CredentialEjRKNS_16ResourceResponseERKNS_13ResourceErrorE(i1, i2, i3, i4, i5, i6) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
...
function __ZN7WebCore27AuthenticationChallengeBase7compareERKNS_23AuthenticationChallengeES3_(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 i3 = (HEAP8[i2 | 0] & 1) == 0;
 ...
 if (!(__ZN7WebCoreeqERKNS_15ProtectionSpaceES2_(i1 + 4 | 0, i2 + 4 | 0) | 0)) {
  return 0;
 }
 if (!(__ZN7WebCoreeqERKNS_10CredentialES2_(i1 + 28 | 0, i2 + 28 | 0) | 0)) {
  return 0;
 }
 if ((HEAP32[i1 + 40 >> 2] | 0) != (HEAP32[i2 + 40 >> 2] | 0)) {
  return 0;
 }
 if (__ZN7WebCore20ResourceResponseBase7compareERKNS_16ResourceResponseES3_(i1 + 48 | 0, i2 + 48 | 0) | 0) {
  return __ZN7WebCore17ResourceErrorBase7compareERKNS_13ResourceErrorES3_(i1 + 216 | 0, i2 + 216 | 0) | 0;
 } else {
  return 0;
 }
 return 0;
...
function __ZN7WebCore27AuthenticationChallengeBaseC2Ev(i1) {
 i1 = i1 | 0;
 HEAP8[i1 | 0] = 1;
 __ZN7WebCore15ProtectionSpaceC1Ev(i1 + 4 | 0);
 __ZN7WebCore10CredentialC1Ev(i1 + 28 | 0);
 HEAP32[i1 + 40 >> 2] = 0;
 __ZN7WebCore20ResourceResponseBaseC2Ev(i1 + 48 | 0);
 HEAP8[i1 + 208 | 0] = 0;
 _memset(i1 + 216 | 0, 0, 16) | 0;
 HEAP8[i1 + 232 | 0] = 1;
 HEAP8[i1 + 233 | 0] = 0;
 HEAP8[i1 + 234 | 0] = 0;
 return;
}
function __ZN7WebCore27AuthenticationChallengeBaseC1Ev(i1) {
 i1 = i1 | 0;
 HEAP8[i1 | 0] = 1;
 __ZN7WebCore15ProtectionSpaceC1Ev(i1 + 4 | 0);
 __ZN7WebCore10CredentialC1Ev(i1 + 28 | 0);
...
function __ZNK7WebCore27AuthenticationChallengeBase20previousFailureCountEv(i1) {
 i1 = i1 | 0;
...
function __ZNK7WebCore27AuthenticationChallengeBase6isNullEv(i1) {
 i1 = i1 | 0;
 return (HEAP8[i1 | 0] & 1) != 0 | 0;
}
function __ZNK7WebCore27AuthenticationChallengeBase18proposedCredentialEv(i1) {
 i1 = i1 | 0;
 return i1 + 28 | 0;
}
function __ZNK7WebCore27AuthenticationChallengeBase15failureResponseEv(i1) {
 i1 = i1 | 0;
 return i1 + 48 | 0;
}
function __ZNK7WebCore27AuthenticationChallengeBase15protectionSpaceEv(i1) {
 i1 = i1 | 0;
 return i1 + 4 | 0;
}
function __ZN7WebCore27AuthenticationChallengeBase7nullifyEv(i1) {
 i1 = i1 | 0;
 HEAP8[i1 | 0] = 1;
 return;
}
...
function __ZNK7WebCore27AuthenticationChallengeBase5errorEv(i1) {
 i1 = i1 | 0;
 return i1 + 216 | 0;
}
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,__ZN7WebCore27AuthenticationChallengeBaseC2Ev,b0];
  var FUNCTION_TABLE_ii = [b1,b1];
  var FUNCTION_TABLE_v = [b2,b2];
  var FUNCTION_TABLE_viiiiii = [b3,b3,__ZN7WebCore27AuthenticationChallengeBaseC2ERKNS_15ProtectionSpaceERKNS_10CredentialEjRKNS_16ResourceResponseERKNS_13ResourceErrorE,b3];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZNK7WebCore27AuthenticationChallengeBase5errorEv","__ZN3WTF9HashTableINS_12AtomicStringENS_12KeyValuePairIS1_NS_6StringEEENS_24KeyValuePairKeyExtractorIS4_EENS_15CaseFoldingHashENS_7HashMapIS1_S3_S7_NS_10HashTraitsIS1_EENS9_IS3_EEE18KeyValuePairTraitsESA_E6expandEPS4_","_strlen","__ZN7WebCore27AuthenticationChallengeBase7nullifyEv","_memset","__ZN3WTF15CaseFoldingHash4hashERNS_10StringImplE","__ZNK7WebCore27AuthenticationChallengeBase15protectionSpaceEv","__ZN7WebCore20ResourceResponseBaseC2ERKS0_","__ZN7WebCore27AuthenticationChallengeBaseC2ERKNS_15ProtectionSpaceERKNS_10CredentialEjRKNS_16ResourceResponseERKNS_13ResourceErrorE","__ZN3WTF9HashTableINS_12AtomicStringENS_12KeyValuePairIS1_NS_6StringEEENS_24KeyValuePairKeyExtractorIS4_EENS_15CaseFoldingHashENS_7HashMapIS1_S3_S7_NS_10HashTraitsIS1_EENS9_IS3_EEE18KeyValuePairTraitsESA_E8reinsertEOS4_","__ZN7WebCore27AuthenticationChallengeBase7compareERKNS_23AuthenticationChallengeES3_","__ZN3WTF9HashTableINS_12AtomicStringENS_12KeyValuePairIS1_NS_6StringEEENS_24KeyValuePairKeyExtractorIS4_EENS_15CaseFoldingHashENS_7HashMapIS1_S3_S7_NS_10HashTraitsIS1_EENS9_IS3_EEE18KeyValuePairTraitsESA_E3addINS_22IdentityHashTranslatorIS7_EERKS1_RKS4_EENS_18HashTableAddResultINS_17HashTableIteratorIS1_S4_S6_S7_SD_SA_EEEEOT0_OT1_","__ZNK7WebCore27AuthenticationChallengeBase6isNullEv","__ZN3WTF12StringHasher28addCharactersAssumingAlignedItXadL_ZNS_15CaseFoldingHash8foldCaseItEEtT_EEEEvPKS4_j","_memcpy","__ZN7WebCore27AuthenticationChallengeBaseC2Ev","__ZNK7WebCore27AuthenticationChallengeBase20previousFailureCountEv","__ZNK7WebCore27AuthenticationChallengeBase18proposedCredentialEv","__ZNK7WebCore27AuthenticationChallengeBase15failureResponseEv"]
