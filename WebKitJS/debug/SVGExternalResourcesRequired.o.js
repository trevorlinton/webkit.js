...
/* memory initializer */ allocate([116,114,117,101,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE+H_BASE)
;
;
;
;
...
function __ZN7WebCore28SVGExternalResourcesRequired21handleAttributeChangeEPNS_10SVGElementERKNS_13QualifiedNameE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
 if ((HEAP32[i3 >> 2] | 0) != (HEAP32[__ZN7WebCore8SVGNames29externalResourcesRequiredAttrE >> 2] | 0)) {
  i4 = 0;
  return i4 | 0;
 }
 ...
 if ((HEAP8[FUNCTION_TABLE_ii[HEAP32[(HEAP32[i1 >> 2] | 0) + 12 >> 2] & 1](i1) | 0] & 1) != 0) {
  i4 = 1;
  return i4 | 0;
 }
 i3 = i1;
 if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i3 >> 2] | 0) + 24 >> 2] & 1](i1) | 0) {
  i4 = 1;
  return i4 | 0;
 }
 if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i3 >> 2] | 0) + 20 >> 2] & 1](i1) | 0) {
  i4 = 1;
  return i4 | 0;
 }
 FUNCTION_TABLE_vii[HEAP32[(HEAP32[i1 >> 2] | 0) + 16 >> 2] & 1](i1, 1);
 __ZN7WebCore10SVGElement26sendSVGLoadEventIfPossibleEb(i2, 0);
 i4 = 1;
 return i4 | 0;
}
function __ZN7WebCore28SVGExternalResourcesRequired17dispatchLoadEventEPNS_10SVGElementE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0, i4 = 0;
 i3 = (HEAP8[FUNCTION_TABLE_ii[HEAP32[(HEAP32[i1 >> 2] | 0) + 12 >> 2] & 1](i1) | 0] & 1) == 0;
 i4 = i1;
 do {
  if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i4 >> 2] | 0) + 20 >> 2] & 1](i1) | 0) {
   if (!i3) {
    break;
   }
   return;
  } else {
   if (!(FUNCTION_TABLE_ii[HEAP32[(HEAP32[i4 >> 2] | 0) + 24 >> 2] & 1](i1) | 0 | i3)) {
    break;
   }
   return;
  }
...
function __ZN7WebCore28SVGExternalResourcesRequired22addSupportedAttributesERN3WTF7HashSetINS_13QualifiedNameENS_17QualifiedNameHashENS1_10HashTraitsIS3_EEEE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i1 = STACKTOP;
 STACKTOP = STACKTOP + 16 | 0;
 __ZN3WTF9HashTableIN7WebCore13QualifiedNameES2_NS_17IdentityExtractorENS1_17QualifiedNameHashENS_10HashTraitsIS2_EES6_E3addINS_22IdentityHashTranslatorIS4_EERKS2_SC_EENS_18HashTableAddResultINS_17HashTableIteratorIS2_S2_S3_S4_S6_S6_EEEEOT0_OT1_(i1 | 0, i2 | 0, __ZN7WebCore8SVGNames29externalResourcesRequiredAttrE, __ZN7WebCore8SVGNames29externalResourcesRequiredAttrE);
 STACKTOP = i1;
 return;
}
function __ZN7WebCore28SVGExternalResourcesRequired14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0, i5 = 0, i6 = 0;
 ...
 STACKTOP = STACKTOP + 8 | 0;
 i5 = i4 | 0;
 if ((HEAP32[i2 >> 2] | 0) != (HEAP32[__ZN7WebCore8SVGNames29externalResourcesRequiredAttrE >> 2] | 0)) {
  i6 = 0;
  STACKTOP = i4;
  return i6 | 0;
 }
 i2 = HEAP32[(HEAP32[i1 >> 2] | 0) + 8 >> 2] | 0;
 HEAP8[i5] = (__ZN3WTF5equalEPKNS_10StringImplEPKh(HEAP32[i3 >> 2] | 0, H_BASE + 8 | 0) | 0) & 1;
 FUNCTION_TABLE_viii[i2 & 1](i1, i5, 1);
 i6 = 1;
 STACKTOP = i4;
 return i6 | 0;
}
...
function __ZN7WebCore28SVGExternalResourcesRequired20insertedIntoDocumentEPNS_10SVGElementE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i1 >> 2] | 0) + 20 >> 2] & 1](i1) | 0) {
  return;
 }
 if ((HEAP8[FUNCTION_TABLE_ii[HEAP32[(HEAP32[i1 >> 2] | 0) + 12 >> 2] & 1](i1) | 0] & 1) != 0) {
  return;
 ...
 FUNCTION_TABLE_vii[HEAP32[(HEAP32[i1 >> 2] | 0) + 16 >> 2] & 1](i1, 1);
 __ZN7WebCore10SVGElement40sendSVGLoadEventIfPossibleAsynchronouslyEv(i2);
 return;
}
...
function __ZNK7WebCore28SVGExternalResourcesRequired27haveLoadedRequiredResourcesEv(i1) {
 i1 = i1 | 0;
 var i2 = 0;
 if ((HEAP8[FUNCTION_TABLE_ii[HEAP32[(HEAP32[i1 >> 2] | 0) + 12 >> 2] & 1](i1) | 0] & 1) == 0) {
  i2 = 1;
 ...
 i2 = FUNCTION_TABLE_ii[HEAP32[(HEAP32[i1 >> 2] | 0) + 24 >> 2] & 1](i1) | 0;
 return i2 | 0;
}
function __ZN7WebCore28SVGExternalResourcesRequired21finishParsingChildrenEv(i1) {
 i1 = i1 | 0;
 if ((HEAP8[FUNCTION_TABLE_ii[HEAP32[(HEAP32[i1 >> 2] | 0) + 12 >> 2] & 1](i1) | 0] & 1) != 0) {
  return;
 }
...
function __ZN7WebCore28SVGExternalResourcesRequired16isKnownAttributeERKNS_13QualifiedNameE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 return (HEAP32[i2 >> 2] | 0) == (HEAP32[__ZN7WebCore8SVGNames29externalResourcesRequiredAttrE >> 2] | 0) | 0;
}
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZN7WebCore28SVGExternalResourcesRequired17dispatchLoadEventEPNS_10SVGElementE","__ZN3WTF9HashTableIN7WebCore13QualifiedNameES2_NS_17IdentityExtractorENS1_17QualifiedNameHashENS_10HashTraitsIS2_EES6_E6rehashEiPS2_","__ZN7WebCore28SVGExternalResourcesRequired14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE","_memset","__ZN7WebCore28SVGExternalResourcesRequired20insertedIntoDocumentEPNS_10SVGElementE","__ZN3WTF9HashTableIN7WebCore13QualifiedNameES2_NS_17IdentityExtractorENS1_17QualifiedNameHashENS_10HashTraitsIS2_EES6_E3addINS_22IdentityHashTranslatorIS4_EERKS2_SC_EENS_18HashTableAddResultINS_17HashTableIteratorIS2_S2_S3_S4_S6_S6_EEEEOT0_OT1_","_memcpy","__ZN7WebCore28SVGExternalResourcesRequired16isKnownAttributeERKNS_13QualifiedNameE","__ZN7WebCore28SVGExternalResourcesRequired21finishParsingChildrenEv","__ZNK7WebCore28SVGExternalResourcesRequired27haveLoadedRequiredResourcesEv","__ZN7WebCore28SVGExternalResourcesRequired21handleAttributeChangeEPNS_10SVGElementERKNS_13QualifiedNameE","__ZN3WTF9HashTableIN7WebCore13QualifiedNameES2_NS_17IdentityExtractorENS1_17QualifiedNameHashENS_10HashTraitsIS2_EES6_E16lookupForWritingINS_22IdentityHashTranslatorIS4_EES2_EENSt3__14pairIPS2_bEERKT0_","__ZN7WebCore28SVGExternalResourcesRequired22addSupportedAttributesERN3WTF7HashSetINS_13QualifiedNameENS_17QualifiedNameHashENS1_10HashTraitsIS3_EEEE"]
