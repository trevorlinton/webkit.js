...
function __ZN7WebCore21JSSQLResultSetRowList4itemEPN3JSC9ExecStateE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0, i5 = 0, i6 = 0, i7 = 0, i8 = 0, i9 = 0, i10 = 0, i11 = 0, i12 = 0, i13 = 0, i14 = 0, i15 = 0, d16 = +0, i17 = 0, i18 = 0, i19 = 0, i20 = 0, i21 = 0, i22 = 0, i23 = 0, i24 = 0, i25 = 0, i26 = 0, i27 = 0, i28 = 0, i29 = 0, i30 = 0, i31 = 0, i32 = 0, i33 = 0, i34 = 0, i35 = 0, i36 = 0, i37 = 0, i38 = 0, i39 = 0, i40 = 0, i41 = 0, i42 = 0, i43 = 0, i44 = 0, i45 = 0, i46 = 0, i47 = 0, i48 = 0, i49 = 0, i50 = 0;
 i4 = STACKTOP;
 ...
 if ((i12 | 0) == 7) {
  d16 = +__ZNK3JSC7JSValue16toNumberSlowCaseEPNS_9ExecStateE(i9, i3);
 }
 HEAPF64[tempDoublePtr >> 3] = d16;
 i9 = HEAP32[tempDoublePtr + 4 >> 2] & 2146435072;
 i15 = 2146435072;
 i14 = i9 >>> 0 < i15 >>> 0 | i9 >>> 0 == i15 >>> 0 & (HEAP32[tempDoublePtr >> 2] & 0) >>> 0 < 0 >>> 0;
 ...
 do {
  if ((i15 | 0) >= 0) {
   i14 = i2 + 12 | 0;
   if (i15 >>> 0 >= (__ZNK7WebCore19SQLResultSetRowList6lengthEv(HEAP32[i14 >> 2] | 0) | 0) >>> 0) {
    break;
   }
   i9 = i3 + 16 | 0;
   i13 = HEAP32[(HEAP32[HEAP32[i9 >> 2] >> 2] | 0) + 4 >> 2] | 0;
   i17 = __ZN3JSC12PrototypeMap32emptyObjectStructureForPrototypeEPNS_8JSObjectEj((HEAP32[(HEAP32[(i13 & -65536) + 1076 >> 2] | 0) + 20544 >> 2] | 0) + 24544 | 0, HEAP32[i13 + 136 >> 2] | 0, 7) | 0;
   i13 = HEAP32[(HEAP32[i9 >> 2] & -65536) + 1076 >> 2] | 0;
   i18 = HEAPU8[i17 + 56 | 0] | 0;
   i19 = (i18 << 3) + 8 | 0;
   if (i19 >>> 0 < 129 >>> 0) {
    i20 = i13 + 13176 + (i18 * 44 & -1) | 0;
   } else {
    i20 = i13 + 13880 + ((i18 >>> 5) * 44 & -1) | 0;
   }
   i18 = i20 | 0;
   i13 = HEAP32[i18 >> 2] | 0;
   if ((i13 | 0) == 0) {
    i21 = __ZN3JSC15MarkedAllocator16allocateSlowCaseEj(i20, i19) | 0;
   } else {
   ...
   L26 : do {
    if ((i18 | 0) == 0) {
     ...
     while (1) {
      i39 = i37 + i19 | 0;
      if ((HEAP32[i38 + 24 >> 2] | 0) >>> 0 <= i39 >>> 0) {
       i12 = 23;
       break;
      }
      i40 = (HEAP32[i38 + 16 >> 2] | 0) + (i39 * 24 & -1) | 0;
      i39 = HEAP32[i40 >> 2] | 0;
      do {
       if ((i39 | 0) == 2) {
        __ZNK7WebCore8SQLValue6stringEv(i11, i40);
        __ZN7WebCore17jsStringWithCacheEPN3JSC9ExecStateERKN3WTF6StringE(i10, i3, i11);
        i41 = HEAP32[i35 >> 2] | 0;
        ...
        d16 = +__ZNK7WebCore8SQLValue6numberEv(i40);
        i42 = ~~d16;
        if (+(i42 | 0) != d16) {
         HEAPF64[tempDoublePtr >> 3] = d16;
         i48 = HEAP32[tempDoublePtr + 4 >> 2] | 0;
         i49 = HEAP32[tempDoublePtr >> 2] | 0;
        } else {
         HEAPF64[tempDoublePtr >> 3] = d16;
         i41 = HEAP32[tempDoublePtr >> 2] | 0;
         i47 = HEAP32[tempDoublePtr + 4 >> 2] | 0;
         i46 = 0;
         if ((i42 | 0) == 0 & ((i47 | 0) < (i46 | 0) | (i47 | 0) == (i46 | 0) & i41 >>> 0 < 0 >>> 0)) {
          i48 = i47;
          i49 = i41;
         } else {
          i44 = i42;
      ...
      i40 = HEAP32[(HEAP32[i9 >> 2] & -65536) + 1076 >> 2] | 0;
      i39 = HEAP32[i14 >> 2] | 0;
      if ((HEAP32[i39 + 12 >> 2] | 0) >>> 0 <= i37 >>> 0) {
       i12 = 35;
       break;
      }
      i42 = HEAP32[(HEAP32[i39 + 4 >> 2] | 0) + (i37 << 2) >> 2] | 0;
      if ((HEAP32[i42 + 16 >> 2] & 4 | 0) == 0) {
       __ZN3JSC10Identifier11addSlowCaseEPNS_9ExecStateEPN3WTF10StringImplE(i5, i3, i42);
      } else {
       HEAP32[i23 >> 2] = i42;
       i39 = i42 | 0;
      ...
      HEAP32[i34 + 4 >> 2] = i45;
      if ((i45 | 0) == -5) {
       i50 = __ZN3JSC21getCallableObjectSlowEPNS_6JSCellE(i44) | 0;
      } else {
       i50 = 0;
      }
      __ZN3JSC8JSObject17putDirectInternalILNS0_7PutModeE1EEEbRNS_2VMENS_12PropertyNameENS_7JSValueEjRNS_15PutPropertySlotEPNS_6JSCellE(i17, i40, i7, i8, 10, i6, i50) | 0;
      do {
       if ((i39 | 0) != 0) {
        i40 = i39 | 0;
 ...
 __ZN7WebCore15setDOMExceptionEPN3JSC9ExecStateEi(i3, 1);
 HEAP32[i1 + 4 >> 2] = -4;
 HEAP32[i1 >> 2] = 0;
 STACKTOP = i4;
 return;
