...
function __ZNK7WebCore12SVGPointList13valueAsStringEv(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 L1 : do {
  if ((i13 | 0) != 0) {
   ...
   while (1) {
     ...
     if ((i16 | 0) != 0) {
      ...
      do {
       if ((i17 | 0) != 0) {
        ...
        HEAP32[i7 >> 2] = i18 + 1;
        if (i19) {
         HEAP16[(HEAP32[i15 >> 2] | 0) + (i18 << 1) >> 1] = 32;
         break L5;
        } else {
         HEAP8[(HEAP32[i11 >> 2] | 0) + i18 | 0] = 32;
         break L5;
        }
       }
      } while (0);
    ...
    i17 = HEAP32[i14 >> 2] | 0;
    __ZN3WTF13StringBuilder12appendNumberEdjNS_29TrailingZerosTruncatingPolicyE(i6, +HEAPF32[i17 + (i16 << 3) >> 2], 6, 1);
    HEAP8[i4] = 32;
    i18 = HEAP32[i9 >> 2] | 0;
    do {
     if ((i18 | 0) == 0) {
      ...
      HEAP32[i7 >> 2] = i19 + 1;
      if (i21) {
       HEAP16[(HEAP32[i15 >> 2] | 0) + (i19 << 1) >> 1] = 32;
       break;
      } else {
    ...
    __ZN3WTF13StringBuilder12appendNumberEdjNS_29TrailingZerosTruncatingPolicyE(i6, +HEAPF32[i17 + (i16 << 3) + 4 >> 2], 6, 1);
    i16 = i16 + 1 | 0;
    if (i16 >>> 0 >= i13 >>> 0) {
     break L1;
    }
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","_memcpy","__ZN3WTF15CrashOnOverflow10overflowedEv","_memset","__ZNK7WebCore12SVGPointList13valueAsStringEv"]
