...
function __ZN7WebCore17JSHTMLFormElement10nameGetterEPN3JSC9ExecStateExxNS1_12PropertyNameE(i1, i2, i3, i4, i5, i6) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 HEAP32[i13 >> 2] = 0;
 i14 = HEAP32[i6 >> 2] | 0;
 i6 = (HEAP32[i14 + 16 >> 2] & 4 | 0) != 0 ? i14 : 0;
 do {
  if ((i6 | 0) == 0) {
   HEAP32[i4 >> 2] = 0;
   i15 = 0;
 ...
 i6 = i7 | 0;
 HEAP32[i6 >> 2] = i15;
 __ZN7WebCore15HTMLFormElement16getNamedElementsERKN3WTF12AtomicStringERNS1_6VectorINS1_3RefINS_7ElementEEELj0ENS1_15CrashOnOverflowEEE(i2, i7, i3);
 i3 = HEAP32[i6 >> 2] | 0;
 do {
  if ((i3 | 0) != 0) {
   i6 = i3 | 0;
 ...
 do {
  if ((i3 | 0) == 0) {
   ...
   i7 = HEAP32[(HEAP32[i10 >> 2] | 0) + 4 >> 2] | 0;
   do {
    if ((i3 | 0) == 1) {
     i6 = HEAP32[HEAP32[i11 >> 2] >> 2] | 0;
     i2 = i6 | 0;
     L18 : do {
      if ((i6 | 0) == 0) {
       HEAP32[i8 + 4 >> 2] = -3;
       ...
       __ZN7WebCore13createWrapperEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_4NodeE(i8, i1, i7, i2);
      }
     } while (0);
     i2 = i8 | 0;
     i30 = HEAP32[i2 + 4 >> 2] | 0;
     ...
     HEAP32[i12 >> 2] = i26;
     i26 = i2;
     __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_8NodeListE(i9, i1, i7, i26);
     i21 = i9 | 0;
     i15 = HEAP32[i21 >> 2] | 0;
     ...
     if ((i21 | 0) == 0) {
      FUNCTION_TABLE_vi[HEAP32[(HEAP32[i2 >> 2] | 0) + 4 >> 2] & 1](i26);
      i30 = i22;
      i31 = i15;
      break;
     } else {
   ...
   i7 = i15;
   while (1) {
    i15 = (HEAP32[i7 >> 2] | 0) + 8 | 0;
    i21 = i15 - 8 | 0;
    i6 = i15 | 0;
    i26 = (HEAP32[i6 >> 2] | 0) - 1 | 0;
    HEAP32[i6 >> 2] = i26;
    do {
     if ((i26 | 0) < 1) {
...
function __ZN7WebCore17JSHTMLFormElement18canGetItemsForNameEPN3JSC9ExecStateEPNS_15HTMLFormElementENS1_12PropertyNameE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i3 = i5 | 0;
 HEAP32[i3 >> 2] = i7;
 i7 = __ZN7WebCore15HTMLFormElement15hasNamedElementERKN3WTF12AtomicStringE(i2, i5) | 0;
 i5 = HEAP32[i3 >> 2] | 0;
 if ((i5 | 0) == 0) {
  STACKTOP = i1;
  return i7 | 0;
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZN7WebCore17JSHTMLFormElement18canGetItemsForNameEPN3JSC9ExecStateEPNS_15HTMLFormElementENS1_12PropertyNameE","__ZN7WebCore17JSHTMLFormElement10nameGetterEPN3JSC9ExecStateExxNS1_12PropertyNameE","_strlen","_memcpy","_memset"]
