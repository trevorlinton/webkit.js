...
var __ZN7WebCore14HTMLMapElementC1ERKNS_13QualifiedNameERNS_8DocumentE;
var __ZN7WebCore14HTMLMapElementD1Ev;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore14HTMLMapElementE=(H_BASE+8)|0;
...
function runPostSets() {
 ...
 HEAP32[H_BASE + 548 >> 2] = F_BASE_vi + 36;
...
function __ZN7WebCore14HTMLMapElement13mapMouseEventENS_11LayoutPointERKNS_10LayoutSizeERNS_13HitTestResultE(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 L7 : while (1) {
  if ((i9 & 16 | 0) != 0) {
   if ((HEAP32[(HEAP32[i13 + 44 >> 2] | 0) + 12 >> 2] | 0) == (HEAP32[(HEAP32[__ZN7WebCore9HTMLNames7areaTagE >> 2] | 0) + 12 >> 2] | 0)) {
    i11 = 17;
    break;
   }
  }
  ...
  do {
   if ((i12 | 0) == 0) {
    ...
    i14 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i13, i8) | 0;
    if ((i14 | 0) == 0) {
     i10 = 0;
     i11 = 48;
     break L7;
  ...
  if ((HEAP32[i15 + 12 >> 2] & 4 | 0) == 0) {
   ...
   while (1) {
    ...
    if ((i14 | 0) == 0) {
     i16 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i12, i8) | 0;
     if ((i16 | 0) == 0) {
      i10 = 0;
      i11 = 50;
      break L7;
 ...
 if ((i11 | 0) == 17) {
  ...
  L30 : while (1) {
   ...
   if ((HEAP32[i9 + 84 >> 2] | 0) == 0) {
    ...
    HEAP32[i6 + 4 >> 2] = i15;
    if (__ZN7WebCore15HTMLAreaElement13mapMouseEventENS_11LayoutPointERKNS_10LayoutSizeERNS_13HitTestResultE(i13, i7, i3, i4) | 0) {
     i10 = 1;
     i11 = 52;
     break;
    } else {
   ...
   do {
    if ((i13 | 0) == 0) {
     ...
     i15 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i9, i18) | 0;
     if ((i15 | 0) == 0) {
      break L30;
     } else {
      i20 = i15;
   ...
   if ((HEAP32[i20 + 12 >> 2] & 4 | 0) == 0) {
    ...
    while (1) {
     ...
     if ((i15 | 0) == 0) {
      i17 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i13, i18) | 0;
      if ((i17 | 0) == 0) {
       break L30;
      } else {
       i21 = i17;
   ...
   L48 : while (1) {
    if ((HEAP32[i22 + 12 >> 2] & 16 | 0) != 0) {
     if ((HEAP32[(HEAP32[i22 + 44 >> 2] | 0) + 12 >> 2] | 0) == (HEAP32[(HEAP32[__ZN7WebCore9HTMLNames7areaTagE >> 2] | 0) + 12 >> 2] | 0)) {
      break;
     }
    }
    i13 = HEAP32[i22 + 36 >> 2] | 0;
    do {
     if ((i13 | 0) == 0) {
      if ((i22 | 0) == (i18 | 0)) {
       break L30;
      }
      i15 = HEAP32[i22 + 28 >> 2] | 0;
      if ((i15 | 0) != 0) {
       i23 = i15;
       break;
      }
      i15 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i22, i18) | 0;
      if ((i15 | 0) == 0) {
       break L30;
      } else {
       i23 = i15;
    ...
    while (1) {
     ...
     if ((i13 | 0) == 0) {
      i15 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i24, i18) | 0;
      if ((i15 | 0) == 0) {
       break L30;
      } else {
       i25 = i15;
  ...
  __ZN7WebCore13HitTestResult12setInnerNodeEPNS_4NodeE(i4, i19 | 0);
  __ZN7WebCore13HitTestResult13setURLElementEPNS_7ElementE(i4, i19 | 0);
  i10 = 1;
  STACKTOP = i5;
  return i10 | 0;
 } else if ((i11 | 0) == 47) {
...
function __ZN7WebCore14HTMLMapElement14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i10 = HEAP32[i9 >> 2] | 0;
 i11 = HEAP32[i2 >> 2] | 0;
 i12 = (i11 | 0) == (HEAP32[(HEAP32[i10 + 8 >> 2] | 0) + 1680 >> 2] | 0);
 if (!(i12 | (i11 | 0) == (HEAP32[__ZN7WebCore9HTMLNames8nameAttrE >> 2] | 0))) {
 ...
 do {
  if (i12) {
   __ZN7WebCore11HTMLElement14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE(i1 | 0, i2, i3);
   i11 = HEAP32[i9 >> 2] | 0;
   if ((HEAP8[(HEAP32[i11 + 8 >> 2] | 0) + 1576 | 0] & 1) == 0) {
    i13 = i11;
    break;
   }
   STACKTOP = i4;
 ...
 i10 = i1 + 12 | 0;
 if ((HEAP32[i10 >> 2] & 256 | 0) != 0) {
  __ZN7WebCore9TreeScope14removeImageMapERNS_14HTMLMapElementE(i13, i1);
 }
 i13 = i6 | 0;
 i2 = HEAP32[i3 >> 2] | 0;
 HEAP32[i13 >> 2] = i2;
 do {
  if ((i2 | 0) != 0) {
   ...
   if ((HEAP32[i3 + 16 >> 2] & 32 | 0) == 0) {
    i14 = HEAP16[HEAP32[i12 >> 2] >> 1] | 0;
   } else {
    i14 = HEAPU8[HEAP32[i12 >> 2] | 0] | 0;
   }
   if (i14 << 16 >> 16 != 35) {
    break;
   }
   __ZNK3WTF6String9substringEjj(i7, i6, 1, -1);
   i12 = i7 | 0;
   i3 = HEAP32[i12 >> 2] | 0;
   HEAP32[i12 >> 2] = 0;
   i11 = HEAP32[i13 >> 2] | 0;
 ...
 do {
  if ((HEAP8[(HEAP32[(HEAP32[i9 >> 2] | 0) + 8 >> 2] | 0) + 1576 | 0] & 1) == 0) {
   i7 = i8 | 0;
   i14 = HEAP32[i13 >> 2] | 0;
   HEAP32[i7 >> 2] = i14;
   if ((i14 | 0) == 0) {
 ...
 do {
  if ((i8 | 0) == 0) {
   ...
   if ((HEAP32[i8 + 16 >> 2] & 16 | 0) == 0) {
    __ZN3WTF12AtomicString11addSlowCaseEPNS_10StringImplE(i5, i8);
    i19 = i5 | 0;
    break;
   } else {
    i6 = i5 | 0;
 ...
 if ((HEAP32[i10 >> 2] & 256 | 0) != 0) {
  __ZN7WebCore9TreeScope11addImageMapERNS_14HTMLMapElementE(HEAP32[i9 >> 2] | 0, i1);
 }
 i1 = HEAP32[i13 >> 2] | 0;
 if ((i1 | 0) == 0) {
  STACKTOP = i4;
...
function __ZN7WebCore14HTMLMapElement6createERKNS_13QualifiedNameERNS_8DocumentE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
...
function __ZN7WebCore14HTMLMapElement6createERNS_8DocumentE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 i6 = HEAP32[__ZN7WebCore9HTMLNames6mapTagE >> 2] | 0;
 HEAP32[i3 + 44 >> 2] = i6;
 i8 = i6 | 0;
...
function __ZN7WebCore14HTMLMapElementC2ERKNS_13QualifiedNameERNS_8DocumentE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
...
function __ZN7WebCore14HTMLMapElementC1ERKNS_13QualifiedNameERNS_8DocumentE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0, i5 = 0, i6 = 0, i7 = 0;
...
function __ZN7WebCore14HTMLMapElement12imageElementEv(i1) {
 i1 = i1 | 0;
 ...
 __ZNK3WTF12AtomicString5lowerEv(i3, i4);
 i4 = i3 | 0;
 i3 = __ZNK7WebCore8Document30imageElementByLowercasedUsemapERKN3WTF16AtomicStringImplE(HEAP32[(HEAP32[i1 + 20 >> 2] | 0) + 8 >> 2] | 0, HEAP32[i4 >> 2] | 0) | 0;
 i1 = HEAP32[i4 >> 2] | 0;
 if ((i1 | 0) == 0) {
  i6 = i3;
  STACKTOP = i2;
...
function __ZN7WebCore14HTMLMapElementD0Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
...
function __ZN7WebCore14HTMLMapElementD2Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i1 + 52 >> 2] | 0;
...
function __ZN7WebCore14HTMLMapElementD1Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i1 + 52 >> 2] | 0;
...
function __ZN7WebCore14HTMLMapElement12insertedIntoERNS_13ContainerNodeE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 i3 = __ZN7WebCore7Element12insertedIntoERNS_13ContainerNodeE(i1 | 0, i2) | 0;
 if ((HEAP32[i2 + 12 >> 2] & 256 | 0) == 0) {
  return i3 | 0;
 }
 __ZN7WebCore9TreeScope11addImageMapERNS_14HTMLMapElementE(HEAP32[i1 + 20 >> 2] | 0, i1);
 return i3 | 0;
}
...
function __ZN7WebCore14HTMLMapElement11removedFromERNS_13ContainerNodeE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 if ((HEAP32[i2 + 12 >> 2] & 256 | 0) != 0) {
  __ZN7WebCore9TreeScope14removeImageMapERNS_14HTMLMapElementE(HEAP32[i1 + 20 >> 2] | 0, i1);
 }
...
function __ZN7WebCore14HTMLMapElement5areasEv(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 __ZN7WebCore7Element26ensureCachedHTMLCollectionENS_14CollectionTypeE(i1, i2 | 0, 18);
 return;
}
...
// EMSCRIPTEN_END_FUNCS
  ...
  ,b3,ii___ZNK7WebCore11HTMLElement11virtualFormEv__wrapper,b3,ii___ZNK7WebCore7Element14shadowPseudoIdEv__wrapper,b3,__ZNK7WebCore4Node19isCharacterDataNodeEv,b3,__ZNK7WebCore7Element9localNameEv,b3,ii___ZN7WebCore7Element6onloadEv__wrapper,b3,ii___ZN7WebCore4Node6toNodeEv__wrapper,b3,__ZNK7WebCore4Node14customPseudoIdEv,b3,ii___ZNK7WebCore7Element11isFocusableEv__wrapper,b3,ii___ZN7WebCore7Element6onblurEv__wrapper,b3,__ZNK7WebCore11HTMLElement11isLabelableEv,b3,__ZNK7WebCore4Node15isMediaControlsEv,b3,ii___ZN7WebCore11EventTarget11toDOMWindowEv__wrapper,b3,__ZNK7WebCore7Element23areAuthorShadowsAllowedEv,b3,__ZNK7WebCore4Node15isAttributeNodeEv,b3,__ZNK7WebCore11HTMLElement29isTextControlInnerTextElementEv
  ,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3
  ,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3
  ,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3
  ,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3,b3];
  var FUNCTION_TABLE_viii = [b4,b4,__ZN7WebCore14HTMLMapElement14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE,b4,viii___ZN7WebCore7Element9cloneNodeEb__wrapper,b4,viii___ZN7WebCore7Element9setPrefixERKN3WTF12AtomicStringERi__wrapper,b4,viii___ZN7WebCore4Node12setNodeValueERKN3WTF6StringERi__wrapper,b4,__ZN7WebCore14HTMLMapElementC2ERKNS_13QualifiedNameERNS_8DocumentE,b4,viii___ZN7WebCore7Element5focusEbNS_14FocusDirectionE__wrapper,b4,viii___ZN7WebCore7Element9setActiveEbb__wrapper,b4];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZNK7WebCore7Element32isSearchFieldCancelButtonElementEv","__ZNK7WebCore7Element21isRequiredFormControlEv","__ZNK7WebCore7Element12namespaceURIEv","__ZN7WebCore7Element20buildPendingResourceEv","__ZN7WebCore14HTMLMapElement6createERKNS_13QualifiedNameERNS_8DocumentE","__ZN7WebCore14HTMLMapElement6createERNS_8DocumentE","__ZN7WebCore7Element29privateBrowsingStateDidChangeEv","__ZN7WebCore14HTMLMapElementD0Ev","__ZN7WebCore7Element30documentDidResumeFromPageCacheEv","__ZNK7WebCore4Node16nonRendererStyleEv","__ZNK7WebCore7Element19isSpinButtonElementEv","__ZN7WebCore7Element20mediaVolumeDidChangeEv","__ZNK7WebCore4Node15isPluginElementEv","__ZN7WebCore14HTMLMapElement11removedFromERNS_13ContainerNodeE","__ZNK7WebCore7Element6targetEv","__ZNK7WebCore7Element31alwaysCreateUserAgentShadowRootEv","__ZN7WebCore4Node24startLoadingDynamicSheetEv","__ZN7WebCore7Element30willStopBeingFullscreenElementEv","__ZN7WebCore4Node26didNotifySubtreeInsertionsEPNS_13ContainerNodeE","_memset","__ZNK7WebCore4Node22scriptExecutionContextEv","__ZNK7WebCore4Node19isCharacterDataNodeEv","__ZNK7WebCore7Element9localNameEv","__ZNK7WebCore7Element22isDefaultButtonForFormEv","_memcpy","__ZNK7WebCore7Element22isHTMLContentAttributeERKNS_9AttributeE","__ZN7WebCore14HTMLMapElement12insertedIntoERNS_13ContainerNodeE","__ZN7WebCore11HTMLElement15asFormNamedItemEv","__ZN7WebCore14HTMLMapElement14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE","__ZNK7WebCore4Node21isMediaControlElementEv","__ZN7WebCore4Node11sheetLoadedEv","__ZNK7WebCore4Node19isFrameOwnerElementEv","__ZNK7WebCore4Node20isInsertionPointNodeEv","__ZN7WebCore14HTMLMapElementD2Ev","__ZN7WebCore7Element22visibilityStateChangedEv","__ZNK7WebCore7Element9isInRangeEv","__ZNK7WebCore4Node14customPseudoIdEv","__ZNK7WebCore7Element20isFormControlElementEv","__ZNK7WebCore7Element12willValidateEv","__ZN7WebCore14HTMLMapElementC2ERKNS_13QualifiedNameERNS_8DocumentE","__ZN7WebCore14HTMLMapElement5areasEv","__ZNK7WebCore7Element21isDisabledFormControlEv","__ZNK7WebCore7Element12isOutOfRangeEv","__ZNK7WebCore7Element17isTextFormControlEv","__ZN7WebCore7Element25didAddUserAgentShadowRootEPNS_10ShadowRootE","__ZN7WebCore14HTMLMapElement13mapMouseEventENS_11LayoutPointERKNS_10LayoutSizeERNS_13HitTestResultE","__ZN7WebCore13StyledElement36additionalPresentationAttributeStyleEv","__ZN7WebCore7Element25isValidFormControlElementEv","__ZNK7WebCore11HTMLElement11isLabelableEv","__ZNK7WebCore7Element18isFrameElementBaseEv","__ZNK7WebCore4Node15isMediaControlsEv","__ZNK7WebCore7Element23areAuthorShadowsAllowedEv","__ZN7WebCore4Node43notifyLoadedSheetAndAllCriticalSubresourcesEb","__ZNK7WebCore7Element21isOptionalFormControlEv","__ZNK7WebCore11HTMLElement20isHTMLUnknownElementEv","__ZNK7WebCore4Node15isAttributeNodeEv","__ZNK7WebCore7Element23canContainRangeEndPointEv","__ZNK7WebCore7Element6prefixEv","__ZN7WebCore7Element37copyNonAttributePropertiesFromElementERKS0_","__ZN7WebCore7Element31documentWillSuspendForPageCacheEv","__ZN7WebCore14HTMLMapElement12imageElementEv","__ZN7WebCore7Element26didBecomeFullscreenElementEv","__ZNK7WebCore11HTMLElement29isTextControlInnerTextElementEv"]
