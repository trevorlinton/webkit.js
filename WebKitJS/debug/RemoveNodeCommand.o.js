...
var __ZN7WebCore17RemoveNodeCommandC1EN3WTF10PassRefPtrINS_4NodeEEENS_35ShouldAssumeContentIsAlwaysEditableE;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore17RemoveNodeCommandE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore17RemoveNodeCommand9doUnapplyEv(i1) {
 i1 = i1 | 0;
 ...
 do {
  if (!i5) {
   ...
   i10 = i4 | 0;
   HEAP32[i10 >> 2] = 0;
   __ZN7WebCore13ContainerNode12insertBeforeEN3WTF10PassRefPtrINS_4NodeEEEPS3_Ri(i6, i3, i7, i10) | 0;
   i10 = HEAP32[i9 >> 2] | 0;
   if ((i10 | 0) == 0) {
    break;
   }
...
function __ZN7WebCore17RemoveNodeCommand7doApplyEv(i1) {
 i1 = i1 | 0;
 ...
 do {
  if ((HEAP32[i1 + 148 >> 2] | 0) == 1) {
   if (__ZN7WebCore4Node17isContentEditableENS0_22UserSelectAllTreatmentE(i5 | 0, 1) | 0) {
    break;
   }
   i6 = i5 + 32 | 0;
 ...
 i6 = HEAP32[(HEAP32[i4 >> 2] | 0) + 28 >> 2] | 0;
 if ((i6 | 0) != 0) {
  i5 = i6 + 8 | 0;
 ...
 i4 = i3 | 0;
 HEAP32[i4 >> 2] = 0;
 __ZN7WebCore4Node6removeERi(i1, i4);
 STACKTOP = i2;
 return;
}
function __ZN7WebCore17RemoveNodeCommandD1Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore17RemoveNodeCommandD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore17RemoveNodeCommandC2EN3WTF10PassRefPtrINS_4NodeEEENS_35ShouldAssumeContentIsAlwaysEditableE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
function __ZN7WebCore17RemoveNodeCommandC1EN3WTF10PassRefPtrINS_4NodeEEENS_35ShouldAssumeContentIsAlwaysEditableE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_vi = [b0,b0,__ZN7WebCore17RemoveNodeCommand7doApplyEv,b0,__ZN7WebCore17RemoveNodeCommand9doUnapplyEv,b0,__ZN7WebCore17RemoveNodeCommandD0Ev,b0,__ZN7WebCore17RemoveNodeCommandD1Ev,b0,vi___ZN7WebCore17SimpleEditCommand9doReapplyEv__wrapper,b0,b0,b0,b0,b0];
  ...
  var FUNCTION_TABLE_viii = [b2,b2,__ZN7WebCore17RemoveNodeCommandC2EN3WTF10PassRefPtrINS_4NodeEEENS_35ShouldAssumeContentIsAlwaysEditableE,b2];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZN7WebCore17RemoveNodeCommand7doApplyEv","__ZN7WebCore17RemoveNodeCommand9doUnapplyEv","__ZN7WebCore17RemoveNodeCommandD0Ev","__ZNK7WebCore17SimpleEditCommand19isSimpleEditCommandEv","_memset","__ZN7WebCore17RemoveNodeCommandD1Ev","__ZNK7WebCore11EditCommand24isEditCommandCompositionEv","_memcpy","__ZNK7WebCore11EditCommand22isCompositeEditCommandEv","__ZN7WebCore17RemoveNodeCommandC2EN3WTF10PassRefPtrINS_4NodeEEENS_35ShouldAssumeContentIsAlwaysEditableE"]
