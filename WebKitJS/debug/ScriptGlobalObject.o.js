...
function __ZN7WebCore18ScriptGlobalObject3setEPN3JSC9ExecStateEPKcPNS_21InspectorFrontendHostE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i11 = i4 + 72 | 0;
 i12 = i4 + 80 | 0;
 __ZN3JSC12JSLockHolderC1EPNS_9ExecStateE(i10, i1);
 i13 = i1 + 16 | 0;
 i14 = HEAP32[i13 >> 2] | 0;
 i15 = HEAP32[(HEAP32[i14 >> 2] | 0) + 4 >> 2] | 0;
 i16 = HEAP32[(i14 & -65536) + 1076 >> 2] | 0;
 __ZN3WTF6StringC1EPKc(i11, i2);
 i2 = i11 | 0;
 i11 = HEAP32[i2 >> 2] | 0;
 if ((HEAP32[i11 + 16 >> 2] & 4 | 0) == 0) {
  __ZN3JSC10Identifier11addSlowCaseEPNS_9ExecStateEPN3WTF10StringImplE(i8, i1, i11);
  i17 = i8 | 0;
 } else {
  i14 = i8 | 0;
  HEAP32[i14 >> 2] = i11;
 ...
 i14 = HEAP32[i17 >> 2] | 0;
 __ZN7WebCore4toJSEPN3JSC9ExecStateEPNS_17JSDOMGlobalObjectEPNS_21InspectorFrontendHostE(i12, i1, i15, i3);
 i3 = i12 | 0;
 i12 = HEAP32[i3 >> 2] | 0;
 i17 = HEAP32[i3 + 4 >> 2] | 0;
 i3 = (i15 | 0) == 0;
 ...
 HEAP32[i5 + 4 >> 2] = 0;
 i8 = i5 + 8 | 0;
 HEAP32[i8 >> 2] = (i3 ? 0 : 0) | i15;
 HEAP32[i8 + 4 >> 2] = i3 ? -6 : -5;
 HEAP8[i5 + 20 | 0] = 0;
 HEAP8[i5 + 21 | 0] = 0;
 HEAP32[i5 + 24 >> 2] = 0;
 HEAP32[i6 >> 2] = i14;
 ...
 HEAP32[i3 >> 2] = i12;
 HEAP32[i3 + 4 >> 2] = i17;
 if ((i12 & 0 | 0) == 0 & (i17 & -1 | 0) == (-5 | 0)) {
  i18 = __ZN3JSC21getCallableObjectSlowEPNS_6JSCellE(i12) | 0;
 } else {
  i18 = 0;
 }
 __ZN3JSC8JSObject17putDirectInternalILNS0_7PutModeE1EEEbRNS_2VMENS_12PropertyNameENS_7JSValueEjRNS_15PutPropertySlotEPNS_6JSCellE(i15, i16, i6, i7, 0, i5, i18) | 0;
 do {
  if ((i14 | 0) != 0) {
   i18 = i14 | 0;
 ...
 i14 = (HEAP32[(HEAP32[i13 >> 2] & -65536) + 1076 >> 2] | 0) + 24800 | 0;
 i13 = HEAP32[i14 >> 2] | 0;
 i5 = HEAP32[i14 + 4 >> 2] | 0;
 if ((i13 & 0 | 0) == 0 & (i5 & -1 | 0) == (-6 | 0)) {
  i19 = 1;
 ...
 HEAP32[i14 >> 2] = i13;
 HEAP32[i14 + 4 >> 2] = i5;
 __ZN7WebCore15reportExceptionEPN3JSC9ExecStateENS0_7JSValueEPNS_12CachedScriptE(i1, i9, 0);
 i19 = 0;
 __ZN3JSC12JSLockHolderD1Ev(i10);
 STACKTOP = i4;
 return i19 | 0;
}
function __ZN7WebCore18ScriptGlobalObject3setEPN3JSC9ExecStateEPKcRKN10Deprecated12ScriptObjectE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0, i5 = 0, i6 = 0, i7 = 0, i8 = 0, i9 = 0, i10 = 0, i11 = 0, i12 = 0, i13 = 0, i14 = 0, i15 = 0, i16 = 0, i17 = 0, i18 = 0, i19 = 0;
 ...
 i12 = i1 + 16 | 0;
 i13 = HEAP32[i12 >> 2] | 0;
 i14 = HEAP32[(HEAP32[i13 >> 2] | 0) + 4 >> 2] | 0;
 i15 = HEAP32[(i13 & -65536) + 1076 >> 2] | 0;
 __ZN3WTF6StringC1EPKc(i11, i2);
 i2 = i11 | 0;
 i11 = HEAP32[i2 >> 2] | 0;
 if ((HEAP32[i11 + 16 >> 2] & 4 | 0) == 0) {
 ...
 HEAP32[i6 >> 2] = i13;
 i3 = i7 | 0;
 HEAP32[i3 >> 2] = (i16 ? 0 : 0) | i17;
 HEAP32[i3 + 4 >> 2] = i16 ? -6 : -5;
 if (i16) {
  i18 = 0;
 } else {
  i18 = __ZN3JSC21getCallableObjectSlowEPNS_6JSCellE(i17 | 0) | 0;
 }
 __ZN3JSC8JSObject17putDirectInternalILNS0_7PutModeE1EEEbRNS_2VMENS_12PropertyNameENS_7JSValueEjRNS_15PutPropertySlotEPNS_6JSCellE(i14, i15, i6, i7, 0, i5, i18) | 0;
 do {
  if ((i13 | 0) != 0) {
   i18 = i13 | 0;
   i5 = (HEAP32[i18 >> 2] | 0) - 2 | 0;
 ...
 i13 = (HEAP32[(HEAP32[i12 >> 2] & -65536) + 1076 >> 2] | 0) + 24800 | 0;
 i12 = HEAP32[i13 >> 2] | 0;
 i5 = HEAP32[i13 + 4 >> 2] | 0;
 if ((i12 & 0 | 0) == 0 & (i5 & -1 | 0) == (-6 | 0)) {
  i19 = 1;
  __ZN3JSC12JSLockHolderD1Ev(i10);
  STACKTOP = i4;
  return i19 | 0;
...
function __ZN7WebCore18ScriptGlobalObject6removeEPN3JSC9ExecStateEPKc(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 i9 = i1 + 16 | 0;
 i10 = HEAP32[(HEAP32[HEAP32[i9 >> 2] >> 2] | 0) + 4 >> 2] | 0;
 i11 = HEAP32[i10 >> 2] | 0;
 i12 = HEAP32[i11 >> 2] | 0;
 do {
  if ((i12 | 0) != 0) {
 ...
 i12 = HEAP32[(HEAP32[((HEAP32[(i10 & -65536) + 1048 >> 2] | 0) == 2 ? i10 + 8 | 0 : i11 + 32 | 0) >> 2] | 0) + 44 >> 2] | 0;
 __ZN3WTF6StringC1EPKc(i8, i2);
 i2 = i8 | 0;
 i8 = HEAP32[i2 >> 2] | 0;
 if ((HEAP32[i8 + 16 >> 2] & 4 | 0) == 0) {
  __ZN3JSC10Identifier11addSlowCaseEPNS_9ExecStateEPN3WTF10StringImplE(i4, i1, i8);
  i13 = i4 | 0;
 } else {
  i11 = i4 | 0;
  HEAP32[i11 >> 2] = i8;
 ...
 i11 = HEAP32[i13 >> 2] | 0;
 HEAP32[i7 >> 2] = i11;
 FUNCTION_TABLE_iiii[i12 & 1](i10, i1, i7) | 0;
 do {
  if ((i11 | 0) != 0) {
   i7 = i11 | 0;
 ...
 i11 = (HEAP32[(HEAP32[i9 >> 2] & -65536) + 1076 >> 2] | 0) + 24800 | 0;
 i9 = HEAP32[i11 >> 2] | 0;
 i10 = HEAP32[i11 + 4 >> 2] | 0;
 if ((i9 & 0 | 0) == 0 & (i10 & -1 | 0) == (-6 | 0)) {
  i14 = 1;
 ...
 HEAP32[i11 >> 2] = i9;
 HEAP32[i11 + 4 >> 2] = i10;
 __ZN7WebCore15reportExceptionEPN3JSC9ExecStateENS0_7JSValueEPNS_12CachedScriptE(i1, i5, 0);
 i14 = 0;
 __ZN3JSC12JSLockHolderD1Ev(i6);
 STACKTOP = i3;
 return i14 | 0;
}
function __ZN7WebCore18ScriptGlobalObject3getEPN3JSC9ExecStateEPKcRN10Deprecated12ScriptObjectE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 ...
 i10 = i4 + 40 | 0;
 __ZN3JSC12JSLockHolderC1EPNS_9ExecStateE(i6, i1);
 i11 = HEAP32[(HEAP32[HEAP32[i1 + 16 >> 2] >> 2] | 0) + 4 >> 2] | 0;
 __ZN3WTF6StringC1EPKc(i9, i2);
 i2 = i9 | 0;
 i9 = HEAP32[i2 >> 2] | 0;
 if ((HEAP32[i9 + 16 >> 2] & 4 | 0) == 0) {
  __ZN3JSC10Identifier11addSlowCaseEPNS_9ExecStateEPN3WTF10StringImplE(i5, i1, i9);
  i12 = i5 | 0;
 } else {
  i13 = i5 | 0;
  HEAP32[i13 >> 2] = i9;
 ...
 i13 = HEAP32[i12 >> 2] | 0;
 HEAP32[i8 >> 2] = i13;
 __ZNK3JSC8JSObject3getEPNS_9ExecStateENS_12PropertyNameE(i7, i11, i1, i8);
 do {
  if ((i13 | 0) != 0) {
   i8 = i13 | 0;
 ...
 if ((HEAPU8[(HEAP32[HEAP32[i7 >> 2] >> 2] | 0) + 52 | 0] | 0) >>> 0 <= 16 >>> 0) {
  i14 = 0;
  __ZN3JSC12JSLockHolderD1Ev(i6);
  STACKTOP = i4;
  return i14 | 0;
 }
 __ZN10Deprecated12ScriptObjectC1EPN3JSC9ExecStateEPNS1_8JSObjectE(i10, i1, HEAP32[i7 >> 2] | 0);
 __ZN3JSC6StrongINS_7UnknownEEaSERKS2_(i3 + 4 | 0, i10 + 4 | 0) | 0;
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZN3JSC8JSObject17putDirectInternalILNS0_7PutModeE1EEEbRNS_2VMENS_12PropertyNameENS_7JSValueEjRNS_15PutPropertySlotEPNS_6JSCellE","_strlen","__ZN3JSC8JSObject43setStructureAndReallocateStorageIfNecessaryERNS_2VMEjPNS_9StructureE","__ZNK3JSC8JSObject3getEPNS_9ExecStateENS_12PropertyNameE","_memset","__ZN7WebCore18ScriptGlobalObject6removeEPN3JSC9ExecStateEPKc","__ZN7WebCore18ScriptGlobalObject3setEPN3JSC9ExecStateEPKcRKN10Deprecated12ScriptObjectE","_memcpy","__ZN3JSC9Structure27putWillGrowOutOfLineStorageEv","__ZN7WebCore18ScriptGlobalObject3setEPN3JSC9ExecStateEPKcPNS_21InspectorFrontendHostE","__ZN3JSC6StrongINS_7UnknownEEaSERKS2_","__ZN7WebCore18ScriptGlobalObject3getEPN3JSC9ExecStateEPKcRN10Deprecated12ScriptObjectE"]
