...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore21SVGFontFaceSrcElementE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZNK7WebCore21SVGFontFaceSrcElement8srcValueEv(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 L4 : do {
  if ((i10 | 0) == 4) {
   ...
   L6 : while (1) {
    ...
    i17 = HEAP32[__ZN7WebCore8SVGNames16font_face_uriTagE >> 2] | 0;
    do {
     if ((i16 | 0) == (i17 | 0)) {
      i10 = 8;
     } else {
      ...
      i19 = HEAP32[__ZN7WebCore8SVGNames17font_face_nameTagE >> 2] | 0;
      if ((i16 | 0) != (i19 | 0)) {
      ...
      __ZNK7WebCore22SVGFontFaceNameElement8srcValueEv(i5, i15);
      i21 = HEAP32[i2 >> 2] | 0;
      i10 = 13;
     }
    } while (0);
    if ((i10 | 0) == 8) {
     i10 = 0;
     __ZNK7WebCore21SVGFontFaceUriElement8srcValueEv(i4, i15);
     i21 = HEAP32[i8 >> 2] | 0;
     i10 = 13;
    }
    L19 : do {
     if ((i10 | 0) == 13) {
      ...
      do {
       if ((i16 | 0) != 0) {
        ...
        if ((i19 | 0) == (HEAP32[i12 >> 2] | 0)) {
         ...
         __ZN3WTF6VectorINS_6RefPtrIN7WebCore8CSSValueEEELj4ENS_15CrashOnOverflowEE15reserveCapacityEj(i13, i23 >>> 0 > i18 >>> 0 ? i23 : i18);
         HEAP32[(HEAP32[i14 >> 2] | 0) + (HEAP32[i11 >> 2] << 2) >> 2] = i17;
        } else {
         HEAP32[(HEAP32[i14 >> 2] | 0) + (i19 << 2) >> 2] = i17;
        }
      ...
      if ((i17 | 0) == 0) {
       __ZN7WebCore8CSSValue7destroyEv(i21 | 0);
       i20 = i15;
       break;
      } else {
       HEAP32[i16 >> 2] = i17;
    ...
    while (1) {
     i17 = HEAP32[i20 + 28 >> 2] | 0;
     if ((i17 | 0) == 0) {
      break L4;
     }
     if ((HEAP32[i17 + 12 >> 2] & 36 | 0) == 36) {
      i15 = i17;
      continue L6;
     } else {
      i20 = i17;
...
function __ZN7WebCore21SVGFontFaceSrcElement15childrenChangedERKNS_13ContainerNode11ChildChangeE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 ...
 i1 = HEAP32[i2 + 44 >> 2] | 0;
 i3 = HEAP32[__ZN7WebCore8SVGNames12font_faceTagE >> 2] | 0;
 do {
  if ((i1 | 0) != (i3 | 0)) {
 ...
 __ZN7WebCore18SVGFontFaceElement15rebuildFontFaceEv(i2);
 return;
}
...
function __ZN7WebCore21SVGFontFaceSrcElement6createERKNS_13QualifiedNameERNS_8DocumentE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
...
function __ZN7WebCore21SVGFontFaceSrcElement16rendererIsNeededERKNS_11RenderStyleE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 return 0;
}
...
function __ZN7WebCore21SVGFontFaceSrcElementD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore21SVGFontFaceSrcElementD1Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore10SVGElementD2Ev(i1 | 0);
 return;
}
