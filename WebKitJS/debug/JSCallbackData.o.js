...
/* memory initializer */ allocate([117,110,100,101,102,105,110,101,100,0,0,0,0,0,0,0,104,97,110,100,108,101,69,118,101,110,116,0,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE+H_BASE)
;
;
;
;
...
function __ZN7WebCore14JSCallbackData14invokeCallbackEN3JSC7JSValueERNS1_20MarkedArgumentBufferEPb(i1, i2, i3, i4, i5) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 i26 = HEAP32[(HEAP32[((HEAP32[(i22 & -65536) + 1048 >> 2] | 0) == 2 ? i22 + 8 | 0 : i2 + 32 | 0) >> 2] | 0) + 28 >> 2] | 0;
 do {
  if ((i25 | 0) == 0) {
   i27 = 0;
  } else {
 ...
 i25 = FUNCTION_TABLE_iii[i26 & 1](i27 | 0, i10) | 0;
 do {
  if ((i25 | 0) == 0) {
   i27 = HEAP32[i21 >> 2] | 0;
   do {
   ...
   __ZN3JSC10Identifier3addEPNS_9ExecStateEPKc(i7, i20, H_BASE + 24 | 0);
   i27 = HEAP32[i7 >> 2] | 0;
   HEAP32[i12 >> 2] = i27;
   __ZNK3JSC8JSObject3getEPNS_9ExecStateENS_12PropertyNameE(i11, i28, i20, i12);
   i26 = i11 | 0;
   i2 = HEAP32[i26 >> 2] | 0;
   ...
   if ((i22 | 0) == (-5 | 0) & (i26 | 0) == 0) {
    ...
    i30 = FUNCTION_TABLE_iii[HEAP32[(HEAP32[((HEAP32[(i2 & -65536) + 1048 >> 2] | 0) == 2 ? i27 + 8 | 0 : i31 + 32 | 0) >> 2] | 0) + 28 >> 2] & 1](i27, i10) | 0;
    if ((i30 | 0) != 0) {
     i32 = i30;
     i33 = i2;
     i34 = i29;
 ...
 i23 = __ZNK7WebCore17JSDOMGlobalObject22scriptExecutionContextEv(i35) | 0;
 if ((i23 | 0) == 0) {
  HEAP32[i1 + 4 >> 2] = -6;
  HEAP32[i1 >> 2] = 0;
  STACKTOP = i6;
 ...
 __ZN7WebCore21JSMainThreadExecState22instrumentFunctionCallEPNS_22ScriptExecutionContextEN3JSC8CallTypeERKNS3_8CallDataE(i13, i23, i32, i10);
 i35 = i33 | 0;
 i33 = i34 | 0;
 do {
  if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i23 >> 2] | 0) + 8 >> 2] & 1](i23) | 0) {
   i34 = i3 | 0;
   i19 = HEAP32[i34 >> 2] | 0;
   i24 = HEAP32[i34 + 4 >> 2] | 0;
   HEAP32[i15 >> 2] = HEAP32[i4 + 72 >> 2];
   HEAP32[i15 + 4 >> 2] = HEAP32[i4 >> 2];
   i34 = HEAP32[__ZN7WebCore21JSMainThreadExecState17s_mainThreadStateE >> 2] | 0;
   ...
   HEAP32[i25 >> 2] = i19;
   HEAP32[i25 + 4 >> 2] = i24;
   __ZN3JSC4callEPNS_9ExecStateENS_7JSValueENS_8CallTypeERKNS_8CallDataES2_RKNS_7ArgListE(i14, i20, i8, i32, i10, i9, i15);
   if ((HEAP32[__ZN7WebCore21JSMainThreadExecState17s_mainThreadStateE >> 2] | 0) == 0) {
    HEAP32[__ZN7WebCore21JSMainThreadExecState17s_mainThreadStateE >> 2] = i34;
    break;
   }
   HEAP32[__ZN7WebCore21JSMainThreadExecState17s_mainThreadStateE >> 2] = i34;
   if ((i34 | 0) != 0) {
   ...
   HEAP32[i25 + 4 >> 2] = i24;
   HEAP32[i18 >> 2] = HEAP32[i4 + 72 >> 2];
   HEAP32[i18 + 4 >> 2] = HEAP32[i4 >> 2];
   __ZN3JSC4callEPNS_9ExecStateENS_7JSValueENS_8CallTypeERKNS_8CallDataES2_RKNS_7ArgListE(i14, i20, i16, i32, i10, i17, i18);
  }
 } while (0);
 do {
 ...
 i18 = (HEAP32[(HEAP32[i20 + 16 >> 2] & -65536) + 1076 >> 2] | 0) + 24800 | 0;
...
function __ZN7WebCore14JSCallbackData10deleteDataEPv(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore14JSCallbackData14invokeCallbackERN3JSC20MarkedArgumentBufferEPb(i1, i2, i3, i4) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 HEAP32[i6 + 4 >> 2] = (i8 | 0) == 0 ? -6 : -5;
 HEAP32[i6 >> 2] = i8;
 __ZN7WebCore14JSCallbackData14invokeCallbackEN3JSC7JSValueERNS1_20MarkedArgumentBufferEPb(i1, i2, i6, i3, i4);
 STACKTOP = i5;
 return;
}
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZNK3JSC8JSObject3getEPNS_9ExecStateENS_12PropertyNameE","_memset","__ZN7WebCore14JSCallbackData10deleteDataEPv","_memcpy","__ZN7WebCore14JSCallbackData14invokeCallbackEN3JSC7JSValueERNS1_20MarkedArgumentBufferEPb","__ZN7WebCore21JSMainThreadExecState22instrumentFunctionCallEPNS_22ScriptExecutionContextEN3JSC8CallTypeERKNS3_8CallDataE","__ZN7WebCore14JSCallbackData14invokeCallbackERN3JSC20MarkedArgumentBufferEPb"]
