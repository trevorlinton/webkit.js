...
function __ZN7WebCore26IDBFactoryBackendInterface6createERKN3WTF6StringE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 i5 = HEAP32[i4 >> 2] | 0;
 if ((i5 | 0) == 0) {
  i6 = FUNCTION_TABLE_ii[HEAP32[(HEAP32[i3 >> 2] | 0) + 12 >> 2] & 1](i3) | 0;
  HEAP32[i4 >> 2] = i6;
  i7 = i6;
 } else {
  i7 = i5;
 }
 FUNCTION_TABLE_viii[HEAP32[(HEAP32[i7 >> 2] | 0) + 4 >> 2] & 1](i1, i7, i2);
 return;
}
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","_memcpy","_memset","__ZN7WebCore26IDBFactoryBackendInterface6createERKN3WTF6StringE"]
