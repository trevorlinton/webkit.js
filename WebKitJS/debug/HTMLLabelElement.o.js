...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore16HTMLLabelElementE=(H_BASE+16)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function runPostSets() {
 ...
 HEAP32[H_BASE + 32 >> 2] = F_BASE_ii + 134;
 HEAP32[H_BASE + 36 >> 2] = F_BASE_ii + 142;
 HEAP32[H_BASE + 40 >> 2] = F_BASE_ii + 54;
 ...
 HEAP32[H_BASE + 88 >> 2] = F_BASE_vii + 46;
 HEAP32[H_BASE + 92 >> 2] = F_BASE_vii + 48;
 ...
 HEAP32[H_BASE + 156 >> 2] = F_BASE_ii + 60;
 ...
 HEAP32[H_BASE + 340 >> 2] = F_BASE_vii + 40;
 HEAP32[H_BASE + 344 >> 2] = F_BASE_v + 8;
 HEAP32[H_BASE + 348 >> 2] = F_BASE_iii + 18;
 HEAP32[H_BASE + 352 >> 2] = F_BASE_ii + 128;
 ...
 HEAP32[H_BASE + 396 >> 2] = F_BASE_vii + 44;
 ...
 HEAP32[H_BASE + 476 >> 2] = F_BASE_ii + 124;
 HEAP32[H_BASE + 480 >> 2] = F_BASE_ii + 28;
 HEAP32[H_BASE + 484 >> 2] = F_BASE_ii + 76;
 HEAP32[H_BASE + 488 >> 2] = F_BASE_ii + 90;
...
function __ZN7WebCore16HTMLLabelElement7controlEv(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0, i5 = 0, i6 = 0, i7 = 0, i8 = 0, i9 = 0, i10 = 0, i11 = 0, i12 = 0, i13 = 0, i14 = 0, i15 = 0, i16 = 0, i17 = 0, i18 = 0;
 i2 = __ZNK7WebCore7Element12getAttributeERKNS_13QualifiedNameE(i1 | 0, __ZN7WebCore9HTMLNames7forAttrE) | 0;
 if ((HEAP32[i2 >> 2] | 0) != 0) {
  ...
  if (!(FUNCTION_TABLE_ii[HEAP32[(HEAP32[i3 >> 2] | 0) + 592 >> 2] & 255](i3) | 0)) {
   i4 = 0;
   return i4 | 0;
  }
  i2 = i3;
  i5 = FUNCTION_TABLE_ii[HEAP32[(HEAP32[i3 >> 2] | 0) + 604 >> 2] & 255](i2) | 0;
  i4 = i5 ? i2 : 0;
  return i4 | 0;
 }
 i2 = i1 + 36 | 0;
 ...
 L20 : while (1) {
  if ((i6 & 16 | 0) != 0) {
   if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i5 >> 2] | 0) + 592 >> 2] & 255](i5) | 0) {
    i7 = 18;
    break;
   }
  }
  ...
  do {
   if ((i8 | 0) == 0) {
    ...
    i3 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i5, i2) | 0;
    if ((i3 | 0) == 0) {
     i4 = 0;
     i7 = 49;
     break L20;
  ...
  if ((HEAP32[i9 + 12 >> 2] & 4 | 0) == 0) {
   ...
   while (1) {
    ...
    i3 = HEAP32[i8 + 28 >> 2] | 0;
    if ((i3 | 0) == 0) {
     i10 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i8, i2) | 0;
     if ((i10 | 0) == 0) {
      i4 = 0;
      i7 = 51;
      break L20;
 ...
 if ((i7 | 0) == 18) {
  ...
  L43 : while (1) {
   i5 = i1;
   if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i1 >> 2] | 0) + 604 >> 2] & 255](i5) | 0) {
    i4 = i5;
    i7 = 53;
    break;
   }
   ...
   do {
    if ((i5 | 0) == 0) {
     ...
     i6 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i1, i12) | 0;
     if ((i6 | 0) == 0) {
      i4 = 0;
      i7 = 55;
      break L43;
   ...
   if ((HEAP32[i13 + 12 >> 2] & 4 | 0) == 0) {
    ...
    while (1) {
     ...
     i6 = HEAP32[i5 + 28 >> 2] | 0;
     if ((i6 | 0) == 0) {
      i9 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i5, i12) | 0;
      if ((i9 | 0) == 0) {
       i4 = 0;
       i7 = 57;
       break L43;
   ...
   L58 : while (1) {
    if ((HEAP32[i15 + 12 >> 2] & 16 | 0) != 0) {
     if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i15 >> 2] | 0) + 592 >> 2] & 255](i15) | 0) {
      break;
     }
    }
    ...
    do {
     if ((i5 | 0) == 0) {
      ...
      i6 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i15, i12) | 0;
      if ((i6 | 0) == 0) {
       i4 = 0;
       i7 = 60;
       break L43;
    ...
    while (1) {
     ...
     if ((i5 | 0) == 0) {
      i6 = __ZN7WebCore13NodeTraversal19nextAncestorSiblingEPKNS_4NodeES3_(i17, i12) | 0;
      if ((i6 | 0) == 0) {
       i4 = 0;
       i7 = 62;
       break L43;
...
function __ZN7WebCore16HTMLLabelElement19defaultEventHandlerEPNS_5EventE(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 ...
 do {
  if ((HEAP32[i2 + 12 >> 2] | 0) == (HEAP32[i3 + 56 >> 2] | 0)) {
   ...
   i4 = __ZN7WebCore16HTMLLabelElement7controlEv(i1) | 0;
   if ((i4 | 0) == 0) {
    return;
   }
   i5 = i4 + 8 | 0;
   ...
   if ((i5 | 0) == 0) {
    ...
    if (__ZNK7WebCore4Node26containsIncludingShadowDOMEPKS0_(i4 | 0, FUNCTION_TABLE_ii[HEAP32[(HEAP32[i5 >> 2] | 0) + 8 >> 2] & 255](i5) | 0) | 0) {
     i7 = 1;
    } else {
     i6 = 6;
    }
   ...
   if ((i6 | 0) == 6) {
    ...
    if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i4 >> 2] | 0) + 356 >> 2] & 255](i5) | 0) {
     FUNCTION_TABLE_viii[HEAP32[(HEAP32[i4 >> 2] | 0) + 392 >> 2] & 15](i5, 1, 0);
    }
    HEAP8[H_BASE + 8 | 0] = 0;
    HEAP8[i2 + 21 | 0] = 1;
    i7 = 0;
...
function __ZN7WebCore16HTMLLabelElement6createERKNS_13QualifiedNameERNS_8DocumentE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
...
function __ZN7WebCore16HTMLLabelElement9setActiveEbb(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 var i4 = 0;
 ...
 do {
  if ((HEAP32[i1 + 12 >> 2] & 1024 | 0) == 0) {
   ...
   if ((__ZNK7WebCore7Element25isUserActionElementActiveEv(i4) | 0) ^ i2) {
    break;
   }
   return;
  }
 } while (0);
 __ZN7WebCore7Element9setActiveEbb(i4, i2, i3);
 i4 = __ZN7WebCore16HTMLLabelElement7controlEv(i1) | 0;
 if ((i4 | 0) == 0) {
  return;
 }
 FUNCTION_TABLE_viii[HEAP32[(HEAP32[i4 >> 2] | 0) + 332 >> 2] & 15](i4 | 0, i2, i3);
 return;
}
function __ZN7WebCore16HTMLLabelElement10setHoveredEb(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 i3 = i1 | 0;
 do {
  if ((HEAP32[i1 + 12 >> 2] & 1024 | 0) == 0) {
   ...
   if ((__ZNK7WebCore7Element26isUserActionElementHoveredEv(i3) | 0) ^ i2) {
    break;
   }
   return;
  }
 } while (0);
 __ZN7WebCore7Element10setHoveredEb(i3, i2);
 i3 = __ZN7WebCore16HTMLLabelElement7controlEv(i1) | 0;
 if ((i3 | 0) == 0) {
  return;
 }
 FUNCTION_TABLE_vii[HEAP32[(HEAP32[i3 >> 2] | 0) + 336 >> 2] & 63](i3 | 0, i2);
 return;
}
...
function __ZN7WebCore16HTMLLabelElement29willRespondToMouseClickEventsEv(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0;
 do {
  if ((__ZN7WebCore16HTMLLabelElement7controlEv(i1) | 0) != 0) {
   i2 = __ZN7WebCore16HTMLLabelElement7controlEv(i1) | 0;
   if (FUNCTION_TABLE_ii[HEAP32[(HEAP32[i2 >> 2] | 0) + 196 >> 2] & 255](i2 | 0) | 0) {
    i3 = 1;
   } else {
    break;
   }
...
function __ZN7WebCore16HTMLLabelElement15accessKeyActionEb(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0;
 i3 = __ZN7WebCore16HTMLLabelElement7controlEv(i1) | 0;
 if ((i3 | 0) == 0) {
  __ZN7WebCore11HTMLElement15accessKeyActionEb(i1 | 0, i2);
  return;
 } else {
  FUNCTION_TABLE_vii[HEAP32[(HEAP32[i3 >> 2] | 0) + 372 >> 2] & 63](i3 | 0, i2);
  return;
 }
}
...
function __ZN7WebCore16HTMLLabelElement5focusEbNS_14FocusDirectionE(i1, i2, i3) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i2 = __ZN7WebCore16HTMLLabelElement7controlEv(i1) | 0;
 ...
 FUNCTION_TABLE_viii[HEAP32[(HEAP32[i2 >> 2] | 0) + 392 >> 2] & 15](i2 | 0, 1, i3);
 return;
}
...
function __ZNK7WebCore16HTMLLabelElement4formEv(i1) {
 i1 = i1 | 0;
 return __ZN7WebCore21FormAssociatedElement18findAssociatedFormEPKNS_11HTMLElementEPNS_15HTMLFormElementE(i1 | 0, 0) | 0;
}
...
function __ZN7WebCore16HTMLLabelElementD0Ev(i1) {
 i1 = i1 | 0;
...
function __ZN7WebCore16HTMLLabelElementD1Ev(i1) {
 i1 = i1 | 0;
 __ZN7WebCore13StyledElementD2Ev(i1 | 0);
 return;
}
...
function __ZNK7WebCore16HTMLLabelElement11isFocusableEv(i1) {
 i1 = i1 | 0;
 return 0;
}
...
// EMSCRIPTEN_END_FUNCS
  ...
  var FUNCTION_TABLE_viii = [b4,b4,__ZN7WebCore16HTMLLabelElement5focusEbNS_14FocusDirectionE,b4,viii___ZN7WebCore7Element9cloneNodeEb__wrapper,b4,viii___ZN7WebCore7Element9setPrefixERKN3WTF12AtomicStringERi__wrapper,b4,viii___ZN7WebCore4Node12setNodeValueERKN3WTF6StringERi__wrapper,b4,viii___ZN7WebCore11HTMLElement14parseAttributeERKNS_13QualifiedNameERKN3WTF12AtomicStringE__wrapper,b4,__ZN7WebCore16HTMLLabelElement9setActiveEbb,b4,b4,b4];
  ...
  var FUNCTION_TABLE_iii = [b6,b6,iii___ZNK7WebCore7Element22shouldMoveToFlowThreadERKNS_11RenderStyleE__wrapper,b6,iii___ZN7WebCore7Element13computedStyleENS_8PseudoIdE__wrapper,b6,iii___ZN7WebCore7Element15willRecalcStyleENS_5Style6ChangeE__wrapper,b6,iii___ZNK7WebCore7Element25childShouldCreateRendererERKNS_4NodeE__wrapper,b6,iii___ZN7WebCore4Node13dispatchEventEN3WTF10PassRefPtrINS_5EventEEE__wrapper,b6,iii___ZN7WebCore7Element12insertedIntoERNS_13ContainerNodeE__wrapper,b6,iii___ZNK7WebCore7Element19isKeyboardFocusableEPNS_13KeyboardEventE__wrapper,b6,iii___ZNK7WebCore7Element16childTypeAllowedENS_4Node8NodeTypeE__wrapper,b6,iii___ZN7WebCore11HTMLElement16rendererIsNeededERKNS_11RenderStyleE__wrapper,b6,iii___ZNK7WebCore11HTMLElement14isURLAttributeERKNS_9AttributeE__wrapper,b6,__ZNK7WebCore7Element22isHTMLContentAttributeERKNS_9AttributeE,b6,iii___ZNK7WebCore11HTMLElement23isPresentationAttributeERKNS_13QualifiedNameE__wrapper,b6,b6,b6,b6
  ,b6,b6,b6];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["_strlen","__ZNK7WebCore7Element32isSearchFieldCancelButtonElementEv","__ZNK7WebCore7Element21isRequiredFormControlEv","__ZNK7WebCore7Element12isOutOfRangeEv","__ZN7WebCore16HTMLLabelElement10setHoveredEb","__ZNK7WebCore7Element12namespaceURIEv","__ZN7WebCore7Element20buildPendingResourceEv","__ZN7WebCore16HTMLLabelElement5focusEbNS_14FocusDirectionE","__ZN7WebCore7Element29privateBrowsingStateDidChangeEv","__ZN7WebCore7Element26didBecomeFullscreenElementEv","__ZNK7WebCore16HTMLLabelElement11isFocusableEv","__ZN7WebCore16HTMLLabelElement15accessKeyActionEb","__ZNK7WebCore4Node16nonRendererStyleEv","__ZNK7WebCore7Element19isSpinButtonElementEv","__ZN7WebCore7Element20mediaVolumeDidChangeEv","__ZNK7WebCore4Node15isPluginElementEv","__ZNK7WebCore7Element6targetEv","__ZNK7WebCore7Element17isTextFormControlEv","__ZNK7WebCore7Element31alwaysCreateUserAgentShadowRootEv","__ZN7WebCore4Node24startLoadingDynamicSheetEv","__ZN7WebCore16HTMLLabelElement7controlEv","__ZNK7WebCore4Node20isInsertionPointNodeEv","__ZN7WebCore16HTMLLabelElement6createERKNS_13QualifiedNameERNS_8DocumentE","__ZNK7WebCore4Node22scriptExecutionContextEv","__ZNK7WebCore4Node19isCharacterDataNodeEv","__ZNK7WebCore7Element9localNameEv","__ZNK7WebCore7Element22isDefaultButtonForFormEv","_memcpy","__ZNK7WebCore16HTMLLabelElement4formEv","__ZN7WebCore7Element30documentDidResumeFromPageCacheEv","__ZNK7WebCore7Element22isHTMLContentAttributeERKNS_9AttributeE","__ZN7WebCore4Node11sheetLoadedEv","__ZN7WebCore11HTMLElement15asFormNamedItemEv","__ZNK7WebCore4Node14customPseudoIdEv","__ZNK7WebCore4Node21isMediaControlElementEv","__ZNK7WebCore7Element12willValidateEv","__ZNK7WebCore4Node19isFrameOwnerElementEv","__ZN7WebCore16HTMLLabelElementD1Ev","__ZN7WebCore16HTMLLabelElement29willRespondToMouseClickEventsEv","__ZN7WebCore16HTMLLabelElementD0Ev","__ZNK7WebCore7Element9isInRangeEv","__ZN7WebCore7Element30willStopBeingFullscreenElementEv","__ZNK7WebCore7Element20isFormControlElementEv","__ZN7WebCore7Element37copyNonAttributePropertiesFromElementERKS0_","__ZN7WebCore16HTMLLabelElement9setActiveEbb","__ZN7WebCore7Element22visibilityStateChangedEv","__ZN7WebCore7Element25didAddUserAgentShadowRootEPNS_10ShadowRootE","__ZN7WebCore4Node26didNotifySubtreeInsertionsEPNS_13ContainerNodeE","__ZN7WebCore13StyledElement36additionalPresentationAttributeStyleEv","__ZNK7WebCore11HTMLElement11isLabelableEv","__ZNK7WebCore7Element21isDisabledFormControlEv","__ZNK7WebCore7Element18isFrameElementBaseEv","__ZNK7WebCore4Node15isMediaControlsEv","__ZNK7WebCore7Element23areAuthorShadowsAllowedEv","__ZN7WebCore4Node43notifyLoadedSheetAndAllCriticalSubresourcesEb","__ZNK7WebCore7Element21isOptionalFormControlEv","__ZNK7WebCore11HTMLElement20isHTMLUnknownElementEv","__ZNK7WebCore4Node15isAttributeNodeEv","__ZNK7WebCore7Element23canContainRangeEndPointEv","__ZNK7WebCore7Element6prefixEv","__ZN7WebCore16HTMLLabelElement19defaultEventHandlerEPNS_5EventE","__ZN7WebCore7Element31documentWillSuspendForPageCacheEv","__ZN7WebCore7Element25isValidFormControlElementEv","_memset","__ZNK7WebCore11HTMLElement29isTextControlInnerTextElementEv"]
