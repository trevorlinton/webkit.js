...
var __ZN7WebCore20MoveSelectionCommandC1EN3WTF10PassRefPtrINS_16DocumentFragmentEEERKNS_8PositionEbb;
...
var asm = (function(global, env, buffer) {
  ...
  var __ZTVN7WebCore20MoveSelectionCommandE=(H_BASE+8)|0;
  var __THREW__ = 0;
  var threwValue = 0;
  var setjmpId = 0;
  var undef = 0;
...
function __ZN7WebCore20MoveSelectionCommand7doApplyEv(i1) {
 i1 = i1 | 0;
 ...
 if ((i11 | 0) == 0) {
  ...
  i11 = i12;
  i13 = HEAP32[i11 >> 2] & -8;
  i14 = (HEAP32[i10 >> 2] | 0) == 0;
  i15 = i12;
  i16 = i11;
 }
 i11 = i4 + 4 | 0;
 HEAP32[i11 >> 2] = HEAP32[i1 + 160 >> 2];
 i12 = HEAP32[i1 + 164 >> 2] | 0;
 i17 = i13 | i12 & 7;
 HEAP32[i16 >> 2] = i17;
 HEAP8[i15] = i17 & 255 & -9 | i12 & 8;
 if (i14) {
  STACKTOP = i2;
  return;
 }
 ...
 i13 = i5 + 4 | 0;
 HEAP32[i13 >> 2] = HEAP32[i1 + 112 >> 2];
 i17 = HEAP32[i1 + 116 >> 2] | 0;
 i18 = i5 + 8 | 0;
 i19 = i18;
 i20 = HEAP32[i19 >> 2] & -8 | i17 & 7;
 HEAP32[i19 >> 2] = i20;
 HEAP8[i18] = i20 & 255 & -9 | i17 & 8;
 do {
  if ((HEAP32[i16 >> 2] & 7 | 0) == 0) {
   if ((HEAP32[i19 >> 2] & 7 | 0) != 0) {
    break;
   }
   i17 = __ZNK7WebCore8Position13containerNodeEv(i5) | 0;
   if ((i17 | 0) != (__ZNK7WebCore8Position13containerNodeEv(i4) | 0)) {
    break;
   }
   i17 = HEAP32[i13 >> 2] | 0;
   i20 = HEAP32[i11 >> 2] | 0;
   ...
   __ZN7WebCore8Position12moveToOffsetEi(i4, i20 - i17 | 0);
   i17 = i6 | 0;
   ...
   do {
    if ((HEAP32[i22 >> 2] & 7 | 0) == 0) {
     i20 = __ZNK7WebCore8Position13containerNodeEv(i6) | 0;
     if ((i20 | 0) != (__ZNK7WebCore8Position13containerNodeEv(i4) | 0)) {
      break;
     }
     __ZN7WebCore8Position12moveToOffsetEi(i4, (HEAP32[i18 >> 2] | 0) + (HEAP32[i11 >> 2] | 0) | 0);
    }
   } while (0);
   i18 = HEAP32[i17 >> 2] | 0;
   if ((i18 | 0) == 0) {
 ...
 i6 = i1 | 0;
 __ZN7WebCore20CompositeEditCommand15deleteSelectionEbbbbb(i6, (HEAP8[i1 + 169 | 0] & 1) != 0, 1, 0, 1, 1);
 i13 = HEAP32[i10 >> 2] | 0;
 if ((HEAP32[i13 + 12 >> 2] & 256 | 0) == 0) {
  ...
  i13 = HEAP32[i1 + 100 >> 2] | 0;
  i19 = HEAP32[i1 + 104 >> 2] | 0;
  i22 = i19 & 8;
  HEAP32[i10 >> 2] = i5;
  do {
   if ((i24 | 0) != 0) {
  ...
  HEAP32[i11 >> 2] = i13;
  i13 = HEAP32[i16 >> 2] & -8 | i19 & 7;
  HEAP32[i16 >> 2] = i13;
  HEAP8[i15] = i13 & 255 & -9 | i22;
 }
 __ZN7WebCore15VisiblePositionC1ERKNS_8PositionENS_9EAffinityE(i7, i4, 1);
 __ZN7WebCore20CompositeEditCommand20cleanupAfterDeletionENS_15VisiblePositionE(i6, i7);
 i22 = HEAP32[i7 >> 2] | 0;
 do {
  if ((i22 | 0) != 0) {
   i7 = i22 + 8 | 0;
 ...
 __ZN7WebCore16VisibleSelectionC1ERKNS_8PositionENS_9EAffinityEb(i8, i4, HEAP32[i1 + 120 >> 2] | 0, (HEAP8[i1 + 128 | 0] & 2) != 0);
 __ZN7WebCore11EditCommand18setEndingSelectionERKNS_16VisibleSelectionE(i14, i8);
 __ZN7WebCore16VisibleSelectionD2Ev(i8);
 do {
  if ((HEAP32[(HEAP32[i10 >> 2] | 0) + 12 >> 2] & 256 | 0) != 0) {
   i8 = (HEAP8[i1 + 168 | 0] & 1) == 0 ? 9 : 11;
   i14 = HEAP32[i1 + 8 >> 2] | 0;
   ...
   i22 = __ZN3WTF10fastMallocEj(200) | 0;
   i7 = i3 | 0;
   HEAP32[i7 >> 2] = i4;
   __ZN7WebCore23ReplaceSelectionCommandC1ERNS_8DocumentEN3WTF10PassRefPtrINS_16DocumentFragmentEEEjNS_10EditActionE(i22, i14, i3, i8, 29);
   i8 = HEAP32[i7 >> 2] | 0;
   do {
    if ((i8 | 0) != 0) {
     i7 = i8 + 8 | 0;
   ...
   i8 = i9 | 0;
   HEAP32[i8 >> 2] = i22;
   __ZN7WebCore20CompositeEditCommand23applyCommandToCompositeEN3WTF10PassRefPtrINS_11EditCommandEEE(i6, i9);
   i17 = HEAP32[i8 >> 2] | 0;
   if ((i17 | 0) == 0) {
    break;
   }
...
function __ZN7WebCore20MoveSelectionCommandC2EN3WTF10PassRefPtrINS_16DocumentFragmentEEERKNS_8PositionEbb(i1, i2, i3, i4, i5) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
 ...
 var i6 = 0, i7 = 0;
 i6 = i3 | 0;
 __ZN7WebCore20CompositeEditCommandC2ERNS_8DocumentE(i1 | 0, HEAP32[(HEAP32[(HEAP32[i6 >> 2] | 0) + 20 >> 2] | 0) + 8 >> 2] | 0);
 ...
 HEAP32[i1 + 160 >> 2] = HEAP32[i3 + 4 >> 2];
 i6 = i3 + 8 | 0;
 i3 = i1 + 164 | 0;
 i2 = i3;
 i7 = HEAP32[i2 >> 2] & -8 | HEAP32[i6 >> 2] & 7;
 HEAP32[i2 >> 2] = i7;
 HEAP8[i3] = i7 & 255 & -9 | HEAP8[i6] & 8;
 HEAP8[i1 + 168 | 0] = i4 & 1;
 HEAP8[i1 + 169 | 0] = i5 & 1;
 return;
}
function __ZN7WebCore20MoveSelectionCommandC1EN3WTF10PassRefPtrINS_16DocumentFragmentEEERKNS_8PositionEbb(i1, i2, i3, i4, i5) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 i3 = i3 | 0;
 i4 = i4 | 0;
...
function __ZN7WebCore20MoveSelectionCommandD0Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0, i5 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
...
function __ZN7WebCore20MoveSelectionCommandD1Ev(i1) {
 i1 = i1 | 0;
 var i2 = 0, i3 = 0, i4 = 0, i5 = 0;
 HEAP32[i1 >> 2] = H_BASE + 16;
 i2 = HEAP32[i1 + 156 >> 2] | 0;
...
function __ZNK7WebCore20MoveSelectionCommand13editingActionEv(i1) {
 i1 = i1 | 0;
 return 25;
}
...
// EMSCRIPTEN_END_FUNCS
  var FUNCTION_TABLE_viiiii = [b0,b0,__ZN7WebCore20MoveSelectionCommandC2EN3WTF10PassRefPtrINS_16DocumentFragmentEEERKNS_8PositionEbb,b0];
  var FUNCTION_TABLE_vi = [b1,b1,__ZN7WebCore20MoveSelectionCommand7doApplyEv,b1,__ZN7WebCore20MoveSelectionCommandD1Ev,b1,__ZN7WebCore20MoveSelectionCommandD0Ev,b1];
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__ZNK7WebCore20CompositeEditCommand18isDictationCommandEv","__ZN7WebCore16VisibleSelectionD2Ev","__ZNK7WebCore20MoveSelectionCommand13editingActionEv","_memset","__ZN7WebCore20MoveSelectionCommandC2EN3WTF10PassRefPtrINS_16DocumentFragmentEEERKNS_8PositionEbb","__ZNK7WebCore11EditCommand19isSimpleEditCommandEv","__ZN7WebCore20MoveSelectionCommand7doApplyEv","__ZNK7WebCore20CompositeEditCommand22isCompositeEditCommandEv","_memcpy","__ZNK7WebCore11EditCommand24isEditCommandCompositionEv","__ZN7WebCore20MoveSelectionCommandD0Ev","_strlen","__ZN7WebCore20MoveSelectionCommandD1Ev","__ZNK7WebCore20CompositeEditCommand23shouldStopCaretBlinkingEv"]
